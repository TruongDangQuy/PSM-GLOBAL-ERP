...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP13125_SEARCH_VS10", cn,  SdateEdate.text1, SdateEdate.text2, txt_cdSite.Code, txt_CustPONO.Data, txt_Article.Data)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP13125_SEARCH_VS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(OrderNo As String, OrderNoSeq As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP13125_SEARCH_vS20", cn, OrderNo, OrderNoSeq)


        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP13125_SEARCH_vS20", "vS20")
            vS20.Enabled = True
            Exit Function
        End If
