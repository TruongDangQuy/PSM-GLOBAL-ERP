...
#Region "Link_ISUD"
    ...
    Private Sub MAIN_JOB01()
        If getData(Vs1, 0, Vs1.ActiveSheet.ActiveRowIndex) <> "" Then
            If ISUD9271A.Link_ISUD9271A(1, getData(Vs1, 1, Vs1.ActiveSheet.ActiveRowIndex), getData(Vs1, 1, Vs1.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
            Call DATA_SEARCH02(getData(Vs1, 1, Vs1.ActiveSheet.ActiveRowIndex))
        Else
            If ISUD9271A.Link_ISUD9271A(1, getData(Vs1, 1, Vs1.ActiveSheet.ActiveRowIndex), "001", Me.Name) = False Then Exit Sub
            Call DATA_SEARCH02(getData(Vs1, 1, Vs1.ActiveSheet.ActiveRowIndex))
        End If
    ...
    Private Sub MAIN_JOB02()
        ...
        'If ISUD9271A.Link_ISUD9271A(3, getData(Vs2, 0, Vs2.ActiveSheet.ActiveRowIndex), getData(Vs2, 1, Vs2.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_PFP92710_SEARCH_VS1_F1", cn, "000", strPWC)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_PFP92710_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_PFP92710_SEARCH_VS2", cn, KSEL)
    ...
    Private Function DATA_SEARCH02_NOTE(Node As Object, KSEL As String, KCODE As String) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_PFP92710_SEARCH_VS2_NODE", cn, KSEL, KCODE)
    ...
    Private Function DATA_SEARCH03(Optional BasicSel As String = "", Optional BasicCode As String = "") As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_PFP92710_SEARCH_vS3", cn, BasicSel, BasicCode)

            If GetDsRc(DSNEW) = 0 Then
                SPR_PRO_NEW(vS3, DSNEW, "USP_PFP92710_SEARCH_vS3", "vS3")
                Exit Function
            End If
...
#Region "EVENT"
    ...
    Private Sub cmd_SEARCH_Click(sender As Object, e As EventArgs) Handles cmd_SEARCH.Click
        If DATA_SEARCH01() = True Then
            '   Call DATA_SEARCH02(a9271(getData(Vs1, 1, Vs1.ActiveSheet.ActiveRowIndex)).KCODE, a9271(getData(Vs1, 1, Vs1.ActiveSheet.ActiveRowIndex)).KNAME)
        End If
    End Sub
...
#Region "Solution"
    ...
    Private Sub DATA_DELETE()
        ...
        Try
            ...
            SQL = "UPDATE[dbo].[PFK9272] "
            SQL = SQL & " SET [K9272_CheckUse] = '2' "
            SQL = SQL & " WHERE [K9272_BasicSel] = '" + FormName + "'"
            SQL = SQL & " AND [K9272_BasicCode] = '" + Parameter + "'"
            SQL = SQL & " AND [K9272_SEQ] = '" + CIntp(getData(vS3, getColumIndex(vS3, "KEY_SEQ"), vS3.ActiveSheet.ActiveRowIndex)).ToString + "'"
    ...
    Private Sub KEY_COUNT()
        ...
        SQL = "SELECT MAX(K9272_SEQ) AS MAX_CODE FROM [PFK9272] "
        SQL = SQL & " WHERE K9272_BasicSel     = '" + FormName + "'"
        SQL = SQL & " AND [K9272_BasicCode] = '" + Parameter + "'"
...
#Region "Event"
    ...
    Private Sub upLoadImageOrFile(ByVal sFilePath As String, ByVal sFileType As String)
        ...
        Try
            ...
            'Set insert query 
            qry = "insert into [PFK9272] ([K9272_BasicSel],[K9272_BasicCode],[K9272_SEQ],[K9272_FileName],[K9272_ImageData]," & _
            "[K9272_FileType],[K9272_AttachDate],[K9272_AttachIncharge],[K9272_Time]) values (@BasicSel, @BasicCode,@SEQ,@FileName,@ImageData,@FileType,@AttachDate,@AttachIncharge,@Time)"
    ...
    Private Sub downLoadFile(ByVal iFileId As Long, ByVal sFileName As String, ByVal sFileExtension As String)
        ...
        Try
            ...
            strSql = strSql & "WHERE [K9272_BasicSel]= '" + getData(vS3, getColumIndex(vS3, "Key_BasicSel"), vS3.ActiveSheet.ActiveRowIndex) + "'"
            strSql = strSql & "AND   [K9272_BasicCode]= '" + getData(vS3, getColumIndex(vS3, "Key_BasicCode"), vS3.ActiveSheet.ActiveRowIndex) + "'"
            strSql = strSql & "AND   [K9272_SEQ]= '" + getData(vS3, getColumIndex(vS3, "KEY_SEQ"), vS3.ActiveSheet.ActiveRowIndex) + "'"
...
#End Region
    ...
    Private Sub ACTION_JOB01()
        Try
            ...
            If READ_PFK9271(Sel, Code) Then
                W9271 = D9271
                Call KEY_COUNT(Sel)
                W9271.BasicName = InputBox("Please fill the name !")
                W9271.selBasicMaster = Sel
                W9271.cdBasicMaster = Code

                Call WRITE_PFK9271(W9271)

                Dim xxx As New TreeNode
                xxx.Name = W9271.BasicSel & W9271.BasicCode
                xxx.Text = W9271.BasicName
                xxx.Tag = W9271.BasicSel & "-" & W9271.BasicCode
    ...
    Private Sub ACTION_JOB02()
        Try
            ...
            If READ_PFK9271(Sel, Code) Then
                ...
                W9271.BasicName = InputBox("Please fill the name !")
                W9271.BasicName = FormatCut(W9271.BasicName)
                If Len(W9271.BasicName) <= 2 Then MsgBoxP("Please Choose > 2 Characters !") : Exit Sub

                Call REWRITE_PFK9271(W9271)
            End If

            trv_001.SelectedNode.Text = W9271.BasicName
    ...
    Private Sub ACTION_JOB03()
        Try
            ...
            Call READ_PFK9271(Sel, Code)

            MsgStr = MsgBox("Do you want to remove it, can not restore  - " & D9271.BasicName, vbYesNo)
            ...
            If READ_PFK9271(Sel, Code) Then
                W9271 = D9271
                W9271.CheckUse = "2"
                REWRITE_PFK9271(W9271)
                'Call DELETE_PFK9271(W9271)
            End If
    ...
    Private Sub KEY_COUNT(BasicSel As String)
        ...
        If IsDBNull(rd!MAX_CODE) Then
            W9271.BasicCode = "001"
        Else
            W9271.BasicCode = Format(CInt(rd!MAX_CODE + 1), "000")
        End If
