...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1, _
                         xISUD2351A & " - " & WordConv("INPUT") & "(F5)",
                         xISUD2351A & " - " & WordConv("INPUT BY SEMI GROUP") & "(F6)",
                         xISUD2351A & " - " & WordConv("INPUT BY ONE LINE") & "(F7)",
                          xISUD2351A & " - " & WordConv("INPUT BY SUPPLIER + MATERIAL + COLOR") & "(F8)")
        ...
        Call Cms_additem(Cms_2, _
                        xISUD2351A & " - " & WordConv("INSERT") & "(F5)", _
                        xISUD2351A & " - " & WordConv("SEARCH") & "(F6)", _
                        xISUD2351A & " - " & WordConv("UPDATE") & "(F7)", _
                        xISUD2351A & " - " & WordConv("DELETE") & "(F8)", _
                        "ALLOCATION REQUEST BASE - UPDATE", _
                        xISUD2351A & " - " & WordConv("UPDATE INVOICE") & "(F9)")


        vS20.ContextMenuStrip = Cms_2

        'Call Cms_additem(Cms_3, _
        '              "MATERIAL ALLOCATION PROCESSING " & " - " & WordConv("ALLOCATION") & "(F6)")
...
#Region "Function"
            ...
            Select Case True
                ...
                Case Vs10.Focused
                    If getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex) <> "" Then
                        If ISUD2351A.Link_ISUD2351A_AUTO(11, getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex),
                                                        Me.Name) = False Then Exit Sub

                    End If
                Case vS20.Focused

                    If ISUD2351D.Link_ISUD2351D(1, "", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        Try
            Select Case True
                ...
                Case Vs10.Focused
                    If getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex) <> "" Then
                        If ISUD2351A.Link_ISUD2351A_AUTO(11, getData(Vs10, getColumIndex(Vs10, "cdSemiGroupMaterial"), Vs10.ActiveSheet.ActiveRowIndex), getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex),
                                                        Me.Name) = False Then Exit Sub
                ...
                Case vS20.Focused
                    ...
                    If FormatCut(getData(vS20, getColumIndex(vS20, "FactOrderNo"), vS20.ActiveSheet.ActiveRowIndex)) = "" Then
                        If ISUD2351D.Link_ISUD2351D(2, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
                    Else
                        If ISUD2351A.Link_ISUD2351A(2, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
                    End If
    ...
    Private Sub MAIN_JOB03()
        Try
            Select Case True
                Case Vs10.Focused
                    If getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex) <> "" Then
                        If ISUD2351A.Link_ISUD2351A_AUTO_LINE(11, getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex), getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderSeq"), Vs10.ActiveSheet.ActiveRowIndex),
                                                        Me.Name) = False Then Exit Sub
                ...
                Case vS20.Focused
                    ...
                    'If ISUD2351A.Link_ISUD2351A(3, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub

                    If FormatCut(getData(vS20, getColumIndex(vS20, "FactOrderNo"), vS20.ActiveSheet.ActiveRowIndex)) = "" Then
                        If ISUD2351D.Link_ISUD2351D(3, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
                    Else
                        If ISUD2351A.Link_ISUD2351A(3, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
                    End If
    ...
    Private Sub MAIN_JOB04()
        Try
            Select Case True
                Case Vs10.Focused
                    If getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex) <> "" Then
                        If ISUD2351A.Link_ISUD2351A_AUTO_LINE(12, getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex), getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderSeq"), Vs10.ActiveSheet.ActiveRowIndex),
                                                        Me.Name) = False Then Exit Sub
                ...
                Case vS20.Focused
                    ...
                    'If ISUD2351A.Link_ISUD2351A(4, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub

                    If FormatCut(getData(vS20, getColumIndex(vS20, "FactOrderNo"), vS20.ActiveSheet.ActiveRowIndex)) = "" Then
                        If ISUD2351D.Link_ISUD2351D(4, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
                    Else
                        If ISUD2351A.Link_ISUD2351A(4, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
                    End If
        ...
        Try
            Select Case True
                Case vS20.Focused
                    ...
                    If FormatCut(getData(vS20, getColumIndex(vS20, "FactOrderNo"), vS20.ActiveSheet.ActiveRowIndex)) = "" Then
                        If ISUD2351D.Link_ISUD2351D(31, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
                    Else
                        If ISUD2351A.Link_ISUD2351A(31, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
                    End If
        ...
        Try
            Select Case True
                Case vS20.Focused
                    ...
                    If ISUD2351A.Link_ISUD2351A(5, CheckInBoundMaterial, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB31()
        Try
            ...
            KEY_MaterialInBoundNo = getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex)
            KEY_MaterialInboundSeq = getData(vS20, getColumIndex(vS20, "KEY_MaterialInboundSeq"), vS20.ActiveSheet.ActiveRowIndex)
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23516_SEARCH_VS10", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                    txt_cdSite.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP23516_SEARCH_VS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23516_SEARCH_vS20", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdSite.Code,
                                                    txt_FactOrderNo.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23516_SEARCH_vS20", "vS20")
            vS20.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23516_SEARCH_VS30", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdSite.Code,
                                                    txt_FactOrderNo.Data,
                                                    txt_SupplierCode.Data, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS30, DS1, "USP_PFP23516_SEARCH_VS30", "VS30")
            vS30.Enabled = True
            Exit Function
        End If
