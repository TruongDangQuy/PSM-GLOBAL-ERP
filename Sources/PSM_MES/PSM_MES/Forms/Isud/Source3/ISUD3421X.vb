...
#Region "Link"
    Public Function Link_ISUD3421X(job As Integer, FactOrderNo As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        Link_ISUD3421X = False
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3421X_SEARCH_HEAD", cn, L3421.FactOrderNo)
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421X_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421X_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "Vs1")
