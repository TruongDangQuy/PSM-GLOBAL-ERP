...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        vS50.ContextMenuStrip = Cms_2
        Call Cms_additem(Cms_2, _
                             "LIQUIDATION CONTROL" & " - " & WordConv("INPUT") & "(F5)",
                             "LIQUIDATION CONTROL" & " - " & WordConv("SEARCH") & "(F6)",
                             "LIQUIDATION CONTROL" & " - " & WordConv("UPDATE") & "(F7)",
                             "LIQUIDATION CONTROL" & " - " & WordConv("DELETE") & "(F8)")
...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_Vs10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13401_SEARCH_Vs10", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data, txt_InvoiceNo.Data)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP13401_SEARCH_Vs10", "Vs10")
    ...
    Private Function DATA_SEARCH_Vs20(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13401_SEARCH_Vs20", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data, txt_InvoiceNo.Data)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs20, DS1, "USP_PFP13401_SEARCH_Vs20", "Vs20")
    ...
    Private Function DATA_SEARCH_Vs30(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13401_SEARCH_Vs30", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data, txt_InvoiceNo.Data)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs30, DS1, "USP_PFP13401_SEARCH_Vs30", "Vs30")
    ...
    Private Function DATA_SEARCH_Vs40(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13401_SEARCH_Vs40", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs40, DS1, "USP_PFP13401_SEARCH_Vs40", "Vs40")
    ...
    Private Function DATA_SEARCH_Vs50(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13401_SEARCH_Vs50", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs50, DS1, "USP_PFP13401_SEARCH_Vs50", "Vs50")
