...
#Region "Link"
    Public Function Link_ISUD7110D(job As Integer, ShoesCode As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        ...
        If READ_PFK7106(ShoesCode) = False Then Link_ISUD7110D = False : Exit Function

        wJOB = job : L7106 = D7106
        If D7106.CheckComplete = "1" Then MsgBoxP("Already complete! Đã hoàn thành !", vbInformation)

        Link_ISUD7110D = False
...
next1:
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD7110D_SEARCH_VS2", cn, ShoesCode)


        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_ISUD7110D_SEARCH_VS2", "VS2")
