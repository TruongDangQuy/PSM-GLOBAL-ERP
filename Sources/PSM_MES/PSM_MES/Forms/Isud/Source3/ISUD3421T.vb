...
#Region "Link"
    Public Function Link_ISUD3421T(job As Integer, FactOrderNo As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "", Optional ByVal link_Subprocess As String = "", Optional ByVal link_ProcessName As String = "") As Boolean
        Link_ISUD3421T = False
    ...
    Public Function Link_ISUD3421T_INSERT(job As Integer, cdSubProcess As String, FactOrderNo As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        D3421.FactOrderNo = FactOrderNo
        D3422.FactOrderNo = FactOrderNo
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3421T_SEARCH_HEAD", cn, L3421.FactOrderNo)
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421T_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421T_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "Vs1")
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421T_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then

                DS2 = PrcDS("USP_ISUD3421T_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder & "_INSERT", cn, L3421.FactOrderNo)

                SPR_PRO_NEW(vS2, DS2, "USP_ISUD3421T_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS2")
            ...
            SPR_PRO_NEW(vS2, DS1, "USP_ISUD3421T_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS2")
            ...
            Call VsSizeRangeTitle(vS2, "USP_VS_SIZERANGE_3421D_S001", str_AutoLink, getData(Vs1, getColumIndex(Vs1, "cdSubProcess"), 0))
            Call VsSizeRangeTitle(vS2, "USP_VS_SIZERANGE_3421D_B001", str_AutoLink, getData(Vs1, getColumIndex(Vs1, "cdSubProcess"), 0))
    ...
    Private Sub Vs1_ButtonClicked(sender As Object, e As EditorNotifyEventArgs) Handles Vs1.ButtonClicked
        ...
        Select Case xCOL
            Case getColumIndex(Vs1, "CLcdMaterialCode_D")
                ...
                If _chk_CheckPurchasingOrder = "2" Then
