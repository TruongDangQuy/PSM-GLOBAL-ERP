...
#Region "Form_Load"
    Public Function Link_HLP7231Y(BasicName As String) As Boolean
        hlp0000SeVaTt = ""
        hlp0000SeVa = ""
        hlp0000SeVaTt1 = ""
...
#Region "Methods"
    ...
    Public Function DATA_SEARCH01(Head_No As Long) As Boolean
        ...
        Try
            ...
            If chk_FullText.Checked = False Then
                ...
                DS1 = PrcDS("USP_HLP7231Y_SEARCH_VS1", cn, txt_cdLargeGroupMaterial.Code, "*" & txt_Name.Data, txt_cdSemiGroupMaterial.Code, txt_cdDetailGroupMaterial.Code)
            Else
                ...
                DS1 = PrcDS("USP_HLP7231Y_SEARCH_VS1_FULLTEXT", cn, txt_cdLargeGroupMaterial.Code, strTemp, txt_cdSemiGroupMaterial.Code, txt_cdDetailGroupMaterial.Code)
            End If

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_HLP7231Y_SEARCH_VS1", "Vs1")
    ...
    Public Function DATA_SEARCH02() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_HLP7231Y_SEARCH_VS2", cn)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS2, DS1, "USP_HLP7231Y_SEARCH_VS2", "Vs2")
    ...
    Public Function DATA_SEARCH_HEAD_vs_Large() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_HLP7231Y_SEARCH_HEAD", cn, ListCode("LargeGroupMaterial"))
            SPR_PRO_NEW(vs_Large, DS1, "USP_HLP7231Y_SEARCH_HEAD", "vs_Large")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Semi() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_HLP7231Y_SEARCH_HEAD_DETAIL", cn, ListCode("SemiGroupMaterial"), ListCode("LargeGroupMaterial"), cdLargeGroupMaterial)
            SPR_PRO_NEW(vS_Semi, DS1, "USP_HLP7231Y_SEARCH_HEAD_DETAIL", "vS_Semi")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Detail() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_HLP7231Y_SEARCH_HEAD_DETAIL", cn, ListCode("DetailGroupMaterial"), ListCode("SemiGroupMaterial"), cdSemiGroupMaterial)
            SPR_PRO_NEW(vS_Detail, DS1, "USP_HLP7231Y_SEARCH_HEAD_DETAIL", "vS_Detail")
    ...
    Public Function DATA_SEARCH_HEAD_WIDTH() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_HLP7231Y_SEARCH_HEAD_WIDTH", cn, txt_cdLargeGroupMaterial.Code, txt_cdSemiGroupMaterial.Code, txt_cdDetailGroupMaterial.Code)

            If GetDsRc(DS1) = 0 Then
                DS2 = PrcDS("USP_HLP7231Y_SEARCH_HEAD_WIDTH_INSERT", cn)
                SPR_PRO_NEW(vS_Spec, DS2, "USP_HLP7231Y_SEARCH_HEAD_WIDTH", "vS_Spec")
                Exit Function
            End If

            SPR_PRO_NEW(vS_Spec, DS1, "USP_HLP7231Y_SEARCH_HEAD_WIDTH", "vS_Spec")
...
#Region "Events"
    ...
    Private Sub vs_Large_CellClick(sender As Object, e As CellClickEventArgs) Handles vs_Large.CellClick
        ...
        Try
            ...
            DS1 = PrcDS("USP_HLP7231Y_SEARCH_VS1_F1", cn, txt_cdLargeGroupMaterial.Code, "*" & txt_Name.Data, txt_Width.Data, txt_Height.Data, txt_SizeName.Data, txt_cdSemiGroupMaterial.Code, txt_cdDetailGroupMaterial.Code)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_HLP7231Y_SEARCH_VS1_F1", "Vs1")
                Vs1.Enabled = True
                Exit Sub
            End If
            SPR_PRO_NEW(Vs1, DS1, "USP_HLP7231Y_SEARCH_VS1_F1", "Vs1")
