...
#Region "Variable"
    ...
    Private W7261 As New T7261_AREA
    Private L7261 As New T7261_AREA
...
#Region "Link"
    Public Function Link_ISUD7260A(job As Integer, ContractID As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        D7260.ContractID = ContractID
        D7261.ContractID = ContractID

        wJOB = job : L7260 = D7260 : L7261 = D7261

        Link_ISUD7260A = False
        Try

            Select Case job
                Case 1
                    D7260.CustomerCode = ContractID
            ...
            Link_ISUD7260A = isudCHK
        Catch ex As Exception
            Call MsgBoxP("61", WordConv("Link_ISUD7260A"))
        End Try
    ...
    Public Function Link_ISUD7260A_MaterialCode(job As Integer, ContractID As String, MaterialCode As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        Link_ISUD7260A_MaterialCode = False
        ...
        Try
            ...
            Link_ISUD7260A_MaterialCode = isudCHK
        Catch ex As Exception
            Call MsgBoxP("61", WordConv("Link_ISUD7260A"))
        End Try
        ...
        Try
            ...
            If wJOB <> "2" And rad_CheckMaterialType2.Checked Then
                If bolCheckRNDPrice = False Then
                    If MsgBoxPPW("Please type the password to modify!", const_pwMRNDPrice) = False Then wJOB = "2" : GoTo next1
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD7260A_SEARCH_HEAD", cn, L7260.ContractID)
        ...
        CheckProcessType(GetDsData(DS1, 0, "K7260_CheckProcessType"))
        CheckIOType(GetDsData(DS1, 0, "K7260_CheckIOType"))
        CheckMaterialType(GetDsData(DS1, 0, "K7260_CheckMaterialType"))
        CheckMarketType(GetDsData(DS1, 0, "K7260_CheckMarketType"))
        CheckRelationType(GetDsData(DS1, 0, "K7260_CheckRelationType"))
        CheckUse(GetDsData(DS1, 0, "K7260_CheckUse"))
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD7260A_SEARCH_VS1", cn, L7260.ContractID)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD7260A_SEARCH_VS1", "Vs1")
...
#Region "Function"
    ...
    Private Sub DATA_MOVE_DEFAULT()
        W7260.seBuyingType = ListCode("BuyingType")
        W7260.seCommercialTerm = ListCode("CommercialTerm")
        W7260.seOrigin = ListCode("Origin")

        W7260.seDeliveryTerm = ListCode("DeliveryTerm")
        W7260.sePaymentTerm = ListCode("PaymentTerm")
        W7260.sePaymentCondition = ListCode("PaymentCondition")
        W7260.sePaymentTime = ListCode("PaymentTime")
        W7260.sePaymentDay = ListCode("PaymentDay")

        W7260.seUnitPrice = ListCode("UnitPrice")

        W7261.seDepartment = ListCode("Department")
        W7261.seUnitMaterial = ListCode("UnitMaterial")
        W7261.seUnitPacking = ListCode("UnitPacking")
        W7261.seUnitPrice = ListCode("UnitPrice")
    ...
    Private Sub DATA_MOVE_WRITE01()
        ...
        For i = 0 To Vs1.ActiveSheet.RowCount - 1
            ...
            j = j + 1
            If K7261_MOVE(Vs1, i, W7261, L7261.ContractID, getData(Vs1, getColumIndex(Vs1, "KEY_ContracSeq"), i)) = True Then


                W7261.PriceMaterialEX = CDecp(txt_PriceExchange.Data) * W7261.PriceMaterialVND
                W7261.cdUnitPrice = txt_cdUnitPrice.Code
                W7261.Dseq = j

                If W7261.cdDepartment = "" Then
                    If txt_cdDepartment.Code <> "" Then W7261.cdDepartment = txt_cdDepartment.Code
                End If

                Call DATA_MOVE_DEFAULT()
                Call REWRITE_PFK7261(W7261)
            Else
                W7261.ContractID = L7260.ContractID
                W7261.PriceMaterialEX = CDecp(txt_PriceExchange.Data) * W7261.PriceMaterialVND
                Call KEY_COUNT_SEQ()
...
skip:
    ...
    Private Sub DATA_INSERT()
        ...
        Try
            If K7260_MOVE(Me, W7260, 1, L7260.ContractID) = False Then

                Call KEY_COUNT()

                If rad_CheckRelationType1.Checked = True Then W7260.CheckRelationType = "1"
                If rad_CheckRelationType2.Checked = True Then W7260.CheckRelationType = "2"

                If rad_CheckProcessType1.Checked = True Then W7260.CheckProcessType = "1"
                If rad_CheckProcessType2.Checked = True Then W7260.CheckProcessType = "2"

                If rad_CheckIOType1.Checked = True Then W7260.CheckIOType = "1"
                If rad_CheckIOType2.Checked = True Then W7260.CheckIOType = "2"

                If rad_CheckMaterialType1.Checked = True Then W7260.CheckMaterialType = "1"
                If rad_CheckMaterialType2.Checked = True Then W7260.CheckMaterialType = "2"

                If rad_CheckMarketType1.Checked = True Then W7260.CheckMarketType = "1"
                If rad_CheckMarketType2.Checked = True Then W7260.CheckMarketType = "2"

                If opt_XCHK0.Checked = True Then W7260.CheckUse = "1"
                If opt_XCHK1.Checked = True Then W7260.CheckUse = "2"

                Call DATA_MOVE_DEFAULT()

                W7260.DateInsert = Pub.DAT
                W7260.InchargeInsert = Pub.SAW
                W7260.CheckSupplierPrice = "3"

                If WRITE_PFK7260(W7260) = True Then
    ...
    Private Sub DATA_UPDATE()
        Try
            ...
            If K7260_MOVE(Me, W7260, 3, L7260.ContractID) = True Then
                If rad_CheckProcessType1.Checked = True Then W7260.CheckProcessType = "1"
                If rad_CheckProcessType2.Checked = True Then W7260.CheckProcessType = "2"
                ...
                W7260.DateUpdate = Pub.DAT
                W7260.InchargeUpdate = Pub.SAW
    ...
    Private Sub DATA_DELETE()
        ...
        Try
            If READ_PFK7260(L7260.ContractID) Then
                W7260 = D7260
                Call DELETE_PFK7260(W7260)

                Call Delete_History("PFK7260", W7260.ContractID)
            End If
    ...
    Private Function DATA_LINE_DELETE(xrow As Integer) As Boolean
        ...
        Try
            If READ_PFK7261(getData(Vs1, getColumIndex(Vs1, "KEY_ContractID"), xrow),
                            getData(Vs1, getColumIndex(Vs1, "KEY_ContracSeq"), xrow)) = True Then

                W7261 = D7261

                If DELETE_PFK7261(W7261) = True Then

                    Call Delete_History("PFK7261", W7261.ContractID & "-" & W7261.MaterialCode & "-" & W7261.ColorName)
    ...
    Private Sub KEY_COUNT()
        ...
        Try
            SQL = "SELECT MAX(CAST(K7260_ContractID AS DECIMAL)) AS MAX_MCODE FROM PFK7260 "
            ...
            If IsDBNull(rd!MAX_MCODE) Then
                W7260.ContractID = "000001"
            Else
                W7260.ContractID = Format(CIntp(rd!MAX_MCODE + 1), "000000")
            End If

            rd.Close()

            txt_ContractID.Data = W7260.ContractID
            L7260.ContractID = W7260.ContractID

            L7261.ContractID = W7260.ContractID
            W7261.ContractID = W7260.ContractID
    ...
    Private Sub KEY_COUNT_SEQ()
        Try
            SQL = "SELECT MAX(CAST(K7261_ContracSeq AS DECIMAL)) AS MAX_MCODE FROM PFK7261 WHERE K7261_ContractID =  '" + L7260.ContractID + "'"
            ...
            If IsDBNull(rd!MAX_MCODE) Then
                W7261.ContracSeq = 1
            Else
                W7261.ContracSeq = CIntp(rd!MAX_MCODE + 1)
            End If

            rd.Close()

            L7261.ContracSeq = W7261.ContracSeq
            W7261.ContracSeq = W7261.ContracSeq
    ...
    Private Function DATA_UPDATE_APPROVED(xStatus As String) As Boolean
        ...
        Try
            If READ_PFK7260(L7260.ContractID) = True Then
                ...
                Select Case xStatus
                    Case "1"
                        W7260.CheckSupplierPrice = xStatus
                        W7260.DatePending1 = ""

                    Case "3"
                        W7260.CheckSupplierPrice = xStatus
                        W7260.DateApproved = Pub.DAT
...
#Region "Event"
    Private Sub tst_iSave_Click(sender As Object, e As EventArgs) Handles tst_iSave.Click
        Select Case wJOB
            Case 1
                If DataCheck(Me, "PFK7260") = False Then Exit Sub
