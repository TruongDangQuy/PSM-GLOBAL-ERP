...
#Region "Event"
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        ...
        Try
            ...
            'DELETE A_SHEETPRINT
            SQL = "DELETE FROM [CS_PRINT].[dbo].[A_SHEETPRINT_MAIN]"
            ...
            If chk_FitRow.Checked = True Then
                SQL = "Insert into [CS_PRINT].[dbo].[A_SHEETPRINT_MAIN]"
                SQL = SQL + " VALUES('" + proname1.Data + "','" + CIntp(txt_MAXROW.Data).ToString + "','" + CIntp(txt_MAXCOL.Data).ToString + "','" + CIntp(txt_IDCOL.Data).ToString + "','" + CIntp(txt_IDROWBEGIN.Data).ToString + "','" + CIntp(txt_IDROWEND.Data).ToString + "',1)"
                cmd = New SqlClient.SqlCommand(SQL, cn)
                cmd.ExecuteNonQuery()
            Else
                SQL = "Insert into [CS_PRINT].[dbo].[A_SHEETPRINT_MAIN]"
                SQL = SQL + " VALUES('" + proname1.Data + "','" + CIntp(txt_MAXROW.Data).ToString + "','" + CIntp(txt_MAXCOL.Data).ToString + "','" + CIntp(txt_IDCOL.Data).ToString + "','" + CIntp(txt_IDROWBEGIN.Data).ToString + "','" + CIntp(txt_IDROWEND.Data).ToString + "',2)"
                cmd = New SqlClient.SqlCommand(SQL, cn)
                cmd.ExecuteNonQuery()
            End If
            ...
            'DELETE A_SHEETPRINT merge
            If chk_MER.Checked Then


                SQL = "DELETE FROM [CS_PRINT].[dbo].[A_SHEETPRINT_MERGE]"
                SQL = SQL + " WHERE [M_SHEETREPORT] = '" + proname1.Data + "'"
                SQL = SQL + "   AND [M_IDCOL] = '" + CIntp(txt_M_IDCOL.Data).ToString + "'"
                cmd = New SqlClient.SqlCommand(SQL, cn)
                cmd.ExecuteNonQuery()

                SQL = "Insert into [CS_PRINT].[dbo].[A_SHEETPRINT_MERGE]"
                SQL = SQL + " VALUES('" + proname1.Data + "','" + CIntp(txt_M_IDCOL.Data).ToString + "','" + CIntp(txt_M_IDROWBEGIN.Data).ToString + "','" + CIntp(txt_M_IDROWEND.Data).ToString + "',1)"
                cmd = New SqlClient.SqlCommand(SQL, cn)
                cmd.ExecuteNonQuery()
            End If
    ...
    Private Sub cmd_DEL_Click(sender As Object, e As EventArgs) Handles cmd_Read.Click
        ...
        Try
            ...
            str = "http://10.0.0.246:6847/CS_WHM/Report/" & proname1.Data & ".xlsx"
        ...
        Catch ex As Exception
            Try
                str = "http://"
                str += Pub.SER.Replace(",", ":")
                str += ":6846/CS_WHM/Report/" & proname1.Data & ".xls"
    ...
    Private Sub vS1_RightClick(ByVal sender As Object, e As CellClickEventArgs) Handles Vs1.CellClick
        ...
        SELECTid = oMenu.PopupNew(sender, e.X, e.Y,
                               ...
                               WordConv("END ROW - Last Value Row"),
                                "-",
                               WordConv("FIX COLUMN - Merge Column"), _
                               WordConv("START ROW MERGE - First Row Start Merge"),
                               WordConv("END ROW MERGE - Last Row Start Merge"))
        ...
        Select Case SELECTid
            ...
            Case 7
                txt_M_IDCOL.Data = CIntp(e.Column)
            Case 8
                txt_M_IDROWBEGIN.Data = CIntp(e.Row)
            Case 9
                txt_M_IDROWEND.Data = CIntp(e.Row)
        End Select
    ...
    Private Sub cmd_Save_Click(sender As Object, e As EventArgs) Handles cmd_Save.Click
        ...
        Try
            ...
            If chk_MER.Checked Then
                ...
                MsgBoxP("Save merge successfully!", vbInformation)
            End If

        Catch ex As Exception
            Call MsgBoxP("cmd_Save_Click Merge")
        End Try
    End Sub
