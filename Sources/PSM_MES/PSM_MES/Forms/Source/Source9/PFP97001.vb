...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP97001_SEARCH_VS1", cn, SdateEdate.text1, SdateEdate.text2, txt_UserName.Code, txt_FromName.Data)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP97001_SEARCH_VS1", "VS1")
            Vs1.Enabled = True
            Exit Function
        End If
