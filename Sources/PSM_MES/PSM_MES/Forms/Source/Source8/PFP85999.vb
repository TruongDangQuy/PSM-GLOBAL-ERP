...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        ProcName = "USP_PFP85999_SEARCH_VS1_" & Pre_FormName

        DS1 = PrcDS(ProcName, cn, txt_Year.Value.ToString("0000") & txt_Month.Value.ToString("00"), txt_cdSubProcess.Code)
