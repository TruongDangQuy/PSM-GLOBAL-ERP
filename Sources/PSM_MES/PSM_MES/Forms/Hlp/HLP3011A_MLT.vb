...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDSVN("USP_HLP3011MLT_SEARCH_APPROVAL_VS1", cn,
                                                        SdateEdate.text1,
                                                        SdateEdate.text2,
                                                        txt_cdSeason.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(PeacePanalSeach, DS1, "USP_HLP3011MLT_SEARCH_APPROVAL_VS1", "Vs1")
...
#Region "Event"
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        ...
        Try
            ...
            '    ElseIf getDataM(PeacePanalSeach, getColumIndex(PeacePanalSeach, "CheckUse"), i) = "1" And CIntp(getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "OrderNoSeq"), i)) > 0 Then
            '        CheckValue = True
            '        hlp0000SeVa &= getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_OrderNo"), i) & "," & getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_OrderNoSeq"), i) & "|"
            '    End If
            'Next

            If chk_CheckDate.Checked = False Then
                For i = 0 To PeacePanalSeach.ActiveSheet.RowCount - 1
                    If getDataM(PeacePanalSeach, getColumIndex(PeacePanalSeach, "CheckUse"), i) = "1" Then
                        CheckValue = True
                        hlp0000SeVa &= getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_OrderNo"), i) & "," & getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_OrderNoSeq"), i) & "," & getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_Autokey"), i) & ","
                        hlp0000SeVa &= getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_PurchasingOrderNo"), i) & ","
                        hlp0000SeVa &= getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_PurchasingOrderSeq"), i) & ","
                        hlp0000SeVa &= "|"
                    End If
                Next
            End If
