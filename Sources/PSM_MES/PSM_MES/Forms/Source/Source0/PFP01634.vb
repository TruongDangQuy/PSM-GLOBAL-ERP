Public Class PFP01634

#Region "Variable"
    Private Dsu01 As Long
    Private wGCODE As String
    Private priFName As String
...
#Region "Form_load"
    ...
    End Sub
    Private Sub PFP01634_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP01634_SEARCH_VS10_PIVOT_" & priFName, cn, xSdate, xEdate, txt_cdMainProcess.Code, "", "")

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP01634_SEARCH_VS10_PIVOT_" & priFName, "Vs10")
                Vs10.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP01634_SEARCH_VS20_PIVOT_" & priFName, cn, xSdate, xEdate, txt_cdMainProcess.Code, "", "")

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS20, DS1, "USP_PFP01634_SEARCH_VS20_PIVOT_" & priFName, "VS20")
                vS20.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        VS30.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01634_SEARCH_VS30_PIVOT_" & priFName, cn, SdateEdate.text1, SdateEdate.text2, txt_cdMainProcess.Code, "", "")

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS30, DS1, "USP_PFP01634_SEARCH_VS30_PIVOT_" & priFName, "VS30")
                VS30.Enabled = True
                Exit Function
            End If
...
#Region "Event"
    ...
    Private Sub PFP01634_Resize(sender As Object, e As EventArgs) Handles Me.Resize
