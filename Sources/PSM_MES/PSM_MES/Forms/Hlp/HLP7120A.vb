...
#Region "Formload"
    ...
    Public Function Link_HLP7120A(Optional ByVal TAG As String = "") As Boolean
        Link_HLP7120A = False
        Me.Tag = TAG
        ...
        Try
            ...
            Me.ShowDialog()
            Link_HLP7120A = isudCHK

        Catch ex As Exception
            Call MsgBoxP("61", WordConv("YARN PROCESSING"))
        End Try
    End Function
    Public Function Link_HLP7120A_SHOESCODE(ByVal SHOESCODE As String, Optional ByVal TAG As String = "") As Boolean
        Link_HLP7120A_SHOESCODE = False
        txt_TechnicianName.Code = SHOESCODE

        If READ_PFK7106(SHOESCODE) Then
            txt_TechnicianName.Data = D7106.Article & "-" & D7106.Line & "-" & D7106.ColorName
        End If
        ...
        Try
            ...
            Me.ShowDialog()
            Link_HLP7120A_SHOESCODE = isudCHK
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        DATA_SEARCH01 = False
        If txt_TechnicianName.Data = "" Then txt_TechnicianName.Code = ""
        Vs1.Enabled = False

        DS1 = PrcDS("USP_HLP7120A_SEARCH_VS1", cn, txt_TechnicianName.Data)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_HLP7120A_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7120A_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO_NEW(Vs2, DSNEW, "USP_HLP7120A_SEARCH_VS2", "Vs2")
