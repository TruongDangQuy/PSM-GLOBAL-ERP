...
#Region "Link"
    Public Function Link_ISUD3421C(job As Integer, FactOrderNo As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3421C_SEARCH_HEAD", cn, L3421.FactOrderNo)
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421C_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421C_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "Vs1")
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421C_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then

                DS2 = PrcDS("USP_ISUD3421C_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder & "_INSERT", cn, L3421.FactOrderNo)

                SPR_PRO_NEW(vS2, DS2, "USP_ISUD3421C_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS2")
            ...
            SPR_PRO_NEW(VS2, DS1, "USP_ISUD3421C_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS2")
            Call VsSizeRangeNew(vS2, "USP_VS_SIZERANGE_MATERIALCODE", "SizeQty01", getData(Vs1, getColumIndex(Vs1, "MaterialCode"), 0), getData(Vs1, getColumIndex(Vs1, "cdSubProcess"), 0))
