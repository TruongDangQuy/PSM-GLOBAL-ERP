...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP30216_SEARCH_VS10", cn,
                    txt_cdSite.Code,
                    txt_CustPONO.Data,
                    txt_Article.Data,
                    txt_SupplierCode.Code,
                    rad_Check1.CheckState,
                    rad_Check2.CheckState,
                    rad_Check3.CheckState,
                    rad_Check4.CheckState,
                    txt_MaterialName.Data,
                    txt_cdSupplierGroup.Data,
                    txt_cdLargeGroupMaterial.Data,
                    txt_CustomerCode.Data,
                    txt_InvoiceName.Data)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP30216_SEARCH_VS10", "vS10")
