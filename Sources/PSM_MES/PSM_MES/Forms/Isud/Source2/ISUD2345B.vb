...
#Region "Link"
    Public Function Link_ISUD2345B(job As Integer, FactOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD2345B = False
    ...
    Public Function Link_ISUD2345B_AUTO(job As Integer, cdSeason As String, CustomerCode As String, SupplierCode As String, _Line As String, _cdLargeGroupMaterial As String, _cdSemiGroupMaterial As String, _checkSample As String, FactOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD2345B_AUTO = False
        ...
        Try
            ...
            Link_ISUD2345B_AUTO = isudCHK
        Catch ex As Exception
            '          Call MsgBoxP("61", WordConv("Request Order Processing"))
        End Try
    End Function

    Public Function Link_ISUD2345B_AUTO_NEW(job As Integer, PRNO As String, Value As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD2345B_AUTO_NEW = False
        Try
            Me.Tag = TAG
            Chk_AutoLink = True
            ...
            Link_ISUD2345B_AUTO_NEW = isudCHK
        Catch ex As Exception
            '            Call MsgBoxP("61", WordConv("Request Order Processing"))
        End Try
    ...
    Public Function Link_ISUD2345B_INSERT_MULTI(job As Integer, Value As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD2345B_INSERT_MULTI = False
        Try
            List_AutoKey = Value
            ...
            Link_ISUD2345B_INSERT_MULTI = isudCHK
        Catch ex As Exception
    ...
    Public Function Link_ISUD2345B_INSERT_INBOUND(job As Integer, Value As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD2345B_INSERT_INBOUND = False
        Try
            strInbound = Value
            ...
            Link_ISUD2345B_INSERT_INBOUND = isudCHK
        Catch ex As Exception
...
#Region "Form"
    Private Sub Form_Activate(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Select Case wJOB
            ...
            Case 21
                Me.Text = Me.Text & " - INSERT INBOUND"
                If CHK(1) <> "1" Then
                    isudCHK = False
                    formA = True
                    Me.Dispose()
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD2345B_SEARCH_HEAD", cn, L2345.FactOrderNo)
    ...
    Private Function DATA_SEARCH_VS0() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD2345B_SEARCH_VS0", cn, L2345.FactOrderNo)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS0, DS1, "USP_ISUD2345B_SEARCH_VS0", "VS0")
            vS0.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS1_INSERT() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD2345B_SEARCH_VS1_INSERT_MULTI", cn, List_AutoKey)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD2345B_SEARCH_VS1_F1", "Vs1")
            ...
            strAutokey = GetDsData(DS1, 0, "PurchasingOrderNo")

            If READ_PFK3411(strAutokey) Then

                Call READ_PFK7101(D3411.CustomerCode)

                txt_CustomerCode.Code = D7101.CustomerCode
                txt_CustomerCode.Data = D7101.CustomerName

                Call READ_PFK7101(D3411.SupplierCode)

                txt_SupplierCode.Code = D7101.CustomerCode
                txt_SupplierCode.Data = D7101.CustomerName

                txt_cdUnitPrice.Code = D3411.cdUnitPrice

                Call READ_PFK7171(D3411.selUnitPrice, D3411.cdUnitPrice)
    ...
    Private Function DATA_SEARCH_VS1_INSERT_INBOUND() As Boolean
        DATA_SEARCH_VS1_INSERT_INBOUND = False
        Try
            Dim i As Integer

            DS1 = PrcDS("USP_ISUD2345B_SEARCH_VS1_INSERT_INVOICE", cn, strInbound)
            ...
            DATA_SEARCH_VS1_INSERT_INBOUND = True
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD2345B_SEARCH_VS1_F1", cn, L2345.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD2345B_SEARCH_VS1_F1", "Vs1")
                Vs1.ActiveSheet.RowCount = 1
                Vs1.Enabled = True
    ...
    Private Function DATA_SEARCH_VS1_STOCK() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD2345B_SEARCH_VS1_F1_COPY", cn, L2345.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD2345B_SEARCH_VS1_F1", "Vs1")
                Vs1.Enabled = True
                Exit Function
...
skip:
    ...
    Private Function Data_Check() As Boolean
        ...
        If txt_FactOrderName.Data = "" Then MsgBoxP("Receipte Note Pls !") : Setfocus(txt_FactOrderName) : Exit Function
                    ...
                    If READ_PFK7101(txt_SupplierCode.Code) = True Then
                        ...
                        For i = 0 To Array_hlp0000SeVaTt.Count - 1
                            If READ_PFK7231(Array_hlp0000SeVaTt1(i)) Then
                                ...
                                DS1 = PrcDS("USP_ISUD2345B_SEARCH_VS1_INSERT_SUPPLIER", cn, Array_hlp0000SeVaTt(i), Array_hlp0000SeVaTt1(i), xCheckMaterialType)

                                Call READ_SPREAD_N(Vs1, DS1, xROW, GetDsRc(DS1), "USP_ISUD2345B_SEARCH_VS1_F1", "VS1")
