...
#Region "Data Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_PFP72316_SEARCH_VS1", cn, "*" & txt_Name.Data,
                                                    "",
                                                    "",
                                                    "",
        ...
        If GetDsRc(DS1) = 0 Then
            Vs1.Enabled = True
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP72316_SEARCH_VS1", "Vs1")
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            Dim RS01 As DataRow = Nothing
            DS1 = PrcDS("USP_PFP72316_SEARCH_VS1_LINE", cn, getData(Vs1, getColumIndex(Vs1, "Key_MaterialCode"), Vs1.ActiveSheet.ActiveRowIndex))

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(Vs1, DS1, "USP_PFP72316_SEARCH_VS1", "Vs1", Vs1.ActiveSheet.ActiveRowIndex)
