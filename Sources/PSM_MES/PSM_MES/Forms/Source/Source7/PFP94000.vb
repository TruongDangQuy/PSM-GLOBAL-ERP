...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        ...
        If CheckChild = False Then DS1 = PrcDS("USP_PFP94000_SEARCH_VS1", cn, "000") Else DS1 = PrcDS("USP_PFP94000_SEARCH_VS1", cn, StrSchild)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_PFP94000_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02_LINE(BasicSel As String, BasicCode As String) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_PFP94000_SEARCH_vS2_LINE", cn, BasicSel, BasicCode)

            If GetDsRc(DSNEW) = 0 Then
                Exit Function
            End If

            READ_SPREAD(Vs2, DSNEW, "USP_PFP94000_SEARCH_VS2", "Vs2", Vs2.ActiveSheet.ActiveRowIndex)
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_PFP94000_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO_NEW(Vs2, DSNEW, "USP_PFP94000_SEARCH_VS2", "Vs2")
