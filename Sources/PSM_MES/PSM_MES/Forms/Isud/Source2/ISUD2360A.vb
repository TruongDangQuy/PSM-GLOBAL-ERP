...
#Region "Form"
    Public Function Link_ISUD2360A(job As Integer, MaterialInboundNo As String, MaterialInBoundSeq As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG

        D2351.MaterialInBoundNo = MaterialInboundNo
        D2351.MaterialInBoundSeq = MaterialInBoundSeq

        txt_Barcode.Data = FormatCut(MaterialInboundNo + MaterialInBoundSeq)

        wJOB = job : L2351 = D2351

        If READ_PFK2351(L2351.MaterialInBoundNo, L2351.MaterialInBoundSeq) Then
            txt_QtyInbound.Data = Format2(CDecp(D2351.QtyInBound))
...
#Region "Search"
    ...
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_ISUD2360A_SEARCH_VS1", cn, txt_PRName.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS1, DS1, "USP_ISUD2360A_SEARCH_VS1", "Vs1")
            Vs1.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD2360A_SEARCH_VS2", cn, txt_Barcode.Data)


            If GetDsRc(DS1) = 0 Then
                SPR_SET(vS2, , , , OperationMode.Normal)
                SPR_PRO(vS2, DS1, "USP_ISUD2360A_SEARCH_VS2", "VS2")
...
#Region "Function"
    ...
    Private Function DATA_MOVE_K2360() As Boolean
        DATA_MOVE_K2360 = False
        ...
        Try
            ...
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                ...
                OrderNo = getData(vS2, getColumIndex(vS2, "KEY_OrderNo"), i)
                OrderNoSeq = CDecp(getData(vS2, getColumIndex(vS2, "KEY_OrderNoSeq"), i))

                Call PrcExeNoError("USP_PFK2360_INSERT_PFK3011", cn, OrderNo, OrderNoSeq, L2351.MaterialInBoundNo, L2351.MaterialInBoundSeq, QtyInbound, Pub.SAW)
...
#Region "Event"
    ...
    Private Sub txt_GreyFullNo_txtTextKeyDown(sender As Object, e As KeyEventArgs) Handles txt_Barcode.txtTextKeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            L2351.MaterialInBoundNo = Strings.Left(txt_Barcode.Code, 9)
            L2351.MaterialInBoundSeq = Strings.Mid(txt_Barcode.Code, 10, 3)
...
#End Region
    ...
    Private Sub vS1_CellClick(sender As Object, e As CellClickEventArgs) Handles vS1.CellDoubleClick
        Try
            ...
            If READ_PFK1312(KEY_OrderNo, KEY_OrderNoSeq) Then
                ...
                setData(vS2, getColumIndex(vS2, "MaterialInBoundNo"), vS2.ActiveSheet.RowCount - 1, L2351.MaterialInBoundNo)
                setData(vS2, getColumIndex(vS2, "MaterialInBoundSeq"), vS2.ActiveSheet.RowCount - 1, L2351.MaterialInBoundSeq)
