...
#Region "Variable"
    ...
    Private W3423 As New T3423_AREA
    Private L3423 As New T3423_AREA
...
#Region "Search"
    ...
    Private Function DATA_SEARCH_VS0() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421A_O_SEARCH_VS0_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(VS0, DS1, "USP_ISUD3421A_O_SEARCH_VS0_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS0")
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421A_O_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421A_O_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "Vs1")
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421A_O_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(VS2, DS1, "USP_ISUD3421A_O_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS2")
    ...
    Private Function DATA_SEARCH_VS3() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421A_O_SEARCH_VS3_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(VS3, DS1, "USP_ISUD3421A_O_SEARCH_VS3_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS3")
...
#Region "Function"
    ...
    Private Sub DATA_MOVE_DEFAULT()
        ...
        If W3421.cdUnitPrice = "001" Then W3421.PriceExchange = 1
...
skip:
    ...
    Private Sub DATA_MOVE_WRITE00()

        Dim i As Integer
        Dim j As Integer
        j = 0
        For i = 0 To vS0.ActiveSheet.RowCount - 1
            If Trim(getData(vS0, getColumIndex(vS0, "Slno"), i)) = "" Then GoTo skip

            j = j + 1

            W3423.FactOrderNo = L3421.FactOrderNo
            W3423.OrderNo = getData(vS0, getColumIndex(vS0, "OrderNo"), i)
            W3423.OrderNoSeq = getData(vS0, getColumIndex(vS0, "OrderNoSeq"), i)
            W3423.JobCard = getData(vS0, getColumIndex(vS0, "JobCard"), i)

            If READ_PFK3423(W3423.FactOrderNo, W3423.OrderNo, W3423.OrderNoSeq, W3423.JobCard) = True Then
                W3423 = D3423
                W3423.QtyOrder = CDecp(getData(vS0, getColumIndex(vS0, "QtyOrder"), i))

                Call REWRITE_PFK3423(W3423)
            Else
                W3423.FactOrderNo = L3421.FactOrderNo
                W3423.OrderNo = getData(vS0, getColumIndex(vS0, "OrderNo"), i)
                W3423.OrderNoSeq = getData(vS0, getColumIndex(vS0, "OrderNoSeq"), i)
    ...
    Private Sub DATA_UPDATE_AFTER()
        ...
        Try
            If READ_PFK3421(L3421.FactOrderNo) = True Then
                ...
                W3421.cdSeason = txt_cdSeason.Code
            ...
            If READ_PFK3422_1(L3421.FactOrderNo) = False Then
                If READ_PFK3421(L3421.FactOrderNo) = True Then
                    ...
                    If DELETE_PFK3421(W3421) = True Then
                        ...
                        Call DELETE_PFK3423_1(L3421.FactOrderNo)
                        Call Delete_History("PFK3423", W3423.FactOrderNo)
    ...
    Private Function Data_Check() As Boolean
        ...
        Try
            For i = 0 To Vs1.ActiveSheet.RowCount - 1
                ...
                'If FormatCut(getData(Vs1, getColumIndex(Vs1, "cdSubProcess"), i)) = "" Then MsgBoxP("SubProcess at Line" & (i + 1)) : Exit Function
...
#Region "Event"
    ...
    Private Sub Vs1_ButtonClicked(sender As Object, e As EditorNotifyEventArgs) Handles Vs1.ButtonClicked
        ...
        Select Case xCOL
            ...
            Case getColumIndex(Vs1, "CLcdMaterialCode_In")
                ...
                SealNo = getData(Vs1, getColumIndex(Vs1, "SlNo"), xROW)
                ...
                Else
                    ...
                    Dim CLJobCard As String
                    Dim cdLineProdName As String
                    Dim cdLineProd As String
                    Dim CLcdLineProd As String
                    Dim cdSubProcessName As String
                    Dim cdSubProcess As String
                    Dim cdDepartmentName As String
                    Dim cdDepartment As String
                    Dim cdSiteName As String
                    Dim cdSite As String
                    Dim SelSite As String

                    ShoesCode = getData(Vs1, getColumIndex(Vs1, "Key_ShoesCode"), Vs1.ActiveSheet.ActiveRowIndex)
                    SlNo = getData(Vs1, getColumIndex(Vs1, "SlNo"), xROW)
                    OrderNoSeq = getData(Vs1, getColumIndex(Vs1, "OrderNoSeq"), xROW)
                    OrderNo = getData(Vs1, getColumIndex(Vs1, "OrderNo"), xROW)
                    CLJobCard = getData(Vs1, getColumIndex(Vs1, "CLJobCard"), xROW)
                    cdLineProdName = getData(Vs1, getColumIndex(Vs1, "cdLineProdName"), xROW)
                    cdLineProd = getData(Vs1, getColumIndex(Vs1, "cdLineProd"), xROW)
                    CLcdLineProd = getData(Vs1, getColumIndex(Vs1, "CLcdLineProd"), xROW)
                    cdSubProcessName = getData(Vs1, getColumIndex(Vs1, "cdSubProcessName"), xROW)
                    cdSubProcess = getData(Vs1, getColumIndex(Vs1, "cdSubProcess"), xROW)
                    cdDepartmentName = getData(Vs1, getColumIndex(Vs1, "cdDepartmentName"), xROW)
                    cdDepartment = getData(Vs1, getColumIndex(Vs1, "cdDepartment"), xROW)
                    cdSiteName = getData(Vs1, getColumIndex(Vs1, "cdSiteName"), xROW)
                    cdSite = getData(Vs1, getColumIndex(Vs1, "cdSite"), xROW)
                    SelSite = getData(Vs1, getColumIndex(Vs1, "SelSite"), xROW)

                    If HLP7108C.Link_HLP7108C_SHOESCODE(ShoesCode) = True Then

                        If hlp0000SeVaTt = "" Or hlp0000SeVaTt1 = "" Then Exit Sub

                        G_BOM = hlp0000SeVaTt.Split("|")
                        G_Seq = hlp0000SeVaTt1.Split("|")


                        If G_BOM.Length = 0 Then Exit Sub
                        For Arr_Index = 0 To G_BOM.Length - 1


                            If G_BOM(Arr_Index) <> "" Then
                                If READ_PFK7109(G_BOM(Arr_Index), G_Seq(Arr_Index)) = True Then


                                    If xROW + Arr_Index >= Vs1.ActiveSheet.RowCount - 1 Then
                                        Vs1.ActiveSheet.RowCount += 1
                                    End If

                                    setData(sender, getColumIndex(Vs1, "SlNo"), xROW, SlNo)
                                    setData(sender, getColumIndex(Vs1, "OrderNoSeq"), xROW, OrderNoSeq)
                                    setData(sender, getColumIndex(Vs1, "cdLineProdName"), xROW, cdLineProdName)
                                    setData(sender, getColumIndex(Vs1, "cdLineProd"), xROW, cdLineProd)
                                    setData(sender, getColumIndex(Vs1, "CLcdLineProd"), xROW, CLcdLineProd)
                                    setData(sender, getColumIndex(Vs1, "cdSubProcessName"), xROW, cdSubProcessName)

                                    setData(sender, getColumIndex(Vs1, "cdSubProcess"), xROW, cdSubProcess)
                                    setData(sender, getColumIndex(Vs1, "cdDepartmentName"), xROW, cdDepartmentName)
                                    setData(sender, getColumIndex(Vs1, "cdSiteName"), xROW, cdSiteName)
                                    setData(sender, getColumIndex(Vs1, "cdSite"), xROW, cdSite)
                                    setData(sender, getColumIndex(Vs1, "SelSite"), xROW, SelSite)


                                    '''
                                    Call READ_PFK7231(D7109.MaterialCode)
                                    setData(sender, getColumIndex(Vs1, "MaterialCode"), xROW, D7231.MaterialCode)
                                    setData(sender, getColumIndex(Vs1, "MaterialName"), xROW, D7231.MaterialName + " " + D7231.MaterialPName)
                ...
                'If HLP7108B.Link_HLP7108B_SHOESCODE(ShoesCode) = True Then

                '    If hlp0000SeVa = "" Then Exit Sub
                '    GroupComponentBOM = hlp0000SeVaTt
                '    GroupComponentSeq = hlp0000SeVaTt1
            ...
            Case getColumIndex(Vs1, "CLJobCard")
                ...
                If HLP3011A_L.Link_HLP3011Material = True Then
                    ...
                    For i = 0 To Value1.Length - 1
                        ...
                        If Value2.Length > 1 Then
                            If READ_PFK1312(Value2(0), Value2(1)) = True Then
                                ...
                                setData(sender, getColumIndex(Vs1, "KEY_ShoesCode"), xROW, D1312.ShoesCode)
    ...
    Private Sub Vs0_ButtonClicked(sender As Object, e As EditorNotifyEventArgs) Handles vS0.ButtonClicked
        Dim xCOL As Integer
        Dim xROW As Integer
        Dim i As Integer
        Dim Value1() As String
        ...
        Select Case xCOL
            Case getColumIndex(Vs0, "CLJobCard")
                ...
                If HLP3011A_L.Link_HLP3011Material = True Then
                    ...
                    For i = 0 To Value1.Length - 1
                        ...
                        If Value2.Length > 1 Then
                            If READ_PFK1312(Value2(0), Value2(1)) = True Then
                                vS0.ActiveSheet.RowCount += 1
                                setData(sender, getColumIndex(vS0, "SLNO"), xROW, D1312.SLNo)
                                setData(sender, getColumIndex(vS0, "OrderNo"), xROW, D1312.OrderNo)
                                setData(sender, getColumIndex(vS0, "OrderNoSeq"), xROW, D1312.OrderNoSeq)
                                setData(sender, getColumIndex(vS0, "KEY_ShoesCode"), xROW, D1312.ShoesCode)
                                setData(sender, getColumIndex(vS0, "ShoesCode"), xROW, D1312.ShoesCode)
                                setData(sender, getColumIndex(vS0, "QtyOrder"), xROW, D1312.QtyOrder)

                            End If
                        Else
                            If READ_PFK4010(Value2(0)) = True Then
                                vS0.ActiveSheet.RowCount += 1
                                setData(sender, getColumIndex(vS0, "SLNO"), xROW, D4010.SlNoD)
                                setData(sender, getColumIndex(vS0, "JobCard"), xROW, D4010.JobCard)
...
KeyTab7:
        ...
        Select Case e.KeyCode
            ...
            Case Keys.Delete
                ...
                If (wJOB = "1") Then
                    ...
                    For i = Vs1.ActiveSheet.RowCount - 1 To 0 Step -1
                        If getDataM(Vs1, getColumIndex(Vs1, "Dchk"), i) = "1" Then
                            'SPR_DEL(Vs1, 0, i)
                            Vs1.ActiveSheet.RemoveRows(i, 1)
                        End If
                    Next
    ...
    Private Sub cmd_BOM_Click(sender As Object, e As EventArgs) Handles cmd_BOM.Click
        ...
        ' Jun change for master seal P.386 2019/01/21 02:15 PM
        ...
        'For i = 0 To vS0.ActiveSheet.RowCount - 1
        '    If READ_PFK4010_SLNO_SEASON(txt_cdSeason.Code, getData(vS0, getColumIndex(vS0, "Slno"), i)) Then
        '        If StrValue.Contains(D4010.JobCard) = False Then
        '            StrValue = StrValue + D4010.JobCard + "'',''"
        '        End If
        '    End If

        'Next
        'If Replace(FormatCutAll(StrValue), "'", "") = "" Then Exit Sub

        'StrValue = Strings.Left(StrValue, Len(StrValue) - 3)

        'If wJOB <> "1" Then Exit Sub
        'DS1 = PrcDS("USP_ISUD3421A_O_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder & "_INSERT", cn, StrValue)
        ...
        For i = 0 To vS0.ActiveSheet.RowCount - 1
            If READ_PFK1312_SEASON(txt_cdSeason.Code, getData(vS0, getColumIndex(vS0, "Slno"), i)) Then
                If StrValue.Contains(D1312.OrderNo + D1312.OrderNoSeq) = False Then
                    StrValue = StrValue + D1312.OrderNo + D1312.OrderNoSeq + "'',''"
                End If
            End If
        ...
        If wJOB <> "1" Then Exit Sub
        DS1 = PrcDS("USP_ISUD3421A_O_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder & "_INSERT_ORDER", cn, StrValue)
        ...
        'End Jun change for master seal P.386 2019/01/21 02:15 PM

    End Sub

    Private Sub txt_FullView_Click(sender As Object, e As EventArgs) Handles txt_FullView.Click
        Try
            If tbp_Full.RowStyles(0).Height > 0 Then
                tbp_Full.RowStyles(0).Height = 0
            Else
                tbp_Full.RowStyles(0).Height = 222
            End If
    ...
    Private Sub vS0_KeyDown(sender As Object, e As KeyEventArgs) Handles vS0.KeyDown
        ...
        Select Case e.KeyCode
            ...
            Case Keys.Delete
                ...
                If Trim(getData(vS0, getColumIndex(vS0, "Slno"), i)) = "" Then Exit Sub
                W3423.FactOrderNo = L3421.FactOrderNo
                W3423.OrderNo = getData(vS0, getColumIndex(vS0, "OrderNo"), i)
                W3423.OrderNoSeq = getData(vS0, getColumIndex(vS0, "OrderNoSeq"), i)
                W3423.JobCard = getData(vS0, getColumIndex(vS0, "JobCard"), i)
                ...
                If READ_PFK3423(W3423.FactOrderNo, W3423.OrderNo, W3423.OrderNoSeq, W3423.JobCard) = True Then
                    ...
                    Call DELETE_PFK3423(W3423)

                    Call Delete_History("PFK3423", W3423.FactOrderNo)

                End If

                SPR_DEL(vS0, 0, vS0.ActiveSheet.ActiveRowIndex)
                vS0.Focus()
        End Select
    End Sub
#End Region
