...
#Region "Link"
    Public Function Link_ISUD3011P(job As Integer, Autokey As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG

        D3011.Autokey = Autokey
...
#Region "Search"
    Private Function APPROVAL_CHECK() As Boolean
        ...
        If READ_PFK3011(L3011.Autokey) = False Then
            Exit Function
        End If
...
#Region "Functions"
    ...
    Private Function Purchasing_Check_All(z3011 As T3011_AREA) As Boolean
        ...
        If READ_PFK3011(L3011.Autokey) = True Then
            W3011 = D3011
