...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP30118_SEARCH_VS10", cn, txt_CustomerCode.Code, txt_cdSite.Code, txt_Line.Data, txt_Article.Data, txt_ColorName.Data, chk_CheckUse1.CheckState, chk_CheckUse2.CheckState)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP30118_SEARCH_VS10", "VS10")
            VS10.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS11(ShoesCode As String, OrderNo As String, OrderNoSeq As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP30118_SEARCH_VS11", cn, ShoesCode, OrderNo, OrderNoSeq)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS11, DS1, "USP_PFP30118_SEARCH_VS11", "VS11")
            vS11.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP30118_SEARCH_VS20", cn, txt_CustomerCode.Code, txt_cdSite.Code, txt_Line.Data, txt_Article.Data, txt_ColorName.Data)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs20, DS1, "USP_PFP30118_SEARCH_VS20", "VS20")
            vS20.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS21(ShoesCode As String, OrderNo As String, OrderNoSeq As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP30118_SEARCH_VS21", cn, ShoesCode, OrderNo, OrderNoSeq)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs21, DS1, "USP_PFP30118_SEARCH_VS21", "VS21")
            VS21.Enabled = True
            Exit Function
        End If
