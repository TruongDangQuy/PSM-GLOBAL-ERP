...
#Region "Function"
    Private Sub MAIN_JOB01()
        ...
        If ISUD7741A.Link_ISUD7741A(1, cdFactory, cdSubProcess, Pub.DAT, cdLineProd, "", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        If ISUD7741A.Link_ISUD7741A(2, cdFactory, cdSubProcess, DatePlan, cdLineProd, "", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        If ISUD7741A.Link_ISUD7741A(3, cdFactory, cdSubProcess, DatePlan, cdLineProd, "", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB04()
        ...
        If ISUD7741A.Link_ISUD7741A(4, cdFactory, cdSubProcess, DatePlan, cdLineProd, "", Me.Name) = False Then Exit Sub
        ...
        For i = 0 To Vs10.ActiveSheet.RowCount - 1
            ...
            If getDataM(Vs10, getColumIndex(Vs10, "dchk"), i) = "1" Then
                ...
                If READ_PFK7741(cdFactory, cdSubProcess, DatePlan, cdLineProd) Then
                    ...
                    If PrcExe("USP_PFK7741A_COPY_NEW_DATE", cn, cdFactory, cdSubProcess, DatePlan, cdLineProd, CalDate) Then
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP77410_SEARCH_VS10", cn, SdateEdate.text1, SdateEdate.text2, txt_cdFactory.Code, txt_cdSubProcess.Code, txt_cdLineProd.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(VS10, DS1, "USP_PFP77410_SEARCH_VS10", "VS10")
            VS10.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS11(cdFactory As String, cdSubProcess As String, DatePlan As String, cdLineProd As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP77410_SEARCH_VS11", cn, cdFactory, cdSubProcess, DatePlan, cdLineProd)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS11, DS1, "USP_PFP77410_SEARCH_VS11", "VS11")
            vS11.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP77410_SEARCH_VS20", cn, SdateEdate.text1, SdateEdate.text2, txt_cdFactory.Data, txt_cdSubProcess.Code, txt_cdLineProd.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(VS20, DS1, "USP_PFP77410_SEARCH_VS20", "VS20")
            vS20.Enabled = True
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP77410_SEARCH_VS10_LINE", cn, cdFactory, cdSubProcess, DatePlan, cdLineProd)
            ...
            READ_SPREAD(VS10, DS1, "USP_PFP77410_SEARCH_VS10", "VS10", VS10.ActiveSheet.ActiveRowIndex)
