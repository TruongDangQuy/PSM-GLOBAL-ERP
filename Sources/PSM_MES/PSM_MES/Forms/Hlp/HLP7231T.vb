...
#Region "Form_Load"
    Public Function Link_HLP7231T(ByRef SPR As PeaceFarpoint) As Boolean
        hlp0000SeVaTt = ""
        hlp0000SeVa = ""
        hlp0000SeVaTt1 = ""
        Array_hlp0000SeVaTt.Clear()

        vS2.DataSource = SPR.DataSource

        hlpCHK = False

        Me.ShowDialog()

        Link_HLP7231T = hlpCHK
    End Function
...
#Region "Methods"
    Public Function DATA_SEARCH01(Head_No As Long) As Boolean
        ...
        Try
            ...
            If chkLast = True Then txt_cdSemiGroupMaterial.Code = "160" : Call READ_PFK7171(ListCode("SemiGroupMaterial"), "160") : txt_cdSemiGroupMaterial.Data = D7171.BasicName
            If chkMold = True Then txt_cdSemiGroupMaterial.Code = "159" : Call READ_PFK7171(ListCode("SemiGroupMaterial"), "159") : txt_cdSemiGroupMaterial.Data = D7171.BasicName
            ...
            Else
                ...
                DS1 = PrcDS("USP_HLP7231C_SEARCH_VS1_FULLTEXT", cn, txt_cdLargeGroupMaterial.Code, strTemp, txt_cdSemiGroupMaterial.Code, txt_cdDetailGroupMaterial.Code)
            End If
...
#Region "Events"
    ...
    Private Sub vs_Large_CellClick(sender As Object, e As CellClickEventArgs) Handles vs_Large.CellClick
        Try
            ...
            DS1 = PrcDS("USP_HLP7231C_SEARCH_VS1_F1", cn, txt_cdLargeGroupMaterial.Code, "*" & txt_Name.Data, txt_Width.Data, txt_cdSemiGroupMaterial.Code, txt_cdDetailGroupMaterial.Code)
    ...
    Private Sub cmd_QuickAdd_Click(sender As Object, e As EventArgs) Handles cmd_QuickAdd.Click
        ...
        If txt_cdDetailGroupMaterial.Code = "" Then MsgBoxP("Detail Group") : Exit Sub
        If txt_Width.Data = "" Then MsgBoxP("Width") : Exit Sub

        'If ISUD7231S.Link_ISUD7231S_ADD(11, txt_cdLargeGroupMaterial.Code, txt_cdSemiGroupMaterial.Code, txt_cdDetailGroupMaterial.Code, txt_Width.Data, "PFP70231") = False Then Exit Sub
    End Sub
#End Region
