...
#Region "Link"
    Public Function Link_ISUD3411I(job As Integer, PurchasingOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD3411I = False
    ...
    Public Function Link_ISUD3411I_AUTO(job As Integer, cdSeason As String, CustomerCode As String, SupplierCode As String, _Line As String, _cdLargeGroupMaterial As String, _cdSemiGroupMaterial As String, _checkSample As String, PurchasingOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD3411I_AUTO = False
        ...
        Try
            ...
            Link_ISUD3411I_AUTO = isudCHK
        Catch ex As Exception
            '          Call MsgBoxP("61", WordConv("Request Order Processing"))
        End Try
    End Function

    Public Function Link_ISUD3411I_AUTO_NEW(job As Integer, PRNO As String, Value As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD3411I_AUTO_NEW = False
        Try
            Me.Tag = TAG
            Chk_AutoLink = True
            ...
            Link_ISUD3411I_AUTO_NEW = isudCHK
        Catch ex As Exception
            '            Call MsgBoxP("61", WordConv("Request Order Processing"))
        End Try
    ...
    Public Function Link_ISUD3411I_INSERT_MULTI(job As Integer, Value As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD3411I_INSERT_MULTI = False
        Try
            List_AutoKey = Value
            ...
            Link_ISUD3411I_INSERT_MULTI = isudCHK
        Catch ex As Exception
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3411I_SEARCH_HEAD", cn, L3411.PurchasingOrderNo)
    ...
    Private Function DATA_SEARCH_VS0() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3411I_SEARCH_VS0", cn, L3411.PurchasingOrderNo)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS0, DS1, "USP_ISUD3411I_SEARCH_VS0", "VS0")
            vS0.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3411I_SEARCH_VS2", cn, L3411.PurchasingOrderNo)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_ISUD3411I_SEARCH_VS2", "VS2")
            vS2.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS1_INSERT() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3411I_SEARCH_VS1_INSERT_MULTI", cn, List_AutoKey)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3411I_SEARCH_VS1_F1", "Vs1")
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            If Chk_AutoLink = True Then
                ...
                DS1 = PrcDS("USP_ISUD3411I_SEARCH_VS1_F1", cn, L3411.PurchasingOrderNo)
                If GetDsRc(DS1) = 0 Then
                    SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3411I_SEARCH_VS1_F1", "Vs1")
                    DS2 = PrcDS("USP_ISUD3411I_SEARCH_VS1_INSERT_AUTO", cn, L_cdSeason, L_CustomerCode, L_SupplierCode, L_Line, L_cdLargeGroupMaterial, L_cdSemiGroupMaterial, L_checkSample)
                    Call READ_SPREAD_N(Vs1, DS2, 0, GetDsRc(DS2), "USP_ISUD3411I_SEARCH_VS1_F1", "VS1")
    ...
    Private Function DATA_SEARCH_VS1_STOCK() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3411I_SEARCH_VS1_F1_COPY", cn, L3411.PurchasingOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3411I_SEARCH_VS1_F1", "Vs1")
                Vs1.Enabled = True
                Exit Function
    ...
    Private Sub DATA_UPDATE_AFTER()
        Try
            ...
            If READ_PFK3411(L3411.PurchasingOrderNo) = True Then
                W3411 = D3411
                W3411.Remark = txt_InvoiceNo.Data
        ...
        Select Case xCOL
            Case getColumIndex(Vs1, "CLBooking")
                ...
                If HLP3011A_BOOKING.Link_HLP3011Material(MaterialCode, ColorCode) = True Then
                    ...
                    DS1 = PrcDS("USP_ISUD3411I_SEARCH_VS1_INSERT_BOOKING", cn, hlp0000SeVa)
                    Call READ_SPREAD_N(Vs1, DS1, xROW, GetDsRc(DS1), "USP_ISUD3411I_SEARCH_VS1_F1", "VS1")
            ...
            Case getColumIndex(Vs1, "cdMaterialCode_NoLink"), getColumIndex(Vs1, "cdPRNo")
                If rad_CheckRelationType1.Checked = True Then
                    ...
                    If HLP3011A_P.Link_HLP3011Material = True Then
                        ...
                        DS1 = PrcDS("USP_ISUD3411I_SEARCH_VS1_INSERT_F1", cn, hlp0000SeVa, txt_SupplierCode.Code)
                        Call READ_SPREAD_N(Vs1, DS1, xROW, GetDsRc(DS1), "USP_ISUD3411I_SEARCH_VS1_F1", "VS1")
                    End If
                    ...
                    If READ_PFK7101(txt_SupplierCode.Code) = True Then
                        ...
                        For i = 0 To Array_hlp0000SeVaTt.Count - 1
                            If READ_PFK7231(Array_hlp0000SeVaTt1(i)) Then
                                ...
                                DS1 = PrcDS("USP_ISUD3411I_SEARCH_VS1_INSERT_SUPPLIER", cn, Array_hlp0000SeVaTt(i), Array_hlp0000SeVaTt1(i), xCheckMaterialType)
