...
#Region "Variable"
    ...
    Private priCustomercode As String
...
#Region "Link"
    Public Function Link_ISUD7110K(job As Integer, ShoesCode As String, Optional ByVal TAG As String = "") As Boolean
        ...
        priCustomercode = D7106.Customercode
    ...
    Private Sub Form_Activate(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Select Case wJOB
            Case 1
                ...
                If CheckData_Customer(priCustomercode, ISUD.Search) = False Then
                    isudCHK = False
                    formA = True
                    Me.Dispose()
                ...
                vS1.Select()
            Case 2
                Me.Text = Me.Text & "- COLOR GROUP" & " - SEARCH"
                ...
                vS1.Select()
            Case 3
                Me.Text = Me.Text & "- COLOR GROUP" & " - UPDATE"
                If CHK(3) <> "1" Then
                    isudCHK = False
                    Me.Dispose()
                    formA = True
                ...
                If CheckData_Customer(priCustomercode, ISUD.Update) = False Then
                    isudCHK = False
                    formA = True
                    Me.Dispose()
                    MsgBoxP("No Correct Customer !")
            ...
            Case 4                                                      '»èÁ¦
                Me.Text = Me.Text & "- COLOR GROUP" & " - DELETE"
                ...
                If CheckData_Customer(priCustomercode, ISUD.Delete) = False Then
                    isudCHK = False
                    formA = True
                    Me.Dispose()
                    MsgBoxP("No Correct Customer !")
...
#Region "Data_Search"
    ...
    Private Function DATA_SEARCH_VS8() As Boolean
        ...
        Call VsSizeRangeTitle_FixColumn(vS8, "USP_VS_SIZERANGE_SHOESCODEBASE_CUTTINGDIE", "Loss", L7108.ShoesCode)
...
next1:
    ...
    Private Function DATA_SEARCH_VS3() As Boolean
        ...
        Call VsSizeRangeTitle_FixColumn(vS3, "USP_VS_SIZERANGE_SHOESCODEBASE_CUTTINGDIE", "Loss", L7108.ShoesCode)
    ...
    Private Function DATA_SEARCH_VS4() As Boolean
        ...
        Call VsSizeRangeTitle_FixColumn(vS4, "USP_VS_SIZERANGE_SHOESCODEBASE_CUTTINGDIE", "Loss", L7108.ShoesCode)
    ...
    Private Sub DATA_MOVE_K7112()
        Try
            ...
            For i = sRow To eRow
                ...
                If W7112.Spec2 = "" Then W7112.Spec2 = ""
                If W7112.Spec3 = "" Then W7112.Spec3 = ""
                If W7112.Spec4 = "" Then W7112.Spec4 = ""
                If W7112.Spec1 = "" Then W7112.Spec1 = ""
                ...
                If chk_Yield.Checked Then

                    Dim cdSizeGroup As String = "002" ' Size dao cắt

                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 1, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 1, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 2, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 2, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 3, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 3, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 4, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 4, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 5, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 5, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 6, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 6, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 7, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 7, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 8, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 8, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 9, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 9, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 10, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 10, i)))

                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 11, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 11, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 12, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 12, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 13, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 13, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 14, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 14, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 15, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 15, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 16, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 16, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 17, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 17, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 18, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 18, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 19, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 19, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 20, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 20, i)))

                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 21, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 21, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 22, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 22, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 23, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 23, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 24, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 24, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 25, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 25, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 26, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 26, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 27, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 27, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 28, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 28, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 29, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 29, i)))
                    Call DATA_MATCHING(READ_PFK7205_SZNO_SIZEGROUP(D7106.ShoesCode, FormatCutAllSize(getData(vS8, Scol + 30, sRow - 1)), cdSizeGroup), CDecp(getData(vS8, Scol + 30, i)))
                Else
                    ...
                    Dim cdSizeGroup As String = "002" ' Size dao cắt add theo P.726 20190528 12:00 PM
...
skip:
    ...
    Private Sub DATA_DELETE()
        Try
            ...
            Call Delete_History("ISUD7110K_Component", W7109.GroupComponentBOM)
            ...
            If READ_PFK7108_SHOESCODE(W7108.ShoesCode) = False Then
                ...
                If WRITE_PFK7108(W7108) = True Then
                    ...
                    For i = 0 To vS2.ActiveSheet.RowCount - 1
                        ...
                        W7109.GroupComponentBOM = W7108.GroupComponentBOM
                        W7109.CheckP1 = getData(vS2, getColumIndex(vS2, "CheckP1"), i)
                        W7109.CheckP2 = getData(vS2, getColumIndex(vS2, "CheckP2"), i)
                        W7109.CheckP3 = getData(vS2, getColumIndex(vS2, "CheckP3"), i)
                        W7109.CheckP4 = getData(vS2, getColumIndex(vS2, "CheckP4"), i)
                        W7109.CheckP5 = getData(vS2, getColumIndex(vS2, "CheckP5"), i)
                        W7109.CheckP6 = getData(vS2, getColumIndex(vS2, "CheckP6"), i)
                        W7109.CheckP7 = getData(vS2, getColumIndex(vS2, "CheckP7"), i)
                        W7109.CheckP8 = getData(vS2, getColumIndex(vS2, "CheckP8"), i)
                        W7109.CheckP9 = getData(vS2, getColumIndex(vS2, "CheckP9"), i)
                    ...
                    For j = 0 To vS2.ActiveSheet.RowCount - 1
                        If vS2.ActiveSheet.ActiveRowIndex = j Then
                            ...
                            If READ_PFK7109(BaseComponentBOM, MaterialSeq) Then
                                ...
                                W7113.MaterialCode = D7109.MaterialCode
                                W7113.Color = ""
                                W7113.ColorName = ""    'Huy modify SHV request 20180601
                                W7113.Height = D7109.Height
                                W7113.Width = D7109.Width
                                W7113.SizeName = D7109.SizeName
                                W7113.Specification = D7109.Specification
...
skip:
    ...
    Private Sub Vs1_CellClick(sender As Object, e As CellClickEventArgs) Handles vS1.CellClick
        ...
        ElseIf ptc_Main.SelectedIndex = 0 And (xCOL = getColumIndex(sender, "SpeciticSize") Or xCOL = getColumIndex(sender, "CLRematching")) Then
            vS1.ActiveSheet.OperationMode = OperationMode.Normal
    ...
    Private Sub vS1_ButtonClicked(sender As Object, e As EditorNotifyEventArgs) Handles vS1.ButtonClicked
        Try
            ...
            Select Case e.Column
                ...
                Case getColumIndex(vS1, "CLRematching")
                    If wJOB = 2 Then Exit Sub

                    Dim str As String = MsgBoxP("Do you want to Re-Matching this size?", vbYesNo)

                    If str <> vbYes Then Exit Sub
                    Dim Starting As Object
                    Try
                        Starting = New DevExpress.Utils.WaitDialogForm("Re-Matching size...", "PSM")
                ...
                Select Case True
                    ...
                    Case sender Is vS5
                        If READ_PFK7113(getData(sender, getColumIndex(sender, "KEY_Autokey"), xROW)) = True Then
                            ...
                            Call Delete_History("ISUD7113K_Component", W7113.Autokey)
                        End If
                    ...
                    Case sender Is vs7
                        ...
                        'Call PrcExeNoError("USP_PFK7110K_UPLOAD_MATCHING", cn, getData(sender, getColumIndex(sender, "KEY_UpLoadNo"), xROW), BaseComponentBOMList)
                        ...
                        Call Delete_History("PFK7112", W7108.GroupComponentBOM)
                        ...
                        Call Delete_History("PFK7111", W7108.GroupComponentBOM)
                    ...
                    Case sender Is vS8
                        If READ_PFK7112(getData(sender, getColumIndex(sender, "KEY_UploadNo"), xROW), getData(sender, getColumIndex(sender, "KEY_UploadSeq"), xROW)) = True Then
                            ...
                            Call Delete_History("PFK7112", W7112.BaseComponentBOM)
                        End If
    ...
    Private Sub ptc_Main_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ptc_Main.SelectedIndexChanged
        ...
        Select Case ptc_Main.SelectedIndex
            Case 0
                Call DATA_SEARCH_VS2()
                txt_DownSize.Visible = False
                txt_Upsize.Visible = False
            Case 1
                Call DATA_SEARCH_VS3()

                If wJOB <> 2 Then
                    txt_DownSize.Visible = True
                    txt_Upsize.Visible = True
                End If
            ...
            Try
                ...
                Using OpenFileDialog As OpenFileDialog = Me.GetOpenFileDialog()
                    ...
                    If (OpenFileDialog.ShowDialog(Me) = DialogResult.OK) Then
                        ...
                        'Jun add lịch sử upload file 2019/05/04 04:14 PM
                        D9700_CLEAR()
                        D9700.ActionName = "U" & wJOB & Me.Name
                        D9700.DateCreate = Pub.DAT
                        D9700.UserCode = Pub.SAW
                        D9700.FormName = Me.FindForm.Name
                        D9700.Reference = getData(vS1, getColumIndex(vS1, "KEY_ShoesCode"), 0) & "-" & _FileExt
                        ...
                        'End Jun add lịch sử upload file 2019/05/04 04:14 PM
    ...
    Private Sub DemandCalculation()
        Try
            ...
            For i = 0 To GetDsRc(DS1x) - 1
                ...
                Call PrcExeNoError("USP_PFK7110K_UPLOAD_MATCHING_NOK7111", cn, GetDsData(DS1x, i, 0), BaseComponentBOMList)
            Next
    ...
    Private Sub vS5_CellDoubleClick(sender As Object, e As CellClickEventArgs) Handles vS5.CellDoubleClick
        If wJOB = 2 Then Exit Sub

        If e.ColumnHeader = True Then Exit Sub
        Dim MaterialCode As String

        If e.Column = getColumIndex(vS5, "width") Then
            Msg_Result = MsgBox("Do you want to adjust width base?", vbYesNo)
            If Msg_Result <> vbYes Then Exit Sub

            MaterialCode = getData(vS5, getColumIndex(vS5, "MaterialCode"), vS5.ActiveSheet.ActiveRowIndex)
            Dim Strmsg As String = InputBox("Please input Width!")
            ...
            If READ_PFK7231(MaterialCode) Then
                ...
                Call KEY_COUNT_MATERIAL()
                If WRITE_PFK7231(W7231) Then
                    setData(vS5, getColumIndex(vS5, "MaterialCode"), vS5.ActiveSheet.ActiveRowIndex, W7231.MaterialCode)
                    setData(vS5, getColumIndex(vS5, "width"), vS5.ActiveSheet.ActiveRowIndex, W7231.Width)
                End If

            End If
        End If

        If e.Column = getColumIndex(vS5, "cdUnitMaterialName") Then
            Msg_Result = MsgBox("Do you want to unit material base?", vbYesNo)
            ...
            If ISUD7231U.Link_HLP7231C("1", cdUnitMaterial) = True Then
                If READ_PFK7231(MaterialCode) Then
                    ...
                    If WRITE_PFK7231(W7231) Then
                        Call READ_PFK7171(ListCode("UnitMaterial"), W7231.cdUnitMaterial)
                        setData(vS5, getColumIndex(vS5, "MaterialCode"), vS5.ActiveSheet.ActiveRowIndex, W7231.MaterialCode)
                        setData(vS5, getColumIndex(vS5, "cdUnitMaterial"), vS5.ActiveSheet.ActiveRowIndex, W7231.cdUnitMaterial)
                        setData(vS5, getColumIndex(vS5, "cdUnitMaterialName"), vS5.ActiveSheet.ActiveRowIndex, D7171.BasicName)
...
#End Region
    ...
    Private Sub tst_9_Click(sender As Object, e As EventArgs) Handles tst_9.Click
        Dim xROW As Integer

        xROW = vS2.ActiveSheet.ActiveRowIndex
        If vS2.ActiveSheet.ActiveRowIndex < 0 Then Exit Sub

        Msg_Result = MsgBox("Do you want to COPY 100% ITEM CODE for Consumption ?", vbYesNo)
        ...
        If READ_PFK7108(hlp0000SeVaTt) Then
            If READ_PFK7106(D7108.ShoesCode) Then
                DS1 = PrcDS("USP_PFK7106_COPY_SHOESCODE_100PERCENT", cn, D7106.ShoesParent, getData(vS1, getColumIndex(vS1, "ShoesParent"), vS1.ActiveSheet.ActiveRowIndex))
    ...
    Private Sub vS5_KeyDown(sender As Object, e As KeyEventArgs) Handles vS5.KeyDown
        ...
        Select Case e.KeyCode
            Case Keys.Delete
                ...
                Call Delete_History("PFK7113", W7113.Autokey)
        ...
        Select Case e.KeyCode
            Case Keys.Delete
                ...
                If READ_PFK7109(W7109.GroupComponentBOM, W7109.GroupComponentSeq) Then
                    ...
                    Call Delete_History("PFK7109", W7109.GroupComponentBOM)
                End If
    ...
    Private Sub vS1_Change(sender As Object, e As ChangeEventArgs) Handles vS1.Change
        ...
        Select e.Column
            Case getColumIndex(vS1, "SpeciticSize")
                If READ_PFK7106(getData(vS1, getColumIndex(vS1, "KEY_ShoesCode"), e.Row)) Then
                    If READ_PFK7104_SZNO(D7106.SizeRange, getData(vS1, getColumIndex(vS1, "SpeciticSize"), e.Row)) = "" Then
                        setData(vS1, getColumIndex(vS1, "SpeciticSize"), e.Row, D7106.SpeciticSize)
                        MsgBoxP("Wrong size!") : Exit Sub
    ...
    Private Sub tst_8_Click(sender As Object, e As EventArgs) Handles tst_8.Click
        ...
        Call Delete_History("PFK7111", D7108.GroupComponentBOM)
    ...
    Private Sub txt_Upsize_btnTitleClick(sender As Object, e As EventArgs) Handles txt_Upsize.btnTitleClick
        Try
            If wJOB = 2 Then Exit Sub
            ...
            ShoesCode = getData(vS3, getColumIndex(vS3, "Key_ShoesCode"), 0)
            If ShoesCode = "" Then Exit Sub

            Dim strMsg As String

            strMsg = MsgBox("Do you want change size of " + ShoesCode, vbYesNo)

            If StrMsg <> vbYes Then Exit Sub


            Call PrcExeNoError("USP_ISUD7110K_SEARCH_VS3_UpDownSize", cn, ShoesCode, CheckType, UpDown, Pub.SAW)

            If ptc_Main.SelectedIndex = 1 Then Call DATA_SEARCH_VS3()
    ...
    Private Sub txt_DownSize_btnTitleClick(sender As Object, e As EventArgs) Handles txt_DownSize.btnTitleClick
        Try
            If wJOB = 2 Then Exit Sub
