...
#Region "load"
    ...
    End Sub
    Private Sub PFP80020_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
#Region "search"
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP80020_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP80020_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP80020_SEARCH_vS_Cus", cn, CustomerCode, cdSeason)
            SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP80020_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP80020_SEARCH_vS_Line_f1", cn, cdSeason, CustomerCode, ListCode("SpecState"))
            SPR_PRO_NEW(vS_Line, DS1, "USP_PFP80020_SEARCH_vS_Line", "vS_Line")
    ...
    Public Function DATA_SEARCH_HEAD_vs_Job() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP80020_SEARCH_vs_Job", cn, txt_DatePlan.Data, txt_Slno.Data, cdSeason, CustomerCode, cdSpecState)
            SPR_PRO_NEW(vs_Job, DS1, "USP_PFP80020_SEARCH_vs_Job", "vs_Job")
