...
#Region "Link"
    Public Function Link_ISUD3421K(job As Integer, FactOrderNo As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        ...
        Try
            ...
            Select Case job
                ...
                Case Else
                    ...
                    'Tlp_001.RowStyles.RemoveAt(2)
            End Select

            formA = False
            Me.ShowDialog()

            Link_ISUD3421K = isudCHK
    ...
    Public Function Link_ISUD3421K_AUTO(job As Integer, JobCard As String, OrderNo As String, OrderNoSeq As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String,
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3421K_SEARCH_HEAD", cn, L3421.FactOrderNo)
    ...
    Private Function DATA_SEARCH_VS0() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD3421K_SEARCH_VS0_AUTO", cn, L3422.JobCard, L3422.OrderNo, L3422.OrderNoSeq)

            '          DS1 = PrcDS("USP_ISUD3421K_SEARCH_VS0", cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS0, DS1, "USP_ISUD3421K_SEARCH_VS0", "VS0")
                vS0.ActiveSheet.RowCount = 1
                vS0.Enabled = True
                Exit Function
            End If

            Call SPR_PRO_NEW(vS0, DS1, "USP_ISUD3421K_SEARCH_VS0", "VS0")
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421K_SEARCH_VS1", cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421K_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH_VS1_AUTO() As Boolean
        ...
        Try
            If txt_cdGroupComponent.Code = "" Then
                MsgBox("Error cdGroupComponent ==>> Try your actions again Data!")
                Setfocus(txt_cdGroupComponent)
                Exit Function
            End If

            If READ_PFK3421(L3421.FactOrderNo) = True Then
                DS1 = PrcDS("USP_ISUD3421K_SEARCH_VS1_AUTO_F2", cn, L3422.JobCard, L3422.OrderNo, L3422.OrderNoSeq, txt_cdGroupComponent.Code, txt_cdLargeGroupMaterial.Code, txt_cdSubProcess.Code, L3421.FactOrderNo)
            Else
                DS1 = PrcDS("USP_ISUD3421K_SEARCH_VS1_AUTO_F1", cn, L3422.JobCard, L3422.OrderNo, L3422.OrderNoSeq, txt_cdGroupComponent.Code, txt_cdLargeGroupMaterial.Code, txt_cdSubProcess.Code)
            End If



            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421K_SEARCH_VS1_AUTO_F1", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
            SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421K_SEARCH_VS1_AUTO_F1", "Vs1")
    ...
    Private Function Data_Check() As Boolean
        ...
        Try
            For i = 0 To Vs1.ActiveSheet.RowCount - 1
                ...
                If txt_cdSeason.Code = "" Then MsgBoxP("Season Pls!") : Exit Function
...
#Region "Event"
    ...
    Private Sub cmd_Explaination_Click(sender As Object, e As EventArgs) Handles cmd_Explaination.Click
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421K_SEARCH_VS1_AUTO_EXPLAIN", cn, L3422.JobCard, L3422.OrderNo, L3422.OrderNoSeq, txt_cdGroupComponent.Code, txt_cdLargeGroupMaterial.Code)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421K_SEARCH_VS1_AUTO_EXPLAIN", "Vs1")
                Vs1.Enabled = True
                Exit Sub
            End If
            SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421K_SEARCH_VS1_AUTO_EXPLAIN", "Vs1")
    ...
    Private Sub cmd_ComponnetList_Refresh_Click(sender As Object, e As EventArgs) Handles cmd_ComponnetList_Refresh.Click
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421K_SEARCH_VS1_AUTO_EXPLAIN_COM", cn, L3422.JobCard, L3422.OrderNo, L3422.OrderNoSeq, txt_cdGroupComponent.Code, txt_cdLargeGroupMaterial.Code)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421K_SEARCH_VS1_AUTO_EXPLAIN_COM", "Vs1")
                Vs1.Enabled = True
                Exit Sub
            End If
            SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421K_SEARCH_VS1_AUTO_EXPLAIN_COM", "Vs1")
