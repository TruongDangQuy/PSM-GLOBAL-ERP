...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP01517_SEARCH_VS10", cn, txt_cdFactory.Code, txt_SDATE.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP01517_SEARCH_VS10", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_vs40(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP01517_SEARCH_vs40", cn, txt_cdFactory.Code, txt_SDATE.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS40, DS1, "USP_PFP01517_SEARCH_vs40", "vs40")
                vS40.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS20.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01517_SEARCH_VS20", cn, txt_cdFactory.Code, txt_SDATE.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS20, DS1, "USP_PFP01517_SEARCH_VS20", "VS20")
                vS20.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS30.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01517_SEARCH_VS30", cn, txt_cdFactory.Code, txt_SDATE.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS30, DS1, "USP_PFP01517_SEARCH_VS30", "VS30")
                vS30.Enabled = True
                Exit Function
            End If
