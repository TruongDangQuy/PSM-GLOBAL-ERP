...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_2, _
                        "QA PROCESSING - " & WordConv("INSERT") & "(F5)", _
                        "QA PROCESSING - " & WordConv("SEARCH") & "(F6)", _
                        "QA PROCESSING - " & WordConv("UPDATE") & "(F7)", _
                        "QA PROCESSING - " & WordConv("DELETE") & "(F8)")
    ...
    Private Sub MAIN_JOB01()
        If ISUD7550A.Link_ISUD7550A(1, "ISUD7171A", "001;950") = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        Try
            ...
            strSql = strSql & "WHERE [K7550_QAKey]= '" & getData(vS10, getColumIndex(vS10, "KEY_QAKey"), vS10.ActiveSheet.ActiveRowIndex) & "'"



            Dim sqlCmd As New SqlClient.SqlCommand(strSql, cn)

            sFileName = getData(vS10, getColumIndex(vS10, "FileName"), vS10.ActiveSheet.ActiveRowIndex) & "_QA" & KEY_QAKey
    ...
    Private Sub MAIN_JOB03()
        ...
        If ISUD7550A.Link_ISUD7550A(3, KEY_QAKey, FileName) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB04()
        Try
            ...
            Call PrcExeNoError("USP_PFK7551_FROM_PFK7550_BACKUP", cn, getData(vS10, getColumIndex(vS10, "KEY_QAKey"), vS10.ActiveSheet.ActiveRowIndex), Pub.TIM, Pub.SAW)

            SQL = "DELETE FROM [dbo].[PFK7550] "
            SQL = SQL & "WHERE [K7550_QAKey]= '" & getData(vS10, getColumIndex(vS10, "KEY_QAKey"), vS10.ActiveSheet.ActiveRowIndex) & "'"

            cmd = New SqlClient.SqlCommand(SQL, cn)
            cmd.ExecuteNonQuery()
            SPR_CLEAR(vS10, vS10.ActiveSheet.ActiveRowIndex, 0, vS10.ActiveSheet.ActiveRowIndex, vS10.ActiveSheet.ColumnCount - 1)
            setData(vS10, getColumIndex(vS10, "FileName"), vS10.ActiveSheet.ActiveRowIndex, "[DELETED]")
...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP75500_SEARCH_vS10", cn, SdateEdate.text1, _
                                                       SdateEdate.text2, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS10, DS1, "USP_PFP75500_SEARCH_vS10", "vS10")
            vS10.Enabled = True
            Exit Function
        End If
