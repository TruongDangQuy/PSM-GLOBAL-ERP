...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_HLP3011Y_SEARCH_vS10", cn, txt_cdSite.Code, "*" & txt_MaterialName.Data, txt_ColorName.Data, txt_Autokey.Data)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS10, DS1, "USP_HLP3011Y_SEARCH_vS10", "vS10")
        ...
        Try
            ...
            For i = 0 To vS10.ActiveSheet.RowCount - 1
                ...
                If getDataM(vS10, getColumIndex(vS10, "DCHK"), i) = "1" Then
                    ...
                    Call PrcExeNoError("USP_PFK2352_UPDATE_PFK3011_MOQSTOCK", cn, txt_Autokey.Data, KEY_MaterialInBoundNo, KEY_MaterialInBoundSeq, KEY_MaterialInBoundSno, Pub.SAW, CDecp(getData(vS10, getColumIndex(vS10, "QtyBooking"), i)), "*" & txt_Remark.Text)
