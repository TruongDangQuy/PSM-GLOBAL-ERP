...
#Region "Form_load"
    Public Function Link_HLP7108F(Optional ByVal TAG As String = "") As Boolean
        Link_HLP7108F = False
        Me.Tag = TAG
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS2(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_HLP7108F_SEARCH_VS2", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_HLP7108F_SEARCH_VS2", "VS2")
            vS2.Enabled = True
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_HLP7108F_SEARCH_Vs2_LINE", cn, ShoesCode)

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(vS2, DS1, "USP_HLP7108F_SEARCH_Vs2", "Vs2", xrow)
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_HLP7108F_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_HLP7108F_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_HLP7108F_SEARCH_vS_Cus", cn, CustomerCode, cdSeason)
            SPR_PRO_NEW(vS_Cus, DS1, "USP_HLP7108F_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_HLP7108F_SEARCH_vS_Line", cn, cdSeason, CustomerCode)
            SPR_PRO_NEW(vS_Line, DS1, "USP_HLP7108F_SEARCH_vS_Line", "vS_Line")
