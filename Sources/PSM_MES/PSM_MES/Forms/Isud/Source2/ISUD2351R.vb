...
#Region "Link"
    ...
    Public Function Link_ISUD2351R(job As Integer, CheckInBoundMaterial As String, MaterialInBoundNo As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
    ...
    Public Function Link_ISUD2351R_AUTO(job As Integer, FactOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
    ...
    Public Function Link_ISUD2351R_AUTO(job As Integer, _cdSemiGroupMaterial As String, FactOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD2351R_SEARCH_HEAD", cn, L2351.MaterialInBoundNo)
    ...
    Private Function DATA_SEARCH_vS1() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD2351R_SEARCH_VS1", cn, L2351.MaterialInBoundNo)


        If GetDsRc(DS1) = 0 Then
            DS2 = PrcDS("USP_ISUD2351R_SEARCH_VS1_INSERT", cn, L2351.FactOrderNo)

            SPR_SET(Vs1, , , , OperationMode.Normal)
            SPR_PRO(Vs1, DS2, "USP_ISUD2351R_SEARCH_VS1", "Vs1")
            SPR_INSERT(Vs1)
        ...
        End If
        SPR_SET(Vs1, , , , OperationMode.Normal)
        SPR_PRO(Vs1, DS1, "USP_ISUD2351R_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH_vS1_Semi() As Boolean
        ...
        If GetDsRc(DS1) = 0 Then
            DS2 = PrcDS("USP_ISUD2351R_SEARCH_VS1_INSERT_SEMI", cn, L2351.FactOrderNo, cdSemiGroupMaterial)
    ...
    Private Function DATA_SEARCH_vS2() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD2351R_SEARCH_VS2", cn, MaterialInBoundNo, _
                                                        MaterialInBoundSeq)

        If GetDsRc(DS1) = 0 Then
            DS2 = PrcDS("USP_ISUD2351R_SEARCH_VS2_INSERT", cn, MaterialInBoundNo, _
                                                       MaterialInBoundSeq,
                                                       PackInBound, QtyBasic)

            SPR_SET(vS2, , , , OperationMode.Normal)
            SPR_PRO(vS2, DS2, "USP_ISUD2351R_SEARCH_vS2", "vS2")
            SPR_INSERT(vS2)
            vS2.Enabled = True
            Exit Function
        End If
        ...
        SPR_SET(vS2, , , , OperationMode.Normal)
        SPR_PRO(vS2, DS1, "USP_ISUD2351R_SEARCH_vS2", "vS2")
    ...
    Private Function DATA_SEARCH_vS3() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD2351R_SEARCH_vS3", cn, MaterialInBoundNo, _
                                                        MaterialInBoundSeq)

        If GetDsRc(DS1) = 0 Then
            DS2 = PrcDS("USP_ISUD2351R_SEARCH_vS3_INSERT", cn, MaterialInBoundNo, _
                                                       MaterialInBoundSeq)

            SPR_SET(vS3, , , , OperationMode.Normal)
            SPR_PRO(vS3, DS2, "USP_ISUD2351R_SEARCH_vS3", "vS3")
            SPR_INSERT(vS3)
            vS3.Enabled = True
            Exit Function
        End If
        ...
        SPR_SET(vS3, , , , OperationMode.Normal)
        SPR_PRO(vS3, DS1, "USP_ISUD2351R_SEARCH_vS3", "vS3")
            ...
            For i = 0 To Vs1.ActiveSheet.RowCount - 1
                ...
                Else
                    ...
                    If WRITE_PFK2351(W2351) Then
                        Call PrcExeNoError("USP_PFK2351R_INSERT", cn, W2351.MaterialInBoundNo, W2351.MaterialInBoundSeq, PackInBound, W2351.QtyBasic)
...
skip:
    ...
    Private Sub KEY_COUNT()
        ...
        Try
            ...
            If IsDBNull(rd!MAX_MCODE) Then
                W2351.MaterialInBoundNo = "WS" & YRNO & "00001"
            Else
                W2351.MaterialInBoundNo = "WS" & YRNO & Format(CInt(rd!MAX_MCODE + 1), "00000")
...
skip:
    ...
    Private Sub Vs1_CellClick(sender As Object, e As CellClickEventArgs) Handles Vs1.CellClick
        ...
        ElseIf (e.Column = getColumIndex(Vs1, "QtyBasic") Or e.Column = getColumIndex(Vs1, "QtyInBound_Or") Or e.Column = getColumIndex(Vs1, "PackInBound")) And (wJOB = 1 Or wJOB = 11) Then
            Vs1.ActiveSheet.OperationMode = OperationMode.Normal
        Else
