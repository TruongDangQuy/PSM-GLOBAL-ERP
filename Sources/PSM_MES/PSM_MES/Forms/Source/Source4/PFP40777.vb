...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call Cms_additem(Cms_1,
                        "SAVE PLAN - " & WordConv("SAVE PLAN") & "(F5)")
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsosrt As String = "1") As Boolean
        DATA_SEARCH_VS10 = False
        Vs10.Enabled = False

        DS1 = PrcDS("USP_PFP40777_SEARCH_VS10", cn, txt_DatePlan.Data, txt_cdSeason.Code, txt_CustomerCode.Code)

        If GetDsRc(DS1) = 0 Then
            DS2 = PrcDS("USP_PFP40777_SEARCH_VS10_INSERT", cn, txt_DatePlan.Data, txt_cdSeason.Code, txt_CustomerCode.Code)

            SPR_PRO_NEW(Vs10, DS2, "USP_PFP40777_SEARCH_VS10", "VS10")
            Vs10.Enabled = True
            Exit Function
        End If

        SPR_PRO_NEW(Vs10, DS1, "USP_PFP40777_SEARCH_VS10", "VS10")
    ...
    Private Function DATA_SEARCH_VS11(cdFactory As String, cdMainProcess As String, DatePlan As String, cdLineProd As String, JobCard As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP40777_SEARCH_VS11", cn, cdFactory, cdMainProcess, DatePlan, cdLineProd, JobCard)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS11, DS1, "USP_PFP40777_SEARCH_VS11", "VS11")
            vS11.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40777_SEARCH_VS20", cn, SdateEdate.text1, SdateEdate.text2, txt_cdSeason.Code, txt_CustomerCode.Code, txt_cdMainProcess.Code, txt_cdFactory.Code, txt_cdLineProd.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP40777_SEARCH_VS20", "VS20")
            vS20.Enabled = True
            Exit Function
        End If

        SPR_PRO_NEW_BARCODE(vS20, DS1, "USP_PFP40777_SEARCH_VS20", "VS20")
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40777_SEARCH_VS30", cn, SdateEdate.text1, SdateEdate.text2, txt_cdSeason.Code, txt_CustomerCode.Code, txt_cdMainProcess.Code, txt_cdFactory.Code, txt_cdLineProd.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(VS30, DS1, "USP_PFP40777_SEARCH_VS30", "VS30")
            VS30.Enabled = True
            Exit Function
        End If

        SPR_PRO_NEW_BARCODE(VS30, DS1, "USP_PFP40777_SEARCH_VS30", "VS30")
    ...
    Private Function DATA_SEARCH_VS40(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40777_SEARCH_VS40", cn, SdateEdate.text1, SdateEdate.text2, txt_cdSeason.Code, txt_CustomerCode.Code, txt_cdMainProcess.Code, txt_cdFactory.Code, txt_cdLineProd.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(VS40, DS1, "USP_PFP40777_SEARCH_VS40", "VS40")
            VS40.Enabled = True
            Exit Function
        End If

        SPR_PRO_NEW_BARCODE(VS40, DS1, "USP_PFP40777_SEARCH_VS40", "VS40")
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40777_SEARCH_VS10_LINE", cn, cdFactory, cdMainProcess, DatePlan, cdLineProd)
            ...
            READ_SPREAD(VS10, DS1, "USP_PFP40777_SEARCH_VS10", "VS10", VS10.ActiveSheet.ActiveRowIndex)
