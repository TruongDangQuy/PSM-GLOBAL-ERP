...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim xISUD3421A As String = ISUD3421A.Text
        Dim xISUD3421P As String = ISUD3421P.Text

        Call Cms_additem(Cms_1,
                        xISUD3421A & " - " & WordConv("INPUT") & "(F5)",
                        xISUD3421A & " - " & WordConv("SEARCH") & "(F6)",
                        xISUD3421A & " - " & WordConv("UPDATE") & "(F7)",
                        xISUD3421A & " - " & WordConv("DELETE") & "(F8)",
                        "-",
                        xISUD3421P & " - " & WordConv("ONE"),
                        xISUD3421P & " - " & WordConv("ALL"),
                        xISUD3421A & " - " & WordConv("UPDATE AFTER"))
    ...
    Private Sub DATA_INIT()
        ...
        If Trim(Pub.DEPARTMENT) <> "" Then
            ...
            If READ_PFK7171(ListCode("Department"), Pub.DEPARTMENT) = True Then
        ...
        Pnl_RelationType.Enabled = False
        Pnl_ProcessType.Enabled = False
        Pnl_CheckInOut.Enabled = False

        chk_CheckIOType1.Checked = True
        chk_CheckIOType = "2"


        chk_CheckProcessMaterial0.Checked = True
        chk_CheckProcessMaterial1.Checked = False

        opt_CheckRelationType0.Checked = False
        opt_CheckRelationType1.Checked = True
        ...
        Select Case Strings.Right(Me.PeaceFormType, 2).ToUpper
            ...
            Case "O5"
                ...
                chk_CheckProcessMaterial0.Checked = False
                chk_CheckProcessMaterial1.Checked = True
                chk_NewForm = False

            Case "O6"
                strFormType = "RETURN PURCHASING"
                chk_CheckOutPurchasingOrder6.Checked = True
                chk_CheckPurchasingOrder = "6"
        End Select

        Select Case Strings.Left(Strings.Right(Me.PeaceFormType, 5).ToUpper, 3)
            Case "CHE"
                txt_cdLargeGroupMaterial.Code = "004"
                txt_cdLargeGroupMaterial.Enabled = False
                If READ_PFK7171(ListCode("LargeGroupMaterial"), txt_cdLargeGroupMaterial.Code) Then
                    txt_cdLargeGroupMaterial.Code = D7171.BasicCode
                    txt_cdLargeGroupMaterial.Data = D7171.BasicName
                End If

            Case "INS", "OSS", "MID"
                txt_cdLargeGroupMaterial.Code = "002"
                txt_cdLargeGroupMaterial.Enabled = False
                If READ_PFK7171(ListCode("LargeGroupMaterial"), txt_cdLargeGroupMaterial.Code) Then
                    txt_cdLargeGroupMaterial.Code = D7171.BasicCode
                    txt_cdLargeGroupMaterial.Data = D7171.BasicName
        ...
        Select Case Strings.Right(Me.PeaceFormType, 4).ToUpper
            Case "O1_1"
                strFormType = "INSIDE BY SEAL"
                chk_CheckOutPurchasingOrder1.Checked = True
                chk_CheckPurchasingOrder = "1"
...
#Region "Function"
    Private Sub MAIN_JOB01()
        ...
        If chk_NewForm = False Then If ISUD3421A.Link_ISUD3421A(1, "000000000", chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
        If chk_NewForm = True Then If chk_CheckPurchasingOrder <> "5" Then If ISUD3421A_S.Link_ISUD3421A(1, "000000000", chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
        If chk_NewForm = True Then If chk_CheckPurchasingOrder = "5" Then If ISUD3421A_O.Link_ISUD3421A(1, "000000000", chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
        Call DATA_SEARCH01()
    End Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        If chk_NewForm = False Then If ISUD3421A.Link_ISUD3421A(2, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub

        If chk_NewForm = True Then If chk_CheckPurchasingOrder <> "5" Then If ISUD3421A_S.Link_ISUD3421A(2, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
        If chk_NewForm = True Then If chk_CheckPurchasingOrder = "5" Then If ISUD3421A_O.Link_ISUD3421A(2, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        If chk_NewForm = False Then If ISUD3421A.Link_ISUD3421A(3, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
        If chk_NewForm = True Then If chk_CheckPurchasingOrder <> "5" Then If ISUD3421A_S.Link_ISUD3421A(3, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
        If chk_NewForm = True Then If chk_CheckPurchasingOrder = "5" Then If ISUD3421A_O.Link_ISUD3421A(3, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB04()
        ...
        If chk_NewForm = False Then If ISUD3421A.Link_ISUD3421A(4, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
        If chk_CheckPurchasingOrder <> "5" Then If chk_NewForm = True Then If ISUD3421A_S.Link_ISUD3421A(4, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
        If chk_CheckPurchasingOrder = "5" Then If chk_NewForm = True Then If ISUD3421A_O.Link_ISUD3421A(4, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB05()
        ...
        If ISUD3421P.Link_ISUD3421P(3, FactOrderNo,
                                        getData(Vs1, getColumIndex(Vs1, "KEY_FactOrderSeq"),
                                        Vs1.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB07()
        ...
        If ISUD3421A.Link_ISUD3421A(5, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
...
#Region "Data_search"
    Private Function DATA_SEARCH01(Optional ByVal xsort As String = "1") As Boolean
        ...
        If opt_G1.Checked = True Then
            ...
            DS1 = PrcDS("USP_PFP34220_SEARCH_VS1_GROUP", cn, SdateEdate.text1,
                                                        SdateEdate.text2,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP34220_SEARCH_VS1_GROUP", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
        ...
        Else
            ...
            DS1 = PrcDS("USP_PFP34220_SEARCH_VS1_DETAIL", cn, SdateEdate.text1,
                                                       SdateEdate.text2,
                                                       txt_GCODE.chkAll.CheckState,
                                                       txt_GCODE.SQL,
                                                        txt_cdDepartment.Code,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP34220_SEARCH_VS1_DETAIL", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP34220_SEARCH_VS1_LINE", cn, FactOrderNo,
                                                        FactOrderSeq)
            ...
            READ_SPREAD(Vs1, DS1, "USP_PFP34220_SEARCH_VS1", "Vs1", Vs1.ActiveSheet.ActiveRowIndex)
    ...
    Private Function CheckOutPurchasingOrder() As String
        ...
        If chk_CheckOutPurchasingOrder5.Checked = True Then If strCheckOutPurchasingOrder = "" Then strCheckOutPurchasingOrder = "5" Else strCheckOutPurchasingOrder += ",5"
        If chk_CheckOutPurchasingOrder6.Checked = True Then If strCheckOutPurchasingOrder = "" Then strCheckOutPurchasingOrder = "6" Else strCheckOutPurchasingOrder += ",6"
