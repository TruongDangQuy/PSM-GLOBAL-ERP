...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23519_SEARCH_VS10", cn, txt_cdSite.Code,
                                                    txt_FactOrderNo.Data,
                                                    txt_SupplierCode.Data, _
                                                    "*" & txt_MaterialName.Data)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP23519_SEARCH_VS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23519_SEARCH_vS20", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdSite.Code,
                                                    txt_FactOrderNo.Data,
                                                    txt_SupplierCode.Data, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23519_SEARCH_vS20", "vS20")
            vS20.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23519_SEARCH_VS30", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdSite.Code,
                                                    txt_FactOrderNo.Data,
                                                    txt_SupplierCode.Data, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS30, DS1, "USP_PFP23519_SEARCH_VS30", "VS30")
            vS30.Enabled = True
            Exit Function
        End If
