...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call Cms_additem(Cms_1,
                        "OUTBOUND REQUEST - WAREHOUSE MATERIAL PROCCESING - " & WordConv("INPUT") & "(F5)",
                        "OUTBOUND REQUEST - WAREHOUSE MATERIAL PROCCESING - " & WordConv("SEARCH") & "(F6)",
                        "OUTBOUND REQUEST - WAREHOUSE MATERIAL PROCCESING - " & WordConv("UPDATE") & "(F7)",
                        "OUTBOUND REQUEST - WAREHOUSE MATERIAL PROCCESING - " & WordConv("DELETE") & "(F8)",
                        "-",
                        "OUTBOUND REQUEST - WAREHOUSE MATERIAL PROCCESING - " & WordConv("APPROVAL") & "(F9)",
                        "OUTBOUND REQUEST - WAREHOUSE MATERIAL PROCCESING - " & WordConv("APPROVAL-ALL LINES") & "(F10)")
...
#Region "Function"
    Private Sub MAIN_JOB01()
        'If ISUD3421A_OUT.Link_ISUD3421A_OUT(1, "000000000", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        'If ISUD3421A_OUT.Link_ISUD3421A_OUT(2, FactRequestOrderYarnNo, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        'If ISUD3421A_OUT.Link_ISUD3421A_OUT(3, FactRequestOrderYarnNo, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB04()
        ...
        'If ISUD3421A_OUT.Link_ISUD3421A_OUT(4, FactRequestOrderYarnNo, Me.Name) = False Then Exit Sub
...
#Region "Data_search"
    Private Function DATA_SEARCH01(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP34210O_SEARCH_VS1", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                   ...
                                                   "*" & txt_YarnName.Data,
                                                    ...
                                                    cmb_CheckMaterialOutbound.InSelected,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP34210O_SEARCH_VS1", "Vs1")
            Vs1.Enabled = True
            Exit Function
        End If
