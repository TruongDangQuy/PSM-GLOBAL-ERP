...
#Region "Link"
    Public Function Link_ISUD3421Y(job As Integer, FactOrderNo As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        Link_ISUD3421Y = False
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3421Y_SEARCH_HEAD", cn, L3421.FactOrderNo)
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421Y_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421Y_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "Vs1")
...
skip:
    ...
    Private Sub DATA_CLOSE()
        Try
            Call PrcExeNoError("EXP_CLOSSING_PFK3421", cn, txt_FactOrderNo.Data)
        Catch ex As Exception
