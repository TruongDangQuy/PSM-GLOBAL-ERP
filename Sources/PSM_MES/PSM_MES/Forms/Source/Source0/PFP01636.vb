...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1, _
                        "PRODUCTON STATUS - STOCKFIT [FOOTBED]",
                        "OUTBOUND STATUS - STOCKFIT [FOOTBED]")
    ...
    Private Sub DATA_INIT()
        txt_cdMainProcess.Data = "Footbed"
        txt_cdMainProcess.Code = "099"
...
#Region "Function"
    ...
    Private Sub MAIN_JOB01()
        ...
        ProdDate = getData(Vs10, getColumIndex(Vs10, "KEY_DateProduction"), Vs10.ActiveSheet.ActiveRowIndex)

        HLP4070C.Link_HLP4070C(Job, JobCard, cdSubProcess, ProdDate, Me.Name)
    ...
    Private Sub MAIN_JOB02()
        ...
        JobCard = getData(Vs10, getColumIndex(Vs10, "KEY_JobCard"), Vs10.ActiveSheet.ActiveRowIndex)
        cdSubProcess = getData(Vs10, getColumIndex(Vs10, "KEY_cdSubProcess_Output"), Vs10.ActiveSheet.ActiveRowIndex)
        ProdDate = getData(Vs10, getColumIndex(Vs10, "KEY_DateProduction"), Vs10.ActiveSheet.ActiveRowIndex)
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Vs10.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01636_SEARCH_VS10", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, SdateEdate.text1, SdateEdate.text2)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP01636_SEARCH_VS10", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS11(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS11.Enabled = True
        Try
            DS1 = PrcDS("USP_PFP01636_SEARCH_VS11", cn, txt_cdFactory.Code, cdMainProcess, cdLineProd, JobCard, DateProduction)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS11, DS1, "USP_PFP01636_SEARCH_VS11", "VS11")
                vS11.Enabled = True
                Exit Function
            End If
            ...
            Call VsSizeRangeNew_one(vS11, "USP_PFP01636_SEARCH_VS11_HEAD", getColumIndex(vS11, "QtyTotal"), getData(vS11, getColumIndex(vS11, "OrderNo"), 0), getData(vS11, getColumIndex(vS11, "OrderNoSeq"), 0))
            ...
            For i = 0 To vS11.ActiveSheet.RowCount - 1
                ...
                If Trim$(getData(vS11, getColumIndex(vS11, "TITILE_S150"), i)) <> "" Then
                    ...
                    If Trim$(getData(vS11, getColumIndex(vS11, "TITILE_S150"), i)) = "3.Prod Assembly" Then Call SPR_BACKCOLOR(vS11, cSprProduction, i)
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS20.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01636_SEARCH_VS20", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, SdateEdate.text1, SdateEdate.text2)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS20, DS1, "USP_PFP01636_SEARCH_VS20", "VS20")
                vS20.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS30.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01636_SEARCH_VS30", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, SdateEdate.text1, SdateEdate.text2)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS30, DS1, "USP_PFP01636_SEARCH_VS30", "VS30")
                vS30.Enabled = True
                Exit Function
            End If
