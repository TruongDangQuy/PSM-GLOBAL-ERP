...
next1:
    ...
    Private Sub MAIN_JOB05()
        ...
        Try
            ...
            If HLP3460.Link_HLP3460Material = True Then
...
next1:
                ...
                If SpecNoList = "" Then Exit Sub
                SpecNoList = Strings.Left(SpecNoList, Len(SpecNoList) - 1)
                If ISUD3460A.Link_ISUD3460A_AUTO(12, InvoiceNo, 0, SpecNoList, Me.Name) = False Then Exit Sub
            End If
...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_Vs10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13400_SEARCH_Vs10", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data, txt_cdStatusExport.Code)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP13400_SEARCH_Vs10", "Vs10")
    ...
    Private Function DATA_SEARCH_Vs20(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13400_SEARCH_Vs20", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data, txt_InvoiceNo.Data, txt_cdStatusExport.Code, SdateEdate.text1, SdateEdate.text2)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs20, DS1, "USP_PFP13400_SEARCH_Vs20", "Vs20")
    ...
    Private Function DATA_SEARCH_Vs30(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13400_SEARCH_Vs30", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data, txt_InvoiceNo.Data, SdateEdate.text1, SdateEdate.text2)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs30, DS1, "USP_PFP13400_SEARCH_Vs30", "Vs30")
            ...
            If chk_TradingExportColor Then
                Dim i As Integer
                Dim Xcol As Integer = getColumIndex(vS30, "CheckStatus_TD")
                Dim XcolsEL As Integer = getColumIndex(vS30, "CheckStatus_TD_Sel")
                DS3 = PrcDS("USP_HLP7171_LISTCOLOR", cn, ListCode("StatusExport"))
                For i = 0 To vS30.ActiveSheet.RowCount - 1
                    SPR_BACKCOLORCELL(vS30, FUNCTION_TRADING_BACK(getData(vS30, Xcol, i)), XcolsEL, i)
                Next
            End If

            'Dim styleCold As New FarPoint.Win.Spread.NamedStyle
            'styleCold.BackColor = Color.Aquamarine
            ...
            'Dim DateEXFac As String = getData(vS30, getColumIndex(vS30, "DateEXFac"), xROW)
            'Dim DateETD As String = getData(vS30, getColumIndex(vS30, "DateETD"), xROW)
            'Dim DateETA As String = getData(vS30, getColumIndex(vS30, "DateETA"), xROW)
            ...
            'Dim InvoiceNo As String = getData(vS30, getColumIndex(vS30, "KEY_InvoiceNo"), xROW)

            vS30.ActiveSheet.ClearConditionalFormatings()
            ...
            vS30.ActiveSheet.SetConditionalFormatting(-1, -1, text)

            'vS30.NamedStyles.Add(styleCold)

            'vS30.ActiveSheet.SetConditionalFormat(-1, getColumnIndex(vS30, "SONo"), styleCold, FarPoint.Win.Spread.ComparisonOperator.IsEmpty)
            'vS30.ActiveSheet.SetConditionalFormat(-1, getColumnIndex(vS30, "BLNo"), styleCold, FarPoint.Win.Spread.ComparisonOperator.IsEmpty)
    ...
    Private Function DATA_SEARCH_Vs40(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13400_SEARCH_Vs40", cn, txt_cdSite.Code, txt_Article.Data, txt_CustPONO.Data, SdateEdate.text1, SdateEdate.text2)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs40, DS1, "USP_PFP13400_SEARCH_Vs40", "Vs40")
        ...
        Try
            ...
            If e.Column = getColumIndex(vS10, "RemarkTrading") Then
                ...
                For i As Integer = 0 To vS10.ActiveSheet.RowCount - 1
                    ...
                    StrValue = PrcExeNoError_ValueVN("USP_PFK3460_UPDATE_PFK1312_REMARK_TRADING", cn, KEY_OrderNo, KEY_OrderNoSeq, "*" & str)
...
#End Region
  ...
  Private Sub vSChange(xROW As Integer)
        Try
            ...
            StrValue = PrcExeNoError_ValueVN("USP_PFK3460_UPDATE_INVOICENO", cn, InvoiceNo, _
