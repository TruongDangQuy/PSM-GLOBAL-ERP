...
#Region "Form"
    Public Function Link_ISUD4090B(job As Integer, cdMainProcess As String, ProdDate As String, ProdSeq As String, _
        ...
        If READ_PFK7171(ListCode("MainProcess"), "007") Then
            txt_cdMainProcess.Code = D7171.BasicCode
            txt_cdMainProcess.Data = D7171.BasicName
            txt_cdMainProcess.Enabled = False
        End If

        If READ_PFK7171(ListCode("SubProcess"), "013") Then
...
#Region "Search"
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD4090B_SEARCH_VS1", cn, L4090.ProdDate, _
                                                        L4090.cdFactory, _
                                                        L4090.cdLineProd, _
                                                        L4090.cdMainProcess)
            ...
            If GetDsRc(DS1) = 0 Then
                ...
                SPR_PRO(vS1, DS1, "USP_ISUD4090B_SEARCH_VS1", "vS1")
    ...
    Private Function DATA_SEARCH_VS1_LINE() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD4090B_SEARCH_VS1_LINE", cn, L4090.BatchNo, _
                                                                L4090.ProdDate,
                                                                  L4090.cdFactory, _
                                                                  L4090.cdLineProd, _
                                                                  L4090.cdMainProcess)
            ...
            Call READ_SPREAD(vS1, DS1, "USP_ISUD4090B_SEARCH_VS1", "Vs1", vS1.ActiveSheet.RowCount - 1)
    ...
    Private Sub txt_Barcode_txtTextKeyDown(sender As Object, e As KeyEventArgs) Handles txt_Barcode.txtTextKeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            If READ_PFK4075_BatchNo(L4090.BatchNo) Then
                ...
                DS1 = PrcDS("USPWF_PFK4090A_INSERT_AUTO_PRODUCTION_F1_ASSEMBLY", cn, txt_cdFactory.Code, txt_cdLineProd.Code, txt_cdMainProcess.Code, txt_cdSubProcess.Code, L4090.BatchNo)

                'txt_Mess.Text = GetDsData(DS1, 0, 0)

                If GetDsData(DS1, 0, 0).Contains("VÔ GIÀY SỐ") = False Then
