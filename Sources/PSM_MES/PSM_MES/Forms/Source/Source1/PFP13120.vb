...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1, _
                                xISUD1311A & " - " & WordConv("INPUT") & "(F5)",
                                xISUD1311A & " - " & WordConv("SEARCH") & "(F6)",
                                xISUD1311A & " - " & WordConv("UPDATE") & "(F7)",
                                xISUD1311A & " - " & WordConv("DELETE") & "(F8)",
                                "-",
                                xISUD1311P & " - " & WordConv("APPROVAL 1 LINE "),
                                xISUD1311P & " - " & WordConv("APPROVAL - ALL"),
                                "-",
                                xISUD1311P & " - " & "COPY NEW (ALL)",
                                xISUD1311P & " - " & "COPY NEW (1 LINE)")

        'xISUD1311A & " - " & WordConv("NEW COPY"),
        '"-",
        'xHLP0511A & " - ")
...
#Region "Function"
    ...
    Private Sub MAIN_JOB08()
        ...
        Try
            ...
            If PrcExe("USP_PFK1311_COPY_ITEM_MASTER", cn, OrderNoNew, OrderNo) Then
                Starting.close()

                If ISUD1311A_F1.Link_ISUD1311A_F1(3, OrderNoNew, Me.Name) = False Then Exit Sub
                Call DATA_SEARCH_VS1()
    ...
    Private Sub MAIN_JOB09()
        ...
        Try
            ...
            If PrcExe("USP_PFK1311_COPY_ITEM_MASTER_LINE", cn, OrderNoNew, OrderNo, OrderNoSeq) Then
                Starting.close()
    ...
    Private Sub MAIN_JOB10()
        ...
        Try
            ...
            If READ_PFK0102_1(OrderNo, OrderNoSeq) Then
                If HLP0511A.Link_HLP0511A(2, D0102.SpecNo, D0102.SpecNoSeq) = False Then Exit Sub
            End If
...
#Region "Data_search"
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13120_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP13120_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13120_SEARCH_VS_LINE", cn, cdSeason, ssp_WHERE.gData_CustomerName, ssp_WHERE.gData_SDate,
                                                       ssp_WHERE.gData_EDate, ssp_WHERE.gData_CheckRequest)
            SPR_PRO_NEW(vS_Line, DS1, "USP_PFP13120_SEARCH_VS_LINE", "vS_Line")
    ...
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            If chk_Total.Checked Then
                DS1 = PrcDS("USP_PFP13120_SEARCH_VS1_GROUPBASE", cn, ssp_WHERE.gData_SDate,
                ...
                If GetDsRc(DS1) = 0 Then
                    SPR_PRO_NEW(Vs1, DS1, "USP_PFP13120_SEARCH_VS1_GROUPBASE", "Vs1")
            ...
            Else
                DS1 = PrcDS("USP_PFP13120_SEARCH_VS1", cn, ssp_WHERE.gData_SDate,
                                                           ssp_WHERE.gData_EDate,
                                                           ssp_WHERE.gData_chkGCodeCheck,
                                                           ssp_WHERE.gData_chkGCodeSQL,
                                                           ssp_WHERE.gData_CustomerName,
                ...
                If GetDsRc(DS1) = 0 Then
                    SPR_PRO_NEW(Vs1, DS1, "USP_PFP13120_SEARCH_VS1", "Vs1")
                    Vs1.ActiveSheet.RowCount = 0
                    Vs1.Enabled = True
                    Exit Function
                End If
    ...
    Private Function DATA_SEARCH_vS2(ByVal OrderNo As String) As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13120_SEARCH_vS2", cn, OrderNo)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS2, DS1, "USP_PFP13120_SEARCH_vS2", "vS2")
                vS2.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS2_MATERIAL() As Boolean
        ...
        SpecNo = getData(Vs1, getColumIndex(Vs1, "SpecNo"), Vs1.ActiveSheet.ActiveRowIndex)
        SpecNoSeq = getData(Vs1, getColumIndex(Vs1, "SpecNoSeq"), Vs1.ActiveSheet.ActiveRowIndex)

        Try
            DS1 = PrcDS("USP_PFP13120_SEARCH_vS2_SPECNO_SPECSEQ", cn, SpecNo, SpecNoSeq)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS2, DS1, "USP_PFP13120_SEARCH_vS2_SPECNO_SPECSEQ", "vS2")
                vS2.Enabled = True
                Exit Function
            End If
    ...
    '        Try
    '            DS1 = PrcDS("USP_PFP13120_SEARCH_vS2_MATERIAL", cn, SpecNoList)

    '            If GetDsRc(DS1) = 0 Then
    '                SPR_PRO_NEW(vS2, DS1, "USP_PFP13120_SEARCH_vS2_MATERIAL", "vS2")
    '                vS2.Enabled = True
    '                Exit Function
    '            End If

    '            SPR_PRO_NEW_NO_PFK9911(vS2, DS1, "USP_PFP13120_SEARCH_vS2_MATERIAL", "vS2")
...
#Region "Event"
    ...
    Private Sub cmd_SEARCH_Click(sender As Object, e As EventArgs) Handles cmd_SEARCH.Click
        Try
            ...
            If chk_Total.Checked Then
                vs_Season.ActiveSheet.ActiveRowIndex = 0
                vS_Line.ActiveSheet.ActiveRowIndex = 0
            End If
