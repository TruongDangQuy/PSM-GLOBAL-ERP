...
#Region "Link"
    Public Function Link_ISUD3421E(job As Integer, FactOrderNo As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "", Optional ByVal link_Subprocess As String = "", Optional ByVal link_ProcessName As String = "") As Boolean
        Link_ISUD3421E = False
    ...
    Public Function Link_ISUD3421E_INSERT(job As Integer, cdSubProcess As String, OrderNo As String, OrderNoSeq As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        ...
        Call READ_PFK7171(ListCode("SubProcess"), cdSubProcess)
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3421E_SEARCH_HEAD", cn, L3421.FactOrderNo)
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            'MR.SON FIX
            _chk_CheckPurchasingOrder = "2"

            DS1 = PrcDS("USP_ISUD3421E_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421E_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "Vs1")
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421E_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then

                DS2 = PrcDS("USP_ISUD3421E_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder & "_INSERT", cn, L3421.FactOrderNo)

                SPR_PRO_NEW(vS2, DS2, "USP_ISUD3421E_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS2")
            ...
            SPR_PRO_NEW(vS2, DS1, "USP_ISUD3421E_SEARCH_VS2_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "VS2")
            ...
            Call VsSizeRangeTitle(vS2, "USP_VS_SIZERANGE_3421E_S001", str_AutoLink, getData(Vs1, getColumIndex(Vs1, "cdSubProcess"), 0))
            Call VsSizeRangeTitle(vS2, "USP_VS_SIZERANGE_3421E_B001", str_AutoLink, getData(Vs1, getColumIndex(Vs1, "cdSubProcess"), 0))
    ...
    Private Sub DATA_MOVE_WRITE01()
        ...
        For i = 0 To Vs1.ActiveSheet.RowCount - 1
            ...
            If K3422_MOVE(Vs1, i, W3422, L3422.FactOrderNo, getData(Vs1, getColumIndex(Vs1, "KEY_FactOrderSeq"), i)) = True Then
                ...
                W3422.cdSubProcess = getData(Vs1, getColumIndex(Vs1, "cdSubProcess"), i)
                If txt_cdSubProcess.Code <> "" Then
                    If W3422.cdSubProcess = "" Then W3422.cdSubProcess = txt_cdSubProcess.Code
                End If
...
skip:
    ...
    Private Sub DATA_UPDATE_SIZERANGE()
        Try
            Call PrcExe("USP_PFK3422_UPDATE_SIZEQTY", cn, L3421.FactOrderNo)
        Catch ex As Exception
    ...
    Private Sub DATA_MOVE_WRITE02()
        ...
        For i = 0 To vS2.ActiveSheet.RowCount - 1
            ...
            j = j + 1
            If K3424_MOVE(vS2, i, W3424, L3421.FactOrderNo, getData(vS2, getColumIndex(vS2, "KEY_FactOrderSeq"), i)) = True Then
                Call REWRITE_PFK3424(W3424)
                Call PrcExe("USP_PFK3424_UPDATE_SIZEQTY", cn, W3424.FactOrderNo, W3424.FactOrderSeq)

            Else
                W3424.FactOrderNo = L3421.FactOrderNo
                W3424.FactOrderSeq = getData(vS2, getColumIndex(vS2, "KEY_FactOrderSeq"), i)

                Call WRITE_PFK3424(W3424)
                Call PrcExe("USP_PFK3424_UPDATE_SIZEQTY", cn, W3424.FactOrderNo, W3424.FactOrderSeq)
            End If
skip:
...
#Region "Event"
    ...
    Private Sub Vs1_ButtonClicked(sender As Object, e As EditorNotifyEventArgs) Handles Vs1.ButtonClicked
        ...
        Select Case xCOL
            Case getColumIndex(Vs1, "CLcdMaterialCode_D")
                ...
                If FormatCut(ShoesCode) = "" Then
                    If HLP7231C.Link_HLP7231C("041", "133", "") Then
                    ...
                    For i = 0 To Value1.Length - 1
                        ...
                        If Value2.Length > 1 Then
                            If READ_PFK1312(Value2(0), Value2(1)) = True Then
                                ...
                                setData(sender, getColumIndex(Vs1, "Key_ShoesCode"), xROW, D7106.ShoesCode)
            ...
            Case getColumIndex(Vs1, "Chk_Component")
                Dim ShoesCode As String
                Dim GroupComponentBOM As String
                Dim GroupComponentSeq As String
                ...
                If HLP7108B.Link_HLP7108B_SHOESCODE(ShoesCode) = True Then
                    ...
                    If GroupComponentBOM <> "" Then
                        If hlp0000SeVa = "Component" Then
                            If READ_PFK7109(GroupComponentBOM, GroupComponentSeq) = True Then

                                Call READ_PFK7106(D1312.ShoesCode)

                                If READ_PFK7109(GroupComponentBOM, GroupComponentSeq) = True Then
                                    setData(sender, getColumIndex(Vs1, "MaterialCode"), Vs1.ActiveSheet.ActiveRowIndex, D7109.MaterialCode)
                                    READ_PFK7231(D7109.MaterialCode)
                                    setData(sender, getColumIndex(Vs1, "MaterialName"), Vs1.ActiveSheet.ActiveRowIndex, D7231.MaterialName + " " + D7231.MaterialPName)
                                    setData(sender, getColumIndex(Vs1, "MaterialColorName"), Vs1.ActiveSheet.ActiveRowIndex, D7109.ColorName)
                                    setData(sender, getColumIndex(Vs1, "ColorName"), Vs1.ActiveSheet.ActiveRowIndex, D7109.ColorName)

                                    setData(sender, getColumIndex(Vs1, "seUnitMaterial"), Vs1.ActiveSheet.ActiveRowIndex, D7231.seUnitMaterial)
                                    setData(sender, getColumIndex(Vs1, "cdUnitMaterial"), Vs1.ActiveSheet.ActiveRowIndex, D7231.cdUnitMaterial)
                                    Call READ_PFK7171(D7231.seUnitMaterial, D7231.cdUnitMaterial)
                                    setData(sender, getColumIndex(Vs1, "cdUnitMaterialName"), Vs1.ActiveSheet.ActiveRowIndex, D7171.BasicName)

                                    setData(sender, getColumIndex(Vs1, "seUnitPacking"), Vs1.ActiveSheet.ActiveRowIndex, D7231.seUnitPacking)
                                    setData(sender, getColumIndex(Vs1, "cdUnitPacking"), Vs1.ActiveSheet.ActiveRowIndex, D7231.cdUnitPacking)
                                    Call READ_PFK7171(D7231.seUnitPacking, D7231.cdUnitPacking)
                                    setData(sender, getColumIndex(Vs1, "cdUnitPackingName"), Vs1.ActiveSheet.ActiveRowIndex, D7171.BasicName)

                                    setData(sender, getColumIndex(Vs1, "seUnitPrice"), Vs1.ActiveSheet.ActiveRowIndex, D7231.seUnitPrice)
                                    setData(sender, getColumIndex(Vs1, "cdUnitPrice"), Vs1.ActiveSheet.ActiveRowIndex, D7231.cdUnitPrice)
                                    Call READ_PFK7171(D7231.seUnitPrice, D7231.cdUnitPrice)
                                    setData(sender, getColumIndex(Vs1, "cdUnitPriceName"), Vs1.ActiveSheet.ActiveRowIndex, D7171.BasicName)

                                End If

                                setData(Vs1, getColumIndex(Vs1, "DateExchange"), Vs1.ActiveSheet.ActiveRowIndex, txt_DateExchange.Data)
                                setData(Vs1, getColumIndex(Vs1, "DateDelivery"), Vs1.ActiveSheet.ActiveRowIndex, txt_DateDelivery.Data)
                                setData(Vs1, getColumIndex(Vs1, "DateFinish"), Vs1.ActiveSheet.ActiveRowIndex, txt_DateFinish.Data)
                                setData(Vs1, getColumIndex(Vs1, "DateStart"), Vs1.ActiveSheet.ActiveRowIndex, txt_DateStart.Data)

                                If rad_CheckMarketType1.Checked = True Then
                                    setData(Vs1, getColumIndex(Vs1, "cdTax"), Vs1.ActiveSheet.ActiveRowIndex, "001")
                                    setData(Vs1, getColumIndex(Vs1, "cdTaxName"), Vs1.ActiveSheet.ActiveRowIndex, "0.1")
                                    setData(Vs1, getColumIndex(Vs1, "cdUnitPrice"), Vs1.ActiveSheet.ActiveRowIndex, "001")
                                    setData(Vs1, getColumIndex(Vs1, "cdUnitPriceName"), Vs1.ActiveSheet.ActiveRowIndex, "VND")
                            ...
                            'Vs1.ActiveSheet.RowCount += 1
                        Else
                            Dim xAutokey As Decimal = 0

                            xAutokey = D7113.Autokey

                            If READ_PFK7113(xAutokey) = True Then
                                W7113 = D7113

                                Call READ_PFK7106(D1312.ShoesCode)

                                setData(sender, getColumIndex(Vs1, "MaterialCode"), Vs1.ActiveSheet.ActiveRowIndex, D7113.MaterialCode)

                                If READ_PFK7231(W7113.MaterialCode) Then
                                    setData(sender, getColumIndex(Vs1, "MaterialName"), Vs1.ActiveSheet.ActiveRowIndex, D7231.MaterialName + " " + D7231.MaterialPName)
    ...
    Private Sub Vs1_Change(sender As Object, e As ChangeEventArgs) Handles Vs1.Change
        ...
        Try
            ...
            '''''''''''''''''''
            If READ_PFK4010(getData(Vs1, getColumIndex(Vs1, "slno"), xROW)) = True Then
                Call READ_PFK4002(D4010.WorkOrder, D4010.WorkOrderSeq)
                Call READ_PFK1312(D4002.OrderNo, D4002.OrderNoSeq)
