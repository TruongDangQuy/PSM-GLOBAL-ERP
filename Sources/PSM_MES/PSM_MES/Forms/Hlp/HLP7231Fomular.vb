...
#Region "Form_Load"
    Public Function Link_HLP7231Fomular(BasicName As String) As Boolean
        hlp0000SeVaTt = ""
        hlp0000SeVa = ""
        hlp0000SeVaTt1 = ""
...
#Region "Methods"
    Public Function DATA_SEARCH01(Head_No As Long) As Boolean
        ...
        Try
            DS1 = PrcDS("USP_HLP7231FU_SEARCH_VS1", cn, "*" & txt_Name.Data, txt_Width.Data, txt_Height.Data, txt_SizeName.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_HLP7231FU_SEARCH_VS1", "Vs1")
                Vs1.ActiveSheet.RowCount = 0
                Vs1.Enabled = True
                Exit Function
            End If
            SPR_PRO_NEW(Vs1, DS1, "USP_HLP7231FU_SEARCH_VS1", "Vs1", , True)
...
#Region "Events"
    ...
    Public Overridable Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        ...
        Else
            ...
            hlp0000SeVa = CInt(txt_QtyCal.Data)
    ...
    Private Sub Vs1_KeyDown(sender As Object, e As KeyEventArgs)
