...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Vs10.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01653_SEARCH_VS10", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, SdateEdate.text1, SdateEdate.text2)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP01653_SEARCH_VS10", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS11(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP01653_SEARCH_VS11", cn, cdFactory, LineProd, DateProd, FactOrderNo, FactOrderSeq, PKONO)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS11, DS1, "USP_PFP01653_SEARCH_VS11", "VS11")
                vS11.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        Vs20.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01653_SEARCH_VS20", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, SdateEdate.text1, SdateEdate.text2)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs20, DS1, "USP_PFP01653_SEARCH_VS20", "VS20")
                Vs20.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS21(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP01653_SEARCH_VS21", cn, cdFactory, LineProd, DateProd, FactOrderNo, FactOrderSeq, PKONO)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs21, DS1, "USP_PFP01653_SEARCH_VS21", "vS21")
                Vs21.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS30.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01653_SEARCH_VS30", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, SdateEdate.text1, SdateEdate.text2)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS30, DS1, "USP_PFP01653_SEARCH_VS30", "VS30")
                vS30.Enabled = True
                Exit Function
            End If
