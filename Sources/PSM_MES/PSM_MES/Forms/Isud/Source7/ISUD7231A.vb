...
#Region "Link"
    Public Function Link_ISUD7231A(job As Integer, MaterialCode As String, Optional ByVal TAG As String = "") As Boolean

        D7231.MaterialCode = MaterialCode

        wJOB = job : L7231 = D7231

        Link_ISUD7231A = False
        ...
        Link_ISUD7231A = isudCHK

    End Function

    Public Function Link_ISUD7231A_AUTO(job As Integer, ByRef Value As String, MaterialCode As String, MaterialName As String, Optional ByVal TAG As String = "") As Boolean

        D7231.MaterialCode = MaterialCode

        wJOB = job : L7231 = D7231

        Link_ISUD7231A_AUTO = False
...
#Region "Event"
    ...
    End Sub
    Private Sub tst_iSave2_Click(sender As Object, e As EventArgs)
        Select Case wJOB
            Case 91
