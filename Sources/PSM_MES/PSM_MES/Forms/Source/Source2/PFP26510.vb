...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        '                "PRODUCT INBOUND PROCESSING - " & WordConv("INPUT") & "(F5)")
        ...
        ''                "PRODUCT INBOUND PROCESSING - " & WordConv("SEARCH") & "(F6)", _
        ''                "PRODUCT INBOUND PROCESSING - " & WordConv("UPDATE") & "(F7)", _
        ''                "PRODUCT INBOUND PROCESSING - " & WordConv("DELETE") & "(F8)")
...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP26510_SEARCH_vS20_F1", cn, SdateEdate.text1, _
                                                       SdateEdate.text2, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS10, DS1, "USP_PFP26510_SEARCH_vS20_F1", "vS20")
            vS10.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS11(Optional ByVal xsort As String = "1") As Boolean
        ...
        ProductInboundNo = getData(vS10, getColumIndex(vS10, "KEY_ProductInboundNo"), vS10.ActiveSheet.ActiveRowIndex)
        KEY_AutoKey = getData(vS10, getColumIndex(vS10, "KEY_AutoKey"), vS10.ActiveSheet.ActiveRowIndex)

        DS1 = PrcDS("USP_PFP26510_SEARCH_vS11", cn, ProductInboundNo,
                                                    KEY_AutoKey)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS11, DS1, "USP_PFP26510_SEARCH_vS11", "vS11")
            vS11.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS11_PKO(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP26510_SEARCH_vS11_PKO", cn, Key_cdSeason, KEY_FactOrderNo, KEY_FactOrderSeq, Key_PKO, getData(vS10, getColumIndex(vS10, "KEY_ProductInboundNo"), vS10.ActiveSheet.ActiveRowIndex))

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS11, DS1, "USP_PFP26510_SEARCH_vS11_PKO", "vS11")
                vS11.Enabled = True
                Exit Function
            End If
...
#Region "Event"
    ...
    Private Sub vS10_CellDoubleClick(sender As Object, e As CellClickEventArgs) Handles vS10.CellDoubleClick
        ...
        Select Case e.Column
            ...
            Case CDblp(getColumIndex(vS10, "QtyProductInboundTotail"))
...
#End Region
    ...
    Private Sub DATA_SEARCH_VS11_All()
