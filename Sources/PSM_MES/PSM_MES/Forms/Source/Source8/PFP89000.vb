...
#Region "Formload"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        If MsgBoxPPW_Management("Please if password to access !", "XXXX") = False Then
            cmd_SEARCH.Visible = False
            SdateEdate.Visible = False
            txt_cdSite.Visible = False
            txt_CustomerCode.Visible = False
        End If
    ...
    Private Sub FORM_INIT()
        ...
        DS1 = PrcDS("USP_PFP89000_SEARCH_HEAD", cn)
        Dim i As Integer
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH(sender As Object) As Boolean
        ...
        ProcName = "USP_PFP89000_SEARCH_VS" & ItemMain.SelectedIndex.ToString("00")

        DS1 = PrcDS(ProcName, cn, SdateEdate.text1, SdateEdate.text2, txt_cdSite.Code, txt_CustomerCode.Code)

        sender.ActiveSheet.GrayAreaBackColor = Color.White

        If GetDsRc(DS1) = 0 Then
            sender.Enabled = True
            SPR_PRO_NEW(sender, DS1, ProcName, "Vs" & ItemMain.SelectedIndex.ToString("00"))
            Exit Function
        End If
