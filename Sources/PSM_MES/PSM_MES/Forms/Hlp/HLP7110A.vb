...
#Region "Formload"
    ...
    Public Function Link_HLP7110A(cdGroupComponent As String, Optional ByVal TAG As String = "") As Boolean
        Link_HLP7110A = False
        Me.Tag = TAG
        ...
        Try
            ...
            If READ_PFK7171(ListCode("GroupComponent"), cdGroupComponent) = True Then
                txt_cdGroupComponent.Code = D7171.BasicCode
                txt_cdGroupComponent.Data = D7171.BasicName
                txt_cdGroupComponent.Enabled = False
            End If

            Me.ShowDialog()
            Link_HLP7110A = isudCHK
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        DATA_SEARCH01 = False
        If txt_cdGroupComponent.Data = "" Then txt_cdGroupComponent.Code = ""
        Vs1.Enabled = False

        DS1 = PrcDS("USP_HLP7110A_SEARCH_VS1", cn, txt_cdGroupComponent.Code)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_HLP7110A_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7110A_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO_NEW(Vs2, DSNEW, "USP_HLP7110A_SEARCH_VS2", "Vs2")
...
#Region "EVENT"
    ...
    Private Sub vS1_Click(ByVal Col As Long, ByVal Row As Long)
        ...
        Call DATA_SEARCH02(getData(Vs1, 0, Row))
    End Sub
