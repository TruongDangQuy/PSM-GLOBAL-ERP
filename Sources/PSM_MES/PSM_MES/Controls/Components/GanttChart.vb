...
Public Class GanttChart
    ...
    Private dateTextFont As Font = New Font("Tahoma", 8.0, FontStyle.Regular, GraphicsUnit.Point)
    Private timeTextFont As Font = New Font("Tahoma", 8.0, FontStyle.Regular, GraphicsUnit.Point)
    Private rowTextFont As Font = New Font("Tahoma", 8.0, FontStyle.Regular, GraphicsUnit.Point)
