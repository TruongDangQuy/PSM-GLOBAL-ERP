...
#Region "Link"
    Public Function Link_ISUD7110F(job As Integer, ShoesCode As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        ...
        If READ_PFK7106(ShoesCode) = False Then Link_ISUD7110F = False : Exit Function
        If D7106.CheckComplete = "1" Then MsgBoxP("Already complete! Đã hoàn thành !", vbInformation)


        Link_ISUD7110F = False
...
next1:
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD7110F_SEARCH_VS2", cn, ShoesCode)


        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_ISUD7110F_SEARCH_VS2", "VS2")
            ...
            If e.Column = getColumnIndex(vS2, "MaterialAMTSales") Then
                ...
                Else
                    ...
                    If K7109_MOVE(vS2, xROW, W7109, W7109.GroupComponentBOM, W7109.GroupComponentSeq) = False Then
                        ...
                        W7109.MaterialAMT = W7109.MaterialAMTSales

                        W7109.MaterialAMTSales = W7109.MaterialAMTSales / (1 + W7109.ShippingRate / 100)
                        W7109.MaterialAMTSales -= W7109.ExchangeCost
                        W7109.MaterialAMTSales -= W7109.AddedCost
                        W7109.MaterialAMTSales -= W7109.ComplicationCost
                        W7109.MaterialAMTSales -= W7109.ShippingCost

                        W7109.GrossUsage = W7109.Consumption * (1 + W7109.Loss / 100)

                        W7109.Price = W7109.MaterialAMTSales / W7109.GrossUsage

                        W7109.PriceRnD = W7109.Price
