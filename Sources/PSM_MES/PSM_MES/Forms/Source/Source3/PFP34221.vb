...
#Region "Function"
    ...
    Private Sub MAIN_JOB09()
        ...
        If cdLineProd <> "" Then
            ...
            LineTno = PrcExeNoError_Value("USP_PFK4073_INSERT_AUTO_SlNoD_SizeCheck", cn, cdSeason, "051", cdMainProcess, cdLineProd, SealNo)

            If LineTno = "" Then Exit Sub

            If ISUD4073D_NC.Link_ISUD4073D(1, "051", cdMainProcess, cdLineProd, LineTno, "PFP34221") Then
                Me.Show()
...
#Region "Data_search"
    Private Function DATA_SEARCH01(Optional ByVal xsort As String = "1") As Boolean
        ...
        If opt_G1.Checked = True Then
            ...
            DS1 = PrcDS("USP_PFP34221_SEARCH_VS1_GROUP", cn, SdateEdate.text1,
                                                        SdateEdate.text2,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP34221_SEARCH_VS1_GROUP", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
        ...
        Else
            ...
            DS1 = PrcDS("USP_PFP34221_SEARCH_VS1_DETAIL", cn, SdateEdate.text1,
                                                       SdateEdate.text2,
                                                       txt_GCODE.chkAll.CheckState,
                                                       txt_GCODE.SQL,
                                                         txt_cdDepartment.Code,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP34221_SEARCH_VS1_DETAIL", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP34221_SEARCH_VS1_LINE", cn, FactOrderNo,
                                                        FactOrderSeq)
            ...
            READ_SPREAD(Vs1, DS1, "USP_PFP34221_SEARCH_VS1", "Vs1", Vs1.ActiveSheet.ActiveRowIndex)
