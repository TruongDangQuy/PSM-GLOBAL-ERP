...
#Region "Form_load"
    Friend Function Link_HLP1312Material(Optional Chk_Order As String = "0") As Boolean
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDSVN("USP_HLP1312A_SEARCH_VS1", cn, SdateEdate.text1,
                                                        SdateEdate.text2,
                                                        txt_cdSeason.Code,
                                                        txt_Customer.Code,
                                                        txt_Article.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(PeacePanalSeach, DS1, "USP_HLP1312A_SEARCH_VS1", "Vs1")
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        Try
            ...
            For i = 0 To PeacePanalSeach.ActiveSheet.RowCount - 1
                If getDataM(PeacePanalSeach, getColumIndex(PeacePanalSeach, "CheckUse"), i) = "1" And CIntp(getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_OrderNoSeq"), i)) > 0 Then
                    CheckValue = True
                    hlp0000SeVa &= "''" & getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_OrderNo"), i)
                    hlp0000SeVa &= getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "KEY_OrderNoSeq"), i) & "''|"
                End If
            Next
