...
#Region "Variable"
    ...
    Private _DateOutBound As String
    ...
    Private _CheckOutBoundMaterial As String

#End Region

#Region "Form"
    Public Function Link_ISUD2356C(job As Integer, DateOutBound As String, cdDepartment As String, cdLineProd As String, cdSubProcess As String, SupplierCode As String, CustomerCode As String, JobCard As String, CheckOutBoundMaterial As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG

        _DateOutBound = DateOutBound
        ...
        _JobCard = JobCard
        _CheckOutBoundMaterial = CheckOutBoundMaterial

        wJOB = job
        Link_ISUD2356C = False
...
#Region "Search"
    ...
    Private Function DATA_SEARCH_HEAD_INSERT() As Boolean
        ...
        Try
            Select Case L2356.CheckOutBoundMaterial
                Case "1"
                    DS1 = PrcDS("USP_ISUD2356C_SEARCH_HEAD_MaterialInSide", cn, L2356.FactOrderNo, L2356.FactOrderSeq)

                Case "2"
                    DS1 = PrcDS("USP_ISUD2356C_SEARCH_HEAD_MaterialSales", cn, L2356.FactOrderNo, L2356.FactOrderSeq)

                Case "3"
                    DS1 = PrcDS("USP_ISUD2356C_SEARCH_HEAD_MaterialTrash", cn, L2356.FactOrderNo, L2356.FactOrderSeq)

                Case "4"
                    DS1 = PrcDS("USP_ISUD2356C_SEARCH_HEAD_Balance", cn, L2356.FactOrderNo, L2356.FactOrderSeq)

                Case "5"
                    DS1 = PrcDS("USP_ISUD2356C_SEARCH_HEAD_ReturnOut", cn, L2356.FactOrderNo, L2356.FactOrderSeq)

                Case "7"
                    DS1 = PrcDS("USP_ISUD2356C_SEARCH_HEAD_ReturnPurchasing", cn, L2356.FactOrderNo, L2356.FactOrderSeq)
    ...
    Private Function DATA_SEARCH_HEAD_MaterialFullNo() As Boolean
        ...
        Try
            Select Case L2356.CheckOutBoundMaterial
                Case "1", "2", "3", "4"
                    DS1 = PrcDS("USP_ISUD2356C_SEARCH_HEAD_MaterialFullNo", cn, L2356.MaterialInBoundNo, L2356.MaterialInBoundSeq, L2356.MaterialInBoundSno)
                Case "5", "7"
                    DS1 = PrcDS("USP_ISUD2356C_SEARCH_HEAD_MaterialFullNo_Customer", cn, L2356.MaterialInBoundNo, L2356.MaterialInBoundSeq, L2356.MaterialInBoundSno, txt_CustomerOutBound.Code)
            End Select
    ...
    Private Function DATA_SEARCH_VS1_INSERT(Optional xrow As Integer = 0) As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD2356C_SEARCH_VS1_INSERT", cn, L2356.MaterialInBoundNo, _
            ...
            Call READ_SPREAD(vS1, DS1, "USP_ISUD2356C_SEARCH_VS1_F1", "Vs1", xrow)
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD2356C_SEARCH_VS1", cn, _DateOutBound, _cdDepartment, _cdLineProd, _cdSubProcess, _SupplierCode, _CustomerCode, _JobCard, _CheckOutBoundMaterial)

            If GetDsRc(DS1) = 0 Then
                SPR_SET(vS1, , , , OperationMode.Normal)
                SPR_PRO(vS1, DS1, "USP_ISUD2356C_SEARCH_VS1", "vS1")
    ...
    Private Function DATA_SEARCH_VS1_LINE() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD2356C_SEARCH_VS1_LINE", cn, L2356.DateOutBoundMaterial, _
            ...
            Call READ_SPREAD(vS1, DS1, "USP_ISUD2356C_SEARCH_VS1", "Vs1", vS1.ActiveSheet.RowCount - 1)
...
#Region "Event"
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
            ...
            If getDataM(vS1, getColumIndex(vS1, "DCHK"), xrow) = "1" Then
                If READ_PFK2356(DateOutBoundMaterial, SeqOutBoundMaterial, SnoOutBoundMaterial) Then
                    If CIntp(D2356.JobCardWorking) = 0 Then
                        ...
                        setData(vS1, getColumIndex(vS1, "JobCardWorking"), xrow, JobCardWorking)
                        Call REWRITE_PFK2356(D2356)
        ...
        Call PrcExeNoError("USP_PFK2367A_INSERT", cn, JobCardWorking)
