...
#Region "Form_Load"
    Public Function Link_PFP94600(_BasicSel As String) As Boolean
        BasicSel = _BasicSel

        Me.ShowDialog()

        Link_PFP94600 = hlpCHK
    End Function

    Private Sub HLP0000_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If Me.PeaceFormType.Contains("_") Then
            BasicSel = Strings.Right(Me.PeaceFormType, 3)
...
#Region "Methods"
    Public Overridable Function DATA_SEARCH01() As Boolean
        ...
        Try
            ...
            If READ_PFK7171("946", BasicSel) Then

                DATADA.SelectCommand = New SqlClient.SqlCommand(PrcDS_SQL("USP_PFP94600_SEARCH_vS1", "1", D7171.NameSimply, txt_Name.Data), cn)
                DATADA.Fill(DATASETNEW, "SP")
                'DATASETNEW = PrcDS("USP_PFP94600_SEARCH_vS1", cn, "1", BasicSel, txt_Name.Data)

                SPR_PRO_NEW(VS1, DATASETNEW, "USP_PFP94600_SEARCH_vS1", "Vs1")
                DATA_SEARCH01 = True
