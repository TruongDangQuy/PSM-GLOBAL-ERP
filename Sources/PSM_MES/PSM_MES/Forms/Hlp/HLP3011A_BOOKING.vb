...
#Region "Form_load"
    Friend Function Link_HLP3011Material(MaterialCode As String, ColorCode As String) As Boolean
        ...
        If READ_PFK7121(ColorCode) Then
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDSVN("USP_HLP3011A_BOOKING_SEARCH_APPROVAL_VS1", cn,
                                                        txt_cdSite.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(PeacePanalSeach, DS1, "USP_HLP3011A_BOOKING_SEARCH_APPROVAL_VS1", "Vs1")
