...
#Region "Form_load"
    Friend Function Link_HLP3011Material(Optional Chk_Order As String = "0") As Boolean
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDSVN("USP_HLP3011A_SEARCH_VS1", cn, SdateEdate.text1,
                                                        SdateEdate.text2,
                                                        txt_cdSeason.Code,
                                                        txt_Customer.Code,
                                                        txt_Article.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(PeacePanalSeach, DS1, "USP_HLP3011A_SEARCH_VS1", "Vs1")
