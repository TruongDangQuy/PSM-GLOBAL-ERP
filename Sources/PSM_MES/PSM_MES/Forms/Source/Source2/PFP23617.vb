...
#Region "Form_load"
    ...
    End Sub
    Private Sub PFP23617_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23617_SEARCH_vS10", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                    txt_cdSeason.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS10, DS1, "USP_PFP23617_SEARCH_vS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23617_SEARCH_vS20", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                    txt_cdSeason.Code,
                                                    txt_CustomerCode.Code,
                                                    txt_cdDepartment.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23617_SEARCH_vS20", "VS20")
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23617_SEARCH_vS30", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                    txt_cdSeason.Code,
                                                    txt_CustomerCode.Code,
                                                    txt_cdDepartment.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23617_SEARCH_vS30", "vS30")
        ...
        SPR_PRO_NEW(vS30, DS1, "USP_PFP23617_SEARCH_vS30", "vS30")
    ...
    Private Function DATA_SEARCH_VS40(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23617_SEARCH_vS40", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                    txt_cdSeason.Code,
                                                    txt_CustomerCode.Code,
                                                    txt_cdDepartment.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23617_SEARCH_vS40", "vS40")
        ...
        SPR_PRO_NEW(vS40, DS1, "USP_PFP23617_SEARCH_vS40", "vS40")
    ...
    Private Function DATA_SEARCH_VS50(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23617_SEARCH_VS50", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                    txt_cdSeason.Code,
                                                    txt_CustomerCode.Code,
                                                    txt_cdDepartment.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23617_SEARCH_VS50", "VS50")
        ...
        SPR_PRO_NEW(vS50, DS1, "USP_PFP23617_SEARCH_VS50", "VS50")
