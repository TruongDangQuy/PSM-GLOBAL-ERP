...
#Region "Formload"
    ...
    Private Sub PFP23528_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FORM_INIT()
        ...
        DS1 = PrcDS("USP_PFP23528_SEARCH_HEAD", cn)
        Dim i As Integer
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH(sender As Object) As Boolean
        ...
        ProcName = "USP_PFP23528_SEARCH_VS" & ItemMain.SelectedIndex.ToString("00")
