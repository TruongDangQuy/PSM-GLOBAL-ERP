...
Public Class PRINTSHEET_PA
    ...
    End Sub
    Private PayableNo As String
    Public Function Link_PRINTSHEET_PA(_PayableNo As String, SheetFileName As String, ByVal chuoi11 As String, ByVal chuoi22 As String) As Boolean

        Link_PRINTSHEET_PA = False
        filename = SheetFileName
        chuoi1 = chuoi11
        chuoi2 = chuoi22
        formA = False

        PayableNo = _PayableNo

        If READ_PFK3428(PayableNo) = False Then Exit Function
        If D3428.CheckComplete = "1" Then MsgBoxP("Already print!") : cmd_Prt.Visible = False Else cmd_Prt.Visible = True
        ...
        Link_PRINTSHEET_PA = isudCHK
    End Function

    Public Function Link_PRINTSHEET_PA(SheetFileName As String, ByVal chuoi11 As String, ByVal chuoi22 As String, _itemcode As String, _itemcodeno As String) As Boolean
        Link_PRINTSHEET_PA = False
        filename = SheetFileName
        chuoi1 = chuoi11
        chuoi2 = chuoi22
    ...
    Public Function Link_PRINTSHEET_PA(SheetFileName As String, ByVal Check As Boolean, ByVal chuoi11 As String) As Boolean
        Link_PRINTSHEET_PA = False
        filename = SheetFileName
        chuoi1 = chuoi11
        Data_Inti()
        ...
        If PrintDialog1.ShowDialog = DialogResult.OK Then
            ...
            Try
                ...
                If READ_PFK3428(PayableNo) Then
                    D3428.CheckComplete = "1"
                    D3428.InchargeUpdate = Pub.SAW

                    D3428.Remark = D3428.Remark & Pub.SAW & System_Date_time()
    ...
    Private Sub PRINTSHEET_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            Try
                str = "http://61.28.231.43:6847/CS_WHM/Report/" & filename & ".xlsx"
                str = "http://"
                str += Pub.SER.Replace(",", ":")
                str += "/CS_WHM/Report/" & filename & ".xlsx" 'Relace SHV to CS_WHM
            ...
            Catch ex As Exception
                Try
                    str = "http://61.28.231.43:6847/CS_WHM/Report/" & filename & ".xls"
                    str = "http://"
                    str += Pub.SER.Replace(",", ":")
                    str += "/CS_WHM/Report/" & filename & ".xls" 'Relace SHV to CS_WHM
            ...
            If filename = "PAYABLE_LIST" Or filename = "PAYABLE_LIST_NT" Then ' Jun add for auto row hight 2018/12/04 05:41 PM
                PeaceButton1.Visible = False
                vSPrint.Enabled = True
                For i = IDROWBEGIN To IDROWEND
                    If getData(vSPrint, 14, i) <> "" Then
