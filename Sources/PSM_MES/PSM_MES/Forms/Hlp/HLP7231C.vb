...
#Region "Form_Load"
    Public Function Link_HLP7231C(_cdLargeGroupMaterial As String, _cdSemiGroupMaterial As String, BasicName As String) As Boolean
        txt_cdLargeGroupMaterial.Data = ""
        txt_cdSemiGroupMaterial.Data = ""
        txt_cdLargeGroupMaterial.Code = ""
        txt_cdSemiGroupMaterial.Code = ""

        txt_cdLargeGroupMaterial.Code = _cdLargeGroupMaterial
        txt_cdSemiGroupMaterial.Code = _cdSemiGroupMaterial

        Call READ_PFK7171(ListCode("LargeGroupMaterial"), _cdLargeGroupMaterial) : txt_cdLargeGroupMaterial.Data = D7171.BasicName : txt_cdLargeGroupMaterial.Enabled = False
        Call READ_PFK7171(ListCode("SemiGroupMaterial"), _cdSemiGroupMaterial) : txt_cdSemiGroupMaterial.Data = D7171.BasicName : txt_cdSemiGroupMaterial.Enabled = False
    ...
    Public Function DATA_SEARCH01(Head_No As Long) As Boolean
        ...
        Try
            ...
            If chkLast = True Then
                If txt_cdLargeGroupMaterial.Code = "" Then
                    txt_cdLargeGroupMaterial.Code = "014" : Call READ_PFK7171(ListCode("LargeGroupMaterial"), "014") : txt_cdLargeGroupMaterial.Data = D7171.BasicName
                End If
                If txt_cdSemiGroupMaterial.Code = "" Then
        ...
        Select Case True
            Case vS_Semi.Focused
                ...
                If READ_PFK7171(ListCode("SemiGroupMaterial"), cdSemiGroupMaterial) Then
                    Call ISUD7171A.Link_ISUD7171A(1, ListCode("LargeGroupMaterial"), cdLargeGroupMaterial, D7171.BasicSel, "000")
                End If

            Case vS_Detail.Focused

            Case vS_Spec.Focused
...
#Region "Events"
    ...
    Private Sub vS_Semi_CellDoubleClick(sender As Object, e As CellClickEventArgs) Handles vS_Semi.CellDoubleClick
        Try
            Dim cdSemiGroupMaterial As String
    ...
    Private Sub vS_Detail_CellDoubleClick(sender As Object, e As CellClickEventArgs) Handles vS_Detail.CellDoubleClick
        Try
        ...
        End Try
    End Sub
    Private Sub vS_Spec_CellDoubleClick(sender As Object, e As CellClickEventArgs) Handles vS_Spec.CellDoubleClick
        Try
            Dim Width As String
    ...
    Private Sub cmd_QuickAdd_Click(sender As Object, e As EventArgs) Handles cmd_QuickAdd.Click
        ...
        If ISUD7231S.Link_ISUD7231S_ADD(11, txt_cdLargeGroupMaterial.Code, txt_cdSemiGroupMaterial.Code, txt_cdDetailGroupMaterial.Code, txt_Width.Data, txt_Height.Data, txt_SizeName.Data, "PFP70231") = False Then Exit Sub
        Call DATA_SEARCH01(W1_Head)
