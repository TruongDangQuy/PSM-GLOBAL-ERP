...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH_01() As Boolean
        ...
        DS1 = PrcDS("USP_SPFP87007_SEARCH_HEAD", cn, txt_DateReport.Data)

        If GetDsRc(DS1) > 0 Then lbl_Factory.Text = GetDsData(DS1, 0, 0)


        DS1 = PrcDS("USP_SPFP87007_SEARCH_VS1", cn, txt_DateReport.Data)

        Try

            SPR_PRO_NEW(Vs1, DS1, "USP_SPFP87007_SEARCH_VS1", "Vs1")
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        Try
            ...
            If Vs1.ActiveSheet.RowCount > 0 Then
                ...
                DS2 = PrcDS("USP_SPFP87007_SEARCH_BACKCOLOR", cn, txt_DateReport.Data)
                ...
                If GetDsRc(DS2) > 0 Then
                    ...
                    DS2 = PrcDS("USP_SPFP87007_SEARCH_BACKCOLOR_ROWHEADER", cn, txt_DateReport.Data)
