...
#Region "Form_Load"
    Private Sub PFP99998_Load(sender As Object, e As EventArgs) Handles Me.Load
        W9982 = D9982
        W9981 = D9981
        W9985 = D9985
        W7411 = D7411
...
#Region "DATA_SEARCH"
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DATA_SEARCH_VS1 = False
            DS1 = PrcDS("USP_PFP99998_SEARCH_VS1", cn, txt_SANO.Data, _
                                                         "",
                                                        Const_Site, _
                                                        Const_Nationality, _
                                                        Const_Department, _
            ...
            If GetDsRc(DS1) = 0 Then
                Call SPR_PRO_NEW(Vs1, DS1, "USP_PFP99998_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH_VS1_LINE_DISP() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP99998_SEARCH_VS1_LINE_DISPLAY", cn, getData(Vs1, getColumIndex(Vs1, "IDNO"), Vs1.ActiveSheet.ActiveRowIndex), _
                                                        Const_Site, _
                                                        Const_Nationality, _
                                                        Const_Department, _
                                                        Const_OnePosition, _
    ...
    Private Function DATA_SEARCH_01() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP99998_SEARCH_VS1_LINE", cn, getData(Vs1, getColumIndex(Vs1, "IDNO"), Vs1.ActiveSheet.ActiveRowIndex), _
                                                            Const_Site, _
                                                            Const_Nationality, _
                                                            Const_Department, _
                                                            Const_OnePosition, _
    ...
    Private Function DATA_SEARCH_Vs20(valSITE As String, valSEL As String, valSANO As String, valCHK1 As String, valCHK2 As String) As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP99998_SEARCH_VS20", cn, valSITE, valSEL, valSANO, valCHK1, valCHK2)

            If GetDsRc(DS1) = 0 Then
                DS1 = PrcDS("USP_PFP99998_SEARCH_VS20", cn, valSITE, valSEL, "00000000", valCHK1, valCHK2)
            End If

            Call SPR_PRO_NEW(VS20, DS1, "USP_PFP99998_SEARCH_VS20", "Vs20")
    ...
    Private Function DATA_SEARCH_VS21(valSITE As String, valSEL As String, valSANO As String, valCHK1 As String, valCHK2 As String) As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP99998_SEARCH_VS21", cn, valSITE, valSEL, valSANO, valCHK1, valCHK2)

            If GetDsRc(DS1) = 0 Then
                DS1 = PrcDS("USP_PFP99998_SEARCH_VS21", cn, valSITE, valSEL, "00000000", valCHK1, valCHK2)
            End If

            Call SPR_PRO_NEW(VS21, DS1, "USP_PFP99998_SEARCH_VS21", "VS21")
    ...
    Private Function DATA_SEARCH_VS21_K9981(valSITE As String, valSEL As String) As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP99998_SEARCH_VS21_K9981", cn, valSITE, valSEL)
            ...
            Call SPR_PRO_NEW(VS21, DS1, "USP_PFP99998_SEARCH_VS21_K9981", "VS21")
    ...
    Private Function DATA_SEARCH_VS3() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP99998_SEARCH_VS3", cn, lab_SITE.Code, txt_IDNO.Code)

            If GetDsRc(DS1) = 0 Then
                Call SPR_PRO_NEW(vS3, DS1, "USP_PFP99998_SEARCH_VS3", "vS3")
        ...
        Try
            ...
            For i = 0 To VS20.ActiveSheet.RowCount - 1
                If getDataM(VS20, getColumIndex(VS20, "PCHK"), i) = "1" Then
                    ...
                    If READ_PFK7411(txt_IDNO.Code) Then


                        Call D9985_CLEAR()

                        W9985.SITE = D7411.cdSite
        ...
        Try
            ...
            For i = 0 To Vs1.ActiveSheet.RowCount - 1
                If getDataM(Vs1, getColumIndex(Vs1, "SCHK"), i) = "1" Then
                    ...
                    Call PrcExeNoError("USP_PFP99998_INSERT_PFK9985_Copy", cn, valSITE, valSEL, txt_SANO_Before.Code, valSANO)
...
#Region "Event"
    Private Sub cmdJOB_Click(sender As Object, e As EventArgs) Handles cmdJOB_dyw.Click
        ...
        Try
            ...
            '' Call PrcExeNoError("USP_PFP99998_DELETE_PFK9985", cn, Pub.SITE, "1")
            ''==================================================================================================================
            ''------------------------------------------------------------------------------------------------------------------
            ''------------------------------------------------------------------------------------------------------------------
            str = "2"  '' '1', PFP  , '2',ISUD
    ...
    Private Sub cmd_Save_Click(sender As Object, e As EventArgs) Handles cmd_Save.Click
        Try
            ...
            If READ_PFK7411(txt_IDNO.Data) Then

          
                If READ_PFK9992(D7411.cdSite, txt_IDNO.Data) = True Then
                    W9992 = D9992
                    ...
                    If READ_PFK9992_IDNO_CHECK(D7411.cdSite, txt_IDNO.Data, Trim$(W9992.ID)) = True Then
...
skip1:
        ...
        Try
            ...
            If Check_Copy.Checked = True Then
                ...
                If READ_PFK7411(txt_SANO_Before.Code) = True And READ_PFK7411(txt_SANO_After.Code) = True Then
                    ...
                    Call PrcExeNoError("USP_PFP99998_INSERT_PFK9985_Copy", cn, D7411.cdSite, valSEL, txt_SANO_Before.Code, txt_SANO_After.Code)
                Else
            ...
            If Check_All_Copy.Checked = True Then
                ...
                Call DATA_MOVE_PFK9985_ALL(D7411.cdSite, valSEL)
            End If
    ...
    Private Sub cmdDEL_Click(sender As Object, e As EventArgs) Handles cmd_del.Click
        ...
        Try
            ...
            If READ_PFK7411(txt_IDNO.Text.Trim) Then


                SQL = " DELETE FROM PFK9992 "
                SQL = SQL & " WHERE K9992_SITE = '" & D7411.cdSite & "' "
                SQL = SQL & "   AND K9992_SANO = '" & txt_IDNO.Text.Trim & "' "
                cmd = New SqlClient.SqlCommand(SQL, cn)
                cmd.ExecuteNonQuery()

                SQL = " DELETE FROM PFK9985 "
                SQL = SQL & " WHERE K9985_SITE = '" & D7411.cdSite & "' "
                SQL = SQL & "   AND K9985_SEL = '" & valSEL & "' "
                ...
                SQL = SQL & " WHERE K9996_SITE = '" & D7411.cdSite & "' "
