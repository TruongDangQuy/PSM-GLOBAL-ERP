...
#Region "Link"
    Public Function Link_ISUD3412B(job As Integer, PurchasingOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        ...
        Link_ISUD3412B = False
        Try

            If TAG = "PFP34112" Or TAG = "PFP34111" Then
    ...
    Public Function Link_ISUD3412B_AUTO(job As Integer, cdSeason As String, CustomerCode As String, SupplierCode As String, _Line As String, _cdLargeGroupMaterial As String, _cdSemiGroupMaterial As String, _checkSample As String, PurchasingOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        Chk_AutoLink = True
