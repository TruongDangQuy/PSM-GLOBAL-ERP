...
#Region "Formload"
    ...
    Public Function Link_HLP7305B(Optional ByVal TAG As String = "") As Boolean
        Link_HLP7305B = False
        Me.Tag = TAG
    ...
    Public Function Link_HLP7305B_SHOESCODE(ByVal SHOESCODE As String, Optional ByVal TAG As String = "") As Boolean
        Link_HLP7305B_SHOESCODE = False
        ...
        Try
            ...
            Me.ShowDialog()
            Link_HLP7305B_SHOESCODE = isudCHK
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        ...
        Vs1.Enabled = False
          ...
          DS1 = PrcDS("USP_HLP7305B_SEARCH_VS1_F1", cn, txt_ProcessBOMName.Data)
        ...
        SPR_PRO(Vs1, DS1, "USP_HLP7305B_SEARCH_VS1_F1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7305B_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO(Vs2, DSNEW, "USP_HLP7305B_SEARCH_VS2", "Vs2")
