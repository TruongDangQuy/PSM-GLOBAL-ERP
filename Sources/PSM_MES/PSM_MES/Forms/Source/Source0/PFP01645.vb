...
#Region "Form_load"
    ...
    End Sub
    Private Sub PFP01645_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP01645_SEARCH_VS10_PIVOT", cn, xSdate, xEdate, txt_cdFactory.Code, txt_cdMainProcess.Code, "", "")

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP01645_SEARCH_VS10_PIVOT", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP01645_SEARCH_VS20_PIVOT", cn, xSdate, xEdate, txt_cdFactory.Code, txt_cdMainProcess.Code, "", "")

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS20, DS1, "USP_PFP01645_SEARCH_VS20_PIVOT", "VS20")
                vS20.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS30.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01645_SEARCH_VS30_PIVOT", cn, SdateEdate.text1, SdateEdate.text2, txt_cdFactory.Code, txt_cdMainProcess.Code, "", "")

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS30, DS1, "USP_PFP01645_SEARCH_VS30_PIVOT", "VS30")
                vS30.Enabled = True
                Exit Function
            End If
...
#Region "Event"
    ...
    Private Sub PFP01645_Resize(sender As Object, e As EventArgs) Handles Me.Resize
