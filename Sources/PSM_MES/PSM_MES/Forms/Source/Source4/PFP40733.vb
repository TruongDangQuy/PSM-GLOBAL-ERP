...
#Region "load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call Cms_additem(Cms_1, "PRODUCTION INPUT - " & "(F11)")
        ...
        Call Cms_additem(Cms_2,
                     ...
                     "LINE PLANNING CONTROL - DELETE " & "(F10)",
                      ...
                      "GENERATE ALL BARCODE - " & "(F12)")

        Call Cms_additem(Cms_3,
                    "ADD NEW BARCODE ")

        vS31.ContextMenuStrip = Cms_3
    ...
    End Sub
    Private Sub PFP40733_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
#Region "Link"
    ...
    Private Sub MAIN_JOB01()
        ...
        If ISUD4073B.Link_ISUD4073B(1, cdFactory, cdMainProcess, cdLineProd, LineTno, Me.Name) = False Then Exit Sub
...
#Region "search"
    Private Sub DATA_SEARCH_HEAD(spr As FarPoint.Win.Spread.FpSpread, Xcol As Integer, Xrow As Integer, Value As String)
        Try
            ...
            DS2 = PrcDS("USP_PFP40733_SEARCH_HEAD", cn, cdFactory,
                                                       cdMainProcess,
                                                       cdLineProd,
                                                       "01")
    ...
    Public Function DATA_SEARCH01(ProcessType As String) As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP40733_SEARCH_VS1_HEAD", cn, ListCode("Factory"), txt_cdFactory.Code, ListCode("LineProd"))
            ...
            Dim STR_Foodbed As String = "2"
            Dim STR_Stockfit As String = "2"

            If chk_Foodbed.Checked = True Then
                STR_Foodbed = "1"
            End If

            If chk_Stockfit.Checked = True Then
                STR_Stockfit = "1"
            End If

            If chk_FullScreen.Checked Then

                DS2 = PrcDS("USP_PFP40733_SEARCH_VS1_F2_FULL", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, txt_cdSeason.Code)
                SPR_PRO(vS1, DS2, "USP_PFP40733_SEARCH_VS1_F2_FULL", "vS1")
            ...
            Else
                ...
                DS2 = PrcDS("USP_PFP40733_SEARCH_VS1_F2", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, txt_cdSeason.Code, STR_Foodbed, STR_Stockfit)
...
next1:
    ...
    Private Function DATA_SEARCH_VS2(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40733_SEARCH_VS2", cn, cdFactory,
                                                    cdMainProcess,
                                                    cdLineProd,
                                                    LineTno)
        ...
        SPR_PRO(vS2, DS1, "USP_PFP40733_SEARCH_VS2", "vs2")

        If READ_PFK4073(cdFactory, cdMainProcess, cdLineProd, LineTno) Then
            Call VsSizeRangeNew(vS2, "USP_VS_SIZERANGE_JOBBASE_STOCKFIT", "SizeQTY01", D4073.JobCard)
        End If
    ...
    Private Function DATA_SEARCH_VS31(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40733_SEARCH_vS31", cn, cdFactory,
                                                    cdMainProcess,
                                                    cdLineProd,
                                                    LineTno)
        ...
        SPR_PRO(vS31, DS1, "USP_PFP40733_SEARCH_vS31", "vS31")
    ...
    Private Function DATA_SEARCH_VS32(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP40733_SEARCH_vS32", cn, cdFactory,
                                                              cdMainProcess,
                                                              cdLineProd,
                                                              LineTno,
                                                              SizeName,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO(vS32, DS1, "USP_PFP40733_SEARCH_vS32", "vS32")
    ...
    Private Function DATA_SEARCH_VS32(xRow As Integer) As Boolean
        'lATER
        Dim BatchGroup As String
        Dim SizeName As String
        Dim cdMainProcess As String
    ...
    Private Function LINE_MOVE_DISPLAY01(spr As FarPoint.Win.Spread.FpSpread, Xcol As Integer, Xrow As Integer,
        ...
        DS2 = PrcDS("USP_ISUD4073B_SEARCH_LINE_TNO", cn, txt_cdFactory.Code,
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40733_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP40733_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40733_SEARCH_vS_Cus", cn, CustomerCode, cdSeason)
            SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP40733_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40733_SEARCH_vS_Line", cn, cdSeason, CustomerCode)
            SPR_PRO_NEW(vS_Line, DS1, "USP_PFP40733_SEARCH_vS_Line", "vS_Line")
    ...
    Public Function DATA_SEARCH_HEAD_vs_Job() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40733_SEARCH_vs_Job", cn, cdSeason, CustomerCode, Line)
            SPR_PRO_NEW(vs_Job, DS1, "USP_PFP40733_SEARCH_vs_Job", "vs_Job")
...
#Region "Event"
            ...
            If READ_PFK4073(cdFactory, cdMainProcess, cdLineProd, LineTno) = False Then
                ...
                If READ_PFK4010_SlnoD(StrMsg) And FormatCut(StrMsg) <> "" Then
                    If chk_Size.Checked = False Then
                        PrcExeNoError("USP_PFK4073_INSERT_AUTO_SlNoD_QtyBase", cn, txt_cdSeason.Code, cdFactory, cdMainProcess, cdLineProd, StrMsg, txt_BatchSizeQ.Value)
                    ...
                    ElseIf chk_Size.Checked = True Then
                        ...
                        If ISUD4073C.Link_ISUD4073C_QTYBASE(1, cdFactory, cdMainProcess, cdLineProd, LineTno, txt_BatchSizeQ.Value, "PFP40733") Then
                            Call LINE_MOVE_DISPLAY01(vS1, vS1.ActiveSheet.ActiveColumnIndex, vS1.ActiveSheet.ActiveRowIndex, cdLineProd)
    ...
    Private Sub MAIN_JOB31()
        ...
        BatchGroup = getData(vS31, getColumIndex(vS31, "BatchGroup"), vS31.ActiveSheet.ActiveRowIndex)

        'If READ_PFK4075_BatchGroup(BatchGroup) = False Then Exit Sub
        ...
        cdMainProcess = txt_cdMainProcess.Code
        Szno = getData(vS31, getColumIndex(vS31, "Szno"), vS31.ActiveSheet.ActiveRowIndex)
        SizeName = getData(vS31, getColumIndex(vS31, "SizeName"), vS31.ActiveSheet.ActiveRowIndex)

        Msg_Result = MsgBoxP("do you want to generate barcode for size " & SizeName, vbYesNo)
        If Msg_Result <> vbYes Then Exit Sub

        If READ_PFK4074(cdFactory, cdMainProcess, cdLineProd, LineTno, Szno) Then
            Call PrcExeNoError("USP_PFK4075_AUTO_BATCHNO_STITCHING_SZNO_STOCKFIT_ADDITIONAL", cn, D4074.cdFactory, D4074.cdLineProd, D4074.LineTno, D4074.JobCard, D4074.Szno, Pub.SAW, BatchGroup, txt_BatchSizeQ.Value)
    ...
    Private Sub PFP40733_Resize(sender As Object, e As EventArgs) Handles Me.Resize
...
#End Region
        ...
        If e.KeyCode = Keys.P Then
            ...
            Try
                ...
                If Msg_Result = vbYes Then
                    ...
                    If chk_Foodbed.Checked = True Then
                        'chk_Stockfit.Checked = Not chk_Stockfit.Checked
    ...
    Public Sub DATA_MOVE_BARCODE_01(BatchNo1 As String, BatchNo2 As String)
        If READ_PFK4075_BatchNo(BatchNo1) Then
            ...
            STITCHINGPANEL1.cdMainProcess = D4075.cdMainProcess
        ...
        If READ_PFK4075_BatchNo(BatchNo2) Then
            ...
            STITCHINGPANEL2.cdMainProcess = D4075.cdMainProcess
    ...
    Public Sub DATA_MOVE_BARCODE_02(BatchNo3 As String, BatchNo4 As String)
        If READ_PFK4075_BatchNo(BatchNo3) Then
            ...
            STITCHINGPANEL3.cdMainProcess = D4075.cdMainProcess
        ...
        If READ_PFK4075_BatchNo(BatchNo4) Then
            ...
            STITCHINGPANEL4.cdMainProcess = D4075.cdMainProcess
    ...
    Public Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        ElseIf chk_Foodbed.Checked = True Then
            Call TAG_PRINT_FOOTBED_PANEL_NEW_PROD()
