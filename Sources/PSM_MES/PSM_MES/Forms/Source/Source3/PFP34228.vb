...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1,
                   "MRO CONTROL PROCCESING - " & WordConv("INPUT") & "(F5)",
                   "MRO CONTROL PROCCESING - " & WordConv("SEARCH") & "(F6)",
                   "MRO CONTROL PROCCESING - " & WordConv("UPDATE") & "(F7)",
                   "MRO CONTROL PROCCESING - " & WordConv("DELETE") & "(F8)",
                   "-",
                   "MRO CONTRO PROCCESING - " & WordConv("APPROVAL STATUS") & "(F10)")
...
next1:
        ...
        If ISUD3421Z.Link_ISUD3421Z_INSERT_MULTI(11, SpecNoList, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        If ISUD3421Z.Link_ISUD3421Z(2, FactOrderNo, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        If ISUD3421Z.Link_ISUD3421Z(3, FactOrderNo, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB04()
        ...
        If ISUD3421Z.Link_ISUD3421Z(4, FactOrderNo, Me.Name) = False Then Exit Sub
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP34228_SEARCH_VS10", cn, SdateEdate.text1, SdateEdate.text2, txt_cdSite.Code, txt_CustPONO.Data, txt_Article.Data)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP34228_SEARCH_VS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(Optional OrderNo As String = "", Optional OrderNoSeq As String = "") As Boolean
        ...
        DS1 = PrcDS("USP_PFP34228_SEARCH_vS20", cn, OrderNo, OrderNoSeq, txt_cdLargeGroupMaterial.Code)


        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP34228_SEARCH_vS20", "vS20")
            vS20.Enabled = True
            Exit Function
        End If
