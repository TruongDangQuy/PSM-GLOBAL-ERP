...
#Region "Form_load"
    Public Function Link_HLP0170A(JobCard As String, cdMainProcess As String, Optional ByVal TAG As String = "") As Boolean
        Link_HLP0170A = False
        Me.Tag = TAG
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        DS1 = PrcDS("USP_HLP0170A_SEARCH_VS1", cn, txt_JobCard.Data, txt_cdMainProcess.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS1, DS1, "USP_HLP0170A_SEARCH_VS1", "VS2")
            vS1.Enabled = True
            Exit Function
        End If
