...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1,
                       WordConv("GROUP COMPONENT BOM PROCESSING") & "(F5)",
                       WordConv("PROCESS BOM PROCESSING") & "(F6)",
                       WordConv("FULL JOB BOM PROCESSING") & "(F7)",
                       WordConv("CBD PROCESS PROCESSING") & "(F8)",
                       "-",
                       WordConv("CBD UPLOAD PROCESSING") & "(F9)",
                       "-",
                       WordConv("CONVERT TO SALES ORDER") & "(F10)",
                       "-",
                       WordConv("COPY ITEM CODE") & "(F11)",
                       WordConv("ITEM CODE TECHICIAN CONTROL") & "(F12)")
...
#Region "Function"
    Private Sub tst_1_Click(sender As Object, e As EventArgs) Handles tst_1.Click, tst_2.Click, tst_3.Click, tst_4.Click, tst_5.Click, tst_6.Click
        ...
        If sender.Equals(tst_6) Then
            MAIN_JOB_MERGE()
        End If
    End Sub
    Private Sub MAIN_JOB01()
        If ISUD7106A.Link_ISUD7106A(1, "000000", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        If ISUD7106A.Link_ISUD7106A(2, getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
    End Sub
    Private Sub MAIN_JOB03()
        If getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex) = "" Then Exit Sub

        D7106.ShoesCode = getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex)
        Call READ_PFK7106(D7106.ShoesCode)

        If CheckData_Customer(D7106.Customercode, ISUD.Update) = False Then MsgBoxP("No correct customer !") : Exit Sub
        If ISUD7106A.Link_ISUD7106A(3, getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
        If LINE_MOVE_DISPLAY01() = False Then
            ...
            setData(vS2, getColumIndex(vS2, "CustomerName"), vS2.ActiveSheet.ActiveRowIndex, "[DELETED]", Color.Red)
        End If
    End Sub
    Private Sub MAIN_JOB04()
        ...
        If CheckData_Customer(D7106.Customercode, ISUD.Delete) = False Then MsgBoxP("No correct customer !") : Exit Sub

        If ISUD7106A.Link_ISUD7106A(4, getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
        If LINE_MOVE_DISPLAY01() = False Then
            SPR_CLEAR(vS2, vS2.ActiveSheet.ActiveRowIndex, 0, vS2.ActiveSheet.ActiveRowIndex, vS2.ActiveSheet.ColumnCount)
            setData(vS2, getColumIndex(vS2, "CustomerName"), vS2.ActiveSheet.ActiveRowIndex, "[DELETED]", Color.Red)
        End If
    ...
    Private Sub MAIN_JOB_COPY()
        ...
        D7106.ShoesCode = getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex)
        Call READ_PFK7106(D7106.ShoesCode)
        If CheckData_Customer(D7106.Customercode, ISUD.Insert) = False Then MsgBoxP("No correct customer !") : Exit Sub

        If ISUD7106A.Link_ISUD7106A(5, getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
        If LINE_MOVE_DISPLAY01() = False Then
            SPR_CLEAR(vS2, vS2.ActiveSheet.ActiveRowIndex, 0, vS2.ActiveSheet.ActiveRowIndex, vS2.ActiveSheet.ColumnCount)
            setData(vS2, getColumIndex(vS2, "CustomerName"), vS2.ActiveSheet.ActiveRowIndex, "[DELETED]", Color.Red)
        End If
    ...
    Private Sub MAIN_JOB_MERGE()
        If getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex) = "" Then Exit Sub

        D7106.ShoesCode = getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex)

        If ISUD7106M.Link_ISUD7106M(3, getData(vS2, 0, vS2.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB05()
        ...
        If READ_PFK7108_SHOESCODE(ShoesCode) = False Then
            ...
            If ISUD7108A.Link_ISUD7108A(1, ShoesCode, Me.Name) = False Then Exit Sub
        Else
            If ISUD7108A.Link_ISUD7108A(3, D7108.GroupComponentBOM, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB06()
        ...
        If READ_PFK7305_SHOESCODE(ShoesCode) = False Then
            If ISUD7305A.Link_ISUD7305A(1, ShoesCode, Me.Name) = False Then Exit Sub

        Else

            If ISUD7305A.Link_ISUD7305A(3, D7305.ProcessBOMCode, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB07()
        ...
        If READ_PFK7311_SHOESCODE(ShoesCode) = True Then
            If ISUD7311A.Link_ISUD7311A(3, D7311.JobBOMCode, Me.Name) = False Then Exit Sub

        ElseIf READ_PFK7305_SHOESCODE(ShoesCode) = True Then
            If ISUD7311A.Link_ISUD7311A(1, D7305.ProcessBOMCode, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB08()
        ...
        If READ_PFK7108_SHOESCODE(ShoesCode) = False Then
            ...
            If ISUD7108C.Link_ISUD7108C(1, ShoesCode, Me.Name) = False Then Exit Sub
        Else
            If ISUD7108C.Link_ISUD7108C(3, D7108.GroupComponentBOM, Me.Name) = False Then Exit Sub

        End If

        'If ISUD7108C.Link_ISUD7108C(3, ShoesCode, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB09()
        ...
        If READ_PFK7106(ShoesCode) Then
            If ISUD7106K.Link_ISUD7106K(3, ShoesCode, Me.Name) = False Then Exit Sub
        End If
    End Sub
    ...
    Private Sub MAIN_JOB10()
        ...
        If READ_PFK7106(ShoesCode) Then
            If ISUD7231M.Link_ISUD7231M(3, ShoesCode, Me.Name) = False Then Exit Sub
        End If
    End Sub
    ...
    Private Sub MAIN_JOB11()
        ...
        For i = 0 To vS2.ActiveSheet.RowCount - 1
            If getDataM(vS2, getColumIndex(vS2, "dchk"), i) <> "1" Then GoTo next1
            ShoesCode = getData(vS2, getColumIndex(vS2, "KEY_ShoesCode"), i)
            If READ_PFK7106(ShoesCode) Then
                If D7106.SizeRange = "" Then MsgBoxP("Input sizerange of Line: " & D7106.Line + "- Aricle: " & D7106.Article & "- Color: " & D7106.ColorName & " at row " & (i + 1).ToString) : Exit Sub
                If cdSpecState_Old = "" Then cdSpecState_Old = D7106.cdSpecState

                cdSpecState_New = D7106.cdSpecState

                If cdSpecState_Old <> cdSpecState_New Then MsgBoxP("No same Dev Stage!") : Exit Sub

                SpecNoList = SpecNoList & "''" & getData(vS2, getColumIndex(vS2, "KEY_ShoesCode"), i) & "''"
...
next1:
        ...
        If READ_PFK7106(ShoesCode) Then
            If READ_PFK7171(D7106.seSpecState, D7106.cdSpecState) Then
                If D7171.Check1 = "1" Then
                    Call ISUD1311A_F1.Link_ISUD1311A_AUTO(1, SpecNoList, "PFP13120")
                ElseIf D7171.Check1 = "2" Then
                    Call ISUD1311A_F1.Link_ISUD1311A_AUTO(1, SpecNoList, "PFP13121")
                End If
            End If
        End If
    ...
    Private Sub MAIN_JOB12()
        ...
        If ISUD7106C.Link_ISUD7106C("1", cdSpecState) = True Then
            If cdSpecState = "" Then Exit Sub

            For i = 0 To vS2.ActiveSheet.RowCount - 1
                If getDataM(vS2, getColumIndex(vS2, "dchk"), i) <> "1" Then GoTo next0
                ShoesCode = getData(vS2, getColumIndex(vS2, "KEY_ShoesCode"), i)
                If READ_PFK7106(ShoesCode) Then

                    If cdSpecState = D7106.cdSpecState Then MsgBoxP("Invalid ITEM CODE!") : Exit Sub
...
next0:
            ...
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                ...
                If READ_PFK7106(ShoesCode) Then
                    ...
                    Call KEY_COUNT()
                    If chk_CopyImange.Checked = False Then Call PrcExeNoError("USP_PFK7106_COPY_SHOESCODE", cn, ShoesCode, cdSpecState, W7106.ShoesCode)
                    If chk_CopyImange.Checked = True Then Call PrcExeNoError("USP_PFK7106_COPY_SHOESCODE_IMAGE", cn, ShoesCode, cdSpecState, W7106.ShoesCode)
                End If
next1:
            Next
        End If
    ...
    Private Sub MAIN_JOB14()
        Dim ShoesCode As String
        ShoesCode = getData(vS2, getColumIndex(vS2, "ShoesCode"), vS2.ActiveSheet.ActiveRowIndex)
    ...
    Private Sub MAIN_JOB15()
        Dim i As Integer
        Dim ShoesCode As String
        Dim ShoesCodeBase As String
        Try
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                If getDataM(vS2, getColumIndex(vS2, "dchk"), i) <> "1" Then GoTo next1
                ShoesCode = getData(vS2, getColumIndex(vS2, "KEY_ShoesCode"), i)
                ShoesCodeBase = getData(vS2, getColumIndex(vS2, "KEY_ShoesCodeBase"), i)
                If READ_PFK7106(ShoesCode) Then

                    If D7106.ShoesCodeBase = "" Then MsgBoxP("Invalid ITEM CODE Base!") : Exit Sub

                    Call PrcExeNoError("USP_PFK7106_COPY_SHOESCODE_RESYNC", cn, ShoesCode, D7106.ShoesCodeBase)

                End If
next1:
            Next
            MsgBoxP("Re-sync Successfully!")
        Catch ex As Exception
            Call MsgBoxP("1", "Err for Re-sync")
        End Try
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Vs1.Enabled = False
        vs_Image.ActiveSheet.RowCount = 0

        DS1 = PrcDS("USP_PFP71065_SEARCH_VS1", cn, ListCode("SpecState"))

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP71065_SEARCH_VS1", "Vs1")
            SplitContainer1.SplitterDistance = SPR_SHEETWIDHT(Vs1) + cSprWidthSize
            Vs1.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS2(cdSpecState As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71065_SEARCH_VS2", cn, txt_CustomerCode.Code, txt_cdSpecState.Code, txt_cdSeason.Code, txt_Line.Data, "*" & txt_Article.Data, txt_ColorName.Data, txt_LastCode.Code, txt_MoldCode.Code, chk_CheckUse1.CheckState, chk_CheckUse2.CheckState)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_PFP71065_SEARCH_VS2", "VS2")
            vS2.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_vs_Image(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71065_SEARCH_vs_Image", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vs_Image, DS1, "USP_PFP71065_SEARCH_vs_Image", "vs_Image")
    ...
    Private Function DATA_SEARCH_vs_Doc(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71065_SEARCH_vs_Doc", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS_Doc, DS1, "USP_PFP71065_SEARCH_vs_Doc", "vs_Doc")
            vS_Doc.Enabled = True
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP71065_SEARCH_Vs2_LINE", cn, ShoesCode)

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(vS2, DS1, "USP_PFP71065_SEARCH_Vs2", "Vs2", xrow)
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71065_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP71065_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71065_SEARCH_vS_Cus", cn, CustomerCode, cdSeason)
            SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP71065_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71065_SEARCH_vS_Line", cn, cdSeason, CustomerCode)
            SPR_PRO_NEW(vS_Line, DS1, "USP_PFP71065_SEARCH_vS_Line", "vS_Line")
...
#Region "Event"
    ...
    Private Sub Vs2_GotFocus(sender As Object, e As EventArgs) Handles vS2.GotFocus
        ...
        Call TOOLBAR_CHECKSHOW(ToolStrip1, True, True, True, True, True, True, WordConv("INPUT") & "(F5)", WordConv("SEARCH") & "(F6)", WordConv("UPDATE") & "(F7)", WordConv("DELETE") & "(F8)", WordConv("COPY") & "(F9)", WordConv("MERGE") & "(F10)")
        ...
        Try
            ...
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                If getDataM(vS2, getColumIndex(vS2, "DCHK"), i) = "1" Then
                    ...
                    If GetDsRc(DS1) > 0 Then
                        READ_SPREAD(vS2, DS1, "USP_PFP71065_SEARCH_VS2", "vS2", i)
                    End If
    ...
    Private Sub Cms_1_Click(sender As Object, e As EventArgs) Handles Cms_1.ItemClicked
        Select Case True
            ...
            Case Cms_1.Items(7).Selected
                Cms_1.Hide()
                Call MAIN_JOB11()

            Case Cms_1.Items(9).Selected
                Cms_1.Hide()
                Call MAIN_JOB12()

            Case Cms_1.Items(10).Selected
                Cms_1.Hide()
                Call MAIN_JOB14()
...
#End Region
    ...
    Private Sub vS_Doc_CellClick(sender As Object, e As CellClickEventArgs) Handles vS_Doc.CellDoubleClick, vs_Image.CellDoubleClick
