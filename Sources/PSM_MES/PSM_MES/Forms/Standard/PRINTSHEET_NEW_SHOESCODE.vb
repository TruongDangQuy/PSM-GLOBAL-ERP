...
Public Class PRINTSHEET_NEW_SHOESCODE
    ...
    Public Function Link_SheetReport(job As Integer, PROG As String, _ShoesCode As String) As Boolean
        Dim SQL As String
    ...
    Private Sub PRINTSHEET_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            For SoSheet = 0 To DSReprt.Tables(0).Rows.Count - 1
                ...
                str = "http://"
                str += Pub.SER
                str += "/CS_WHM/Report/" & GetDsData(DSReprt, SoSheet, 0) & ".xlsx" 'Relace SHV to CS_WHM
                '-------------------------------------------------------------------------------------------------------------'
