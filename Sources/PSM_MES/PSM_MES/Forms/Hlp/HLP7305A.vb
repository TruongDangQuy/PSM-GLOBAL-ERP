...
#Region "Formload"
    ...
    Public Function Link_HLP7305A(Optional ByVal TAG As String = "") As Boolean
        Link_HLP7305A = False
        Me.Tag = TAG
    ...
    Public Function Link_HLP7305A_SHOESCODE(ByVal SHOESCODE As String, Optional ByVal TAG As String = "") As Boolean
        Link_HLP7305A_SHOESCODE = False
        txt_ProcessBOMName.Code = SHOESCODE

        If READ_PFK7106(SHOESCODE) Then
            txt_ProcessBOMName.Data = D7106.Article & "-" & D7106.Line & "-" & D7106.ColorName
        End If
        ...
        Try
            ...
            Me.ShowDialog()
            Link_HLP7305A_SHOESCODE = isudCHK
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        DATA_SEARCH01 = False
        If txt_ProcessBOMName.Data = "" Then txt_ProcessBOMName.Code = ""
        Vs1.Enabled = False

        If txt_ProcessBOMName.Code <> "" Then

            DS1 = PrcDS("USP_HLP7305A_SEARCH_VS1_F1", cn, txt_ProcessBOMName.Code)
            ...
            SPR_PRO(Vs1, DS1, "USP_HLP7305A_SEARCH_VS1_F1", "Vs1")

            Vs1.Enabled = True
            DATA_SEARCH01 = True
        Else
            DS1 = PrcDS("USP_HLP7305A_SEARCH_VS1", cn, txt_ProcessBOMName.Data)
            If GetDsRc(DS1) = 0 Then
                Vs1.Enabled = True
                Vs1.ActiveSheet.RowCount = 0
                Exit Function
            End If
            SPR_SET(Vs1, , , , OperationMode.SingleSelect)
            SPR_PRO(Vs1, DS1, "USP_HLP7305A_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7305A_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO(Vs2, DSNEW, "USP_HLP7305A_SEARCH_VS2", "Vs2")
