...
#Region "load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_2,
                     "LINE PLANNING CONTROL - INSERT " & "(F5)",
                     "LINE PLANNING CONTROL - SEARCH " & "(F6)",
                     "LINE PLANNING CONTROL - UPDATE " & "(F7)",
                     "LINE PLANNING CONTROL - DELETE " & "(F8)",
                      "-",
                      "PRODUCTION INPUT - " & "(F9)",
                      "PLAN PRODUCTION UPDATE - " & "(F10)",
                      "PROGRESS PRODUCTION UPDATE - " & "(F11)",
                      "COMPLETE PRODUCTION UPDATE - " & "(F12)")
    ...
    Private Sub Function_Event(PressKey As Integer)
        Try
            Select Case PressKey
                ...
                Case Keys.F11 : Call MAIN_JOB07()
                Case Keys.F12 : Call MAIN_JOB08()
...
#Region "Link"
    ...
    Private Sub MAIN_JOB01()
        ...
        If ISUD4073F.Link_ISUD4073F(1, cdFactory, cdMainProcess, cdLineProd, LineTno, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        If ISUD4073F.Link_ISUD4073F(2, cdFactory, cdMainProcess, cdLineProd, LineTno, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        If ISUD4073F.Link_ISUD4073F(3, cdFactory, cdMainProcess, cdLineProd, LineTno, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB04()
        ...
        If ISUD4073F.Link_ISUD4073F(4, cdFactory, cdMainProcess, cdLineProd, LineTno, Me.Name) = False Then Exit Sub
        Call LINE_MOVE_DISPLAY01(vS1, vS1.ActiveSheet.ActiveColumnIndex, vS1.ActiveSheet.ActiveRowIndex, cdLineProd)
    End Sub
    ...
    Private Sub MAIN_JOB06()
        ...
        If READ_PFK4073(cdFactory, cdMainProcess, cdLineProd, LineTno) Then
            D4073.CheckComplete = "1"
            If REWRITE_PFK4073(D4073) Then
                setData(vS1, getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex, "Plan")
                SPR_BACKCOLORCELL(vS1, FUNCTION_DYEING_PLAN_BACK(D4073.CheckComplete), getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex)
                SPR_FORECOLORCELL(vS1, FUNCTION_DYEING_PLAN_FORE(D4073.CheckComplete), getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex)
    ...
    Private Sub MAIN_JOB07()
        ...
        If READ_PFK4073(cdFactory, cdMainProcess, cdLineProd, LineTno) Then
            D4073.CheckComplete = "6"
            If REWRITE_PFK4073(D4073) Then
                setData(vS1, getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex, "Progress")
                SPR_BACKCOLORCELL(vS1, FUNCTION_DYEING_PLAN_BACK(D4073.CheckComplete), getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex)
                SPR_FORECOLORCELL(vS1, FUNCTION_DYEING_PLAN_FORE(D4073.CheckComplete), getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex)
            End If
        End If
    ...
    Private Sub MAIN_JOB08()
        ...
        If READ_PFK4073(cdFactory, cdMainProcess, cdLineProd, LineTno) Then
            D4073.CheckComplete = "2"
            If REWRITE_PFK4073(D4073) Then
                setData(vS1, getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex, "Complete")
                SPR_BACKCOLORCELL(vS1, FUNCTION_DYEING_PLAN_BACK(D4073.CheckComplete), getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex)
                SPR_FORECOLORCELL(vS1, FUNCTION_DYEING_PLAN_FORE(D4073.CheckComplete), getColumIndex(vS1, "CheckComplete_Sel"), vS1.ActiveSheet.ActiveRowIndex)
            End If
        End If
...
#Region "search"
    ...
    Public Function DATA_SEARCH01(ProcessType As String) As Boolean
        ...
        Try
            ...
            If chk_FullScreen.Checked Then
                DS2 = PrcDS("USP_PFP40703_SEARCH_VS1_F1_FULL", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, txt_cdSeason.Code)
                SPR_PRO(vS1, DS2, "USP_PFP40703_SEARCH_VS1_F1_FULL", "vS1")
