...
#Region "Variable"
    ...
    Private Form_Close As Boolean = False
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH_01() As Boolean
        ...
        lbl_Factory.Text = PrcExeNoError_Value("USP_SPFP89000_SEARCH_VS1", cn, txt_DateReport.Data)



        DS1 = PrcDS("USP_SPFP89000_SEARCH_VS1", cn, txt_DateReport.Data)

        Try

            SPR_PRO_NEW(Vs1, DS1, "USP_SPFP89000_SEARCH_VS1", "Vs1")
            ...
            If chk_Timer.Checked = False Then
                tim_01.Enabled = True
                tim_01.Interval = 60000
                tim_01.Start()

                tim_02.Enabled = True
                tim_02.Interval = 2000
                tim_02.Start()
            ElseIf chk_Timer.Checked = True Then
...
#End Region
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles tim_02.Tick
        Try
            Dim i, j As Integer

            If Vs1.ActiveSheet.RowCount > 0 Then

                DS2 = PrcDS("USP_SPFP89000_SEARCH_BACKCOLOR", cn, txt_DateReport.Data)
                ...
                If GetDsRc(DS2) > 0 Then
                    ...
                    DS2 = PrcDS("USP_SPFP89000_SEARCH_BACKCOLOR_ROWHEADER", cn, txt_DateReport.Data)
    ...
    Private Sub txt_DateReport_m_Textchange(sender As Object, e As EventArgs) Handles txt_DateReport.m_Textchange
        Try
            If Form_Close = False Then Exit Sub

            If IsDate(FSDate(txt_DateReport.Data)) = False Then Exit Sub
        ...
        End Try
    End Sub
    Private Sub chk_Timer_CheckedChanged(sender As Object, e As EventArgs) Handles chk_Timer.CheckedChanged
        Try
            If Form_Close = False Then Exit Sub

            If chk_Timer.Checked = False Then
                chk_Timer.Text = "STOP"
                chk_Timer.BackColor = Color.LightCoral
                tim_01.Start()
                tim_02.Start()
            ElseIf chk_Timer.Checked = True Then
                chk_Timer.Text = "START"
                chk_Timer.BackColor = Color.LightGreen
