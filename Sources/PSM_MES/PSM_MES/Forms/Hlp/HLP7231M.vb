...
#Region "Methods"
    Public Function DATA_SEARCH01(Head_No As Long) As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_HLP7231M_SEARCH_VS1", cn, txt_cdLargeGroupMaterial.Code, txt_Name.Data, txt_cdSemiGroupMaterial.Data, _
            ...
            If GetDsRc(DS1) = 0 Then
                ...
                SPR_PRO(Vs1, DS1, "USP_HLP7231M_SEARCH_VS1", "Vs1")
