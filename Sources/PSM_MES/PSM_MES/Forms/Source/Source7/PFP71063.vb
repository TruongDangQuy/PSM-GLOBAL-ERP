...
#Region "Data_search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_PFP71063_SEARCH_VS1", cn, txt_CustomerCode.Code, "*" & txt_Article.Data)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_PFP71063_SEARCH_VS1", "Vs1")
        DATA_SEARCH01 = True
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP71063_SEARCH_VS1_LINE", cn, Autokey)

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(Vs1, DS1, "USP_PFP71063_SEARCH_VS1", "Vs1", xrow)
        ...
        Try
            ...
            For intRow = 0 To Vs1.ActiveSheet.RowCount - 1
                If getDataM(Vs1, getColumIndex(Vs1, "DCHK"), intRow) = "1" Then
                    KEY_ShoesCode = getData(Vs1, getColumIndex(Vs1, "KEY_ShoesCode"), intRow)

                    If READ_PFK7106(KEY_ShoesCode) Then
                        D7106.QtyAverage = CDecp(getData(Vs1, getColumIndex(Vs1, "QtyAverage"), intRow))
