...
Public Class ISUD4060B
    ...
    Public Function Link_ISUD4060B(job As Integer, sDate As String, eDate As String, JobCard As String, cdMainProcess As String, Optional CheckName As String = "") As Boolean
        Batch_1 = Nothing
...
next1:
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        If txt_cdFactory.Code = "" Then MsgBoxP("Department,pls!") : Exit Sub
        If txt_cdLineProd1.Code = "" Then MsgBoxP("Line Prod,pls!") : Exit Sub
                        ...
                        If W4060.QtyPlan > 0 Then
                            ...
                            If WRITE_PFK4060(W4060) = True Then
                                If READ_PFK4010(txt_SealNo.Code) And ChkWrite = False Then
                                    ...
                                    D4010.CheckPlan = "1"
                                    D4010.QtyPlan = D4010.QtyOrder

                                    D4010.cdFactory = txt_cdFactory.Code
                                    D4010.cdLineProd1 = txt_cdLineProd1.Code
                                    D4010.cdLineProd2 = txt_cdLineProd2.Code
                                    D4010.cdLineProd3 = txt_cdLineProd3.Code

                                    D4010.seFactory = ListCode("Factory")
                                    D4010.seLineProd1 = ListCode("LineProd")
                                    D4010.seLineProd2 = ListCode("LineProd")
                                    D4010.seLineProd3 = ListCode("LineProd")
    ...
    Private Sub txt_cdLineProd1_btnTitleClick(sender As Object, e As EventArgs) Handles txt_cdLineProd1.btnTitleClick
