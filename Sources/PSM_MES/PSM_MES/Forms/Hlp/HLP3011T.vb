...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_HLP3011T_SEARCH_vS10", cn, txt_cdSite.Code, "*" & txt_MaterialName.Data, txt_ColorName.Data)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS10, DS1, "USP_HLP3011T_SEARCH_vS10", "vS10")
...
#End Region
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        ...
        Try
            ...
            Dim KEY_PurchasingOrderNo As String
            Dim KEY_PurchasingOrderSeq As String
            ...
            For i = 0 To vS10.ActiveSheet.RowCount - 1
                ...
                If getDataM(vS10, getColumIndex(vS10, "DCHK"), i) = "1" Then
                    ...
                    KEY_PurchasingOrderNo = getData(vS10, getColumIndex(vS10, "KEY_PurchasingOrderNo"), i)
                    KEY_PurchasingOrderSeq = getData(vS10, getColumIndex(vS10, "KEY_PurchasingOrderSeq"), i)


                    Call PrcExeNoError("USP_PFK3017_UPDATE_PFK3011", cn, txt_Autokey.Data, KEY_PurchasingOrderNo, KEY_PurchasingOrderSeq, CDecp(getData(vS10, getColumIndex(vS10, "QtyBooking"), i)), Pub.SAW, Pub.DAT)
