...
#Region "Link"
    Public Function Link_ISUD7360P(job As Integer, ContractID As String,
                                                    Status1 As String,
                                                    Status2 As String,
                                                    Status3 As String,
                                                    Status4 As String,
            ...
            Select Case job
                ...
                Case Else
                    If READ_PFK7360(L7360.ContractID) = False Then
                        ...
                        Exit Function
                    Else
                        L7360.CheckSupplierPrice = D7360.CheckSupplierPrice

                        If L7360.CheckSupplierPrice = "3" Or L7360.CheckSupplierPrice = "2" Or L7360.CheckSupplierPrice = "4" Then
                            L_Status1 = "2"
                            L_Status2 = "1"
                            L_Status3 = "1"
                            L_Status4 = "1"
                        ...
                        If L7360.CheckSupplierPrice = "1" Then
                            L_Status1 = "1"
                            L_Status2 = "2"
                            L_Status3 = "1"
                            L_Status4 = "2"
                        ...
                        If L7360.CheckSupplierPrice = "5" Or L7360.CheckSupplierPrice = "6" Then
                            L_Status1 = "1"
                            L_Status2 = "2"
                            L_Status3 = "1"
                            L_Status4 = "2"
...
#Region "Form"
    Private Sub Form_Activate(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Block_Check()
        Call K7360_CheckSupplierPrice(L7360.CheckSupplierPrice)
...
#Region "Search"
    ...
    Private Sub K7360_CheckSupplierPrice(Process As String)
        Select Case Process
        ...
        End Select
    End Sub
    Private Sub K7360_CheckSupplierPrice()
        If rad_CheckSupplierPrice1.Checked = True Then W7360.CheckSupplierPrice = "1"
        If rad_CheckSupplierPrice2.Checked = True Then W7360.CheckSupplierPrice = "2" : W7360.DateComplete = Pub.DAT
        If rad_CheckSupplierPrice3.Checked = True Then W7360.CheckSupplierPrice = "3" : W7360.DateApproved = Pub.DAT
        If rad_CheckSupplierPrice4.Checked = True Then W7360.CheckSupplierPrice = "4" : W7360.DateCancel = Pub.DAT
        If rad_CheckSupplierPrice5.Checked = True Then W7360.CheckSupplierPrice = "5" : W7360.DatePending1 = Pub.DAT
        If rad_CheckSupplierPrice6.Checked = True Then W7360.CheckSupplierPrice = "6" : W7360.DatePending2 = Pub.DAT
    End Sub
