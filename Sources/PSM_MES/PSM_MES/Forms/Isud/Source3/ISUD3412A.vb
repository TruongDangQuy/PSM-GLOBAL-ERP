...
#Region "Link"
    Public Function Link_ISUD3412A(job As Integer, PurchasingOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD3412A = False
    ...
    Public Function Link_ISUD3412A_AUTO(job As Integer, cdSeason As String, CustomerCode As String, SupplierCode As String, _Line As String, _cdLargeGroupMaterial As String, _cdSemiGroupMaterial As String, _checkSample As String, PurchasingOrderNo As String, Optional ByVal TAG As String = "") As Boolean
        Link_ISUD3412A_AUTO = False
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3412A_SEARCH_HEAD", cn, L3411.PurchasingOrderNo)
    ...
    Private Function DATA_SEARCH_VS0() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3412A_SEARCH_VS0", cn, L3411.PurchasingOrderNo)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS0, DS1, "USP_ISUD3412A_SEARCH_VS0", "VS0")
            vS0.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3412A_SEARCH_VS2", cn, L3411.PurchasingOrderNo)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_ISUD3412A_SEARCH_VS2", "VS2")
            vS2.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3412A_SEARCH_VS1_F1", cn, L3411.PurchasingOrderNo)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3412A_SEARCH_VS1_F1", "Vs1")
...
#Region "Function"
    ...
    Private Sub DATA_MOVE_WRITE01()
        ...
        For i = 0 To Vs1.ActiveSheet.RowCount - 1
            ...
            Else
                W7231.MaterialCode = MaterialCode
            End If
            ...
            If K3412_MOVE(Vs1, i, W3412, L3412.PurchasingOrderNo, getData(Vs1, getColumIndex(Vs1, "KEY_PurchasingOrderSeq"), i)) = True Then
                ...
                W3412.cdDepartment = "001"

                W3412.MaterialCode = W7231.MaterialCode
...
skip1:
    ...
    Private Sub KEY_COUNT()
        ...
        'Try
        '    SQL = "SELECT MAX(CAST(SUBSTRING(K3411_PurchasingOrderNo,7,3) AS DECIMAL)) AS MAX_MCODE FROM PFK3411 "
        '    SQL = SQL & " WHERE SUBSTRING(K3411_PurchasingOrderNo,3,4) = '" & YRNO.ToString & "' "
        ...
        '        W3411.PurchasingOrderNo = "PD" & YRNO & "001"
        '    Else
        '        W3411.PurchasingOrderNo = "PD" & YRNO & Format(CInt(rd!MAX_MCODE + 1), "000")
        '    End If
        ...
        Try
            ...
            SQL = SQL & " AND SUBSTRING(K3411_PurchasingOrderNo,1,2) = '" & "PD" & "' AND ISNUMERIC(SUBSTRING(K3411_PurchasingOrderNo,5,5)) > 0"
            ...
            If IsDBNull(rd!MAX_MCODE) Then
                W3411.PurchasingOrderNo = "PD" & YRNO & "00001"
            Else
                W3411.PurchasingOrderNo = "PD" & YRNO & Format(CInt(rd!MAX_MCODE + 1), "00000")
            End If
    ...
    Private Sub FORM_INIT()
        ...
        If Me.Tag = "PFP34112" Or Me.Tag = "PFP34111" Then
    ...
    Private Function Data_Check() As Boolean
        ...
        Try
            For i = 0 To Vs1.ActiveSheet.RowCount - 1
                If getData(Vs1, getColumIndex(Vs1, "MaterialName"), i).ToString.Trim = "" Then MsgBoxP("MaterialName at Row " & (i + 1)) : Exit Function
...
#Region "Event"
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        Select Case wJOB
            Case 1
                If CheckData_Department(txt_cdDepartment.Code, wJOB) = False Then
                    isudCHK = False
                    formA = True
                    MsgBoxP("No Correct Department !")
                    Exit Sub
