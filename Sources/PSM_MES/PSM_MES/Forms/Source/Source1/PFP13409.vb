...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_Vs10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Vs10.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP13409_SEARCH_Vs10", cn, txt_cdSite.Code, txt_Year.Value)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS10, DS1, "USP_PFP13409_SEARCH_Vs10", "Vs10")
    ...
    Private Function DATA_SEARCH_Vs20(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13409_SEARCH_Vs20", cn, txt_cdSite.Code, txt_Year.Value)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs20, DS1, "USP_PFP13409_SEARCH_Vs20", "Vs20")
    ...
    Private Function DATA_SEARCH_Vs21(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13409_SEARCH_Vs21", cn, cdSite, DateOutbound, InvoiceNo, TradingCode)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs21, DS1, "USP_PFP13409_SEARCH_Vs21", "Vs21")
    ...
    Private Function DATA_SEARCH_Vs22(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13409_SEARCH_Vs22", cn, LiquidNo, LiquidSeq)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs22, DS1, "USP_PFP13409_SEARCH_Vs22", "Vs22")
    ...
    Private Function DATA_SEARCH_Vs30(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP13409_SEARCH_Vs30", cn, txt_cdSite.Code, txt_Year.Value)


            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs30, DS1, "USP_PFP13409_SEARCH_Vs30", "Vs30")
