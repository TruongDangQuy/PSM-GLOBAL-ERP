            ...
            If READ_PFK4073(L4073.cdFactory, L4073.cdMainProcess, L4073.cdLineProd, L4073.LineTno) Then
                ...
                For i = Scol To vS1.ActiveSheet.ColumnCount - 1
                    If READ_PFK4074(L4073.cdFactory, L4073.cdMainProcess, L4073.cdLineProd, L4073.LineTno, (i - FixCol + 1).ToString("00")) Then
                        ...
                        Call Delete_History("PFK4074", W4074.cdFactory & W4074.cdMainProcess & W4074.cdLineProd & W4074.LineTno & W4074.Szno)
                ...
                If DELETE_PFK4073(W4073) = True Then
                    ...
                    Call Delete_History("PFK4073", W4073.cdFactory & W4073.cdMainProcess & W4073.cdLineProd & W4073.LineTno)
...
#Region "Event"
    ...
    Private Sub cmd_Generate_Click(sender As Object, e As EventArgs) Handles cmd_Generate.Click
        ...
        If L4073.cdMainProcess = "004" Then
            For i = Scol To vS1.ActiveSheet.ColumnCount - 1
                If getDataM(vS1, i, 1) = "1" And CIntp(getDataM(vS1, i, 0)) >= 1 Then
                    Call PrcExeNoError("USP_PFK4075_AUTO_BATCHNO_STITCHING_SZNO_SIZECHECK_STOCKFIT", cn, L4073.cdFactory, "", "", L4073.cdLineProd, L4073.LineTno, L4073.JobCard, (i - FixCol + 1).ToString("00"), txt_InchargePlan.Code)
                End If
            Next
            Call DATA_SEARCH_VS0()
