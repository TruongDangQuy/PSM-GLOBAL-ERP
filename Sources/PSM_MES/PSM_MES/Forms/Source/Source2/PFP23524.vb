...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1, _
                        "MATERIAL INBOUND PROCESSING - " & WordConv("INPUT") & "(F5)",
                         "MATERIAL INBOUND PROCESSING - " & WordConv("INPUT BY SEMI GROUP") & "(F6)")
        ...
        Call Cms_additem(Cms_2, _
                        "MATERIAL INBOUND PROCESSING - " & WordConv("SEARCH") & "(F6)", _
                        "MATERIAL INBOUND PROCESSING - " & WordConv("UPDATE") & "(F7)", _
                        "MATERIAL INBOUND PROCESSING - " & WordConv("DELETE") & "(F8)")
...
#Region "Function"
    ...
    Private Sub MAIN_JOB05()
        Try
            ...
            'If ISUD2351B.Link_ISUD2351B(3, getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundNo"), vS20.ActiveSheet.ActiveRowIndex), getData(vS20, getColumIndex(vS20, "KEY_MaterialInBoundSeq"), vS20.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23524_SEARCH_VS10", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP23524_SEARCH_VS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23524_SEARCH_vS20", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdDepartment.Code,
                                                    txt_FactOrderNo.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23524_SEARCH_vS20", "vS20")
            vS20.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23524_SEARCH_VS30", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdDepartment.Code,
                                                    txt_FactOrderNo.Data,
                                                    txt_SupplierCode.Data, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS30, DS1, "USP_PFP23524_SEARCH_VS30", "VS30")
            vS30.Enabled = True
            Exit Function
        End If
