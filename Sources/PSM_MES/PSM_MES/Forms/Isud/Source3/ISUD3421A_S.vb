...
#Region "Search"
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421A_S_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421A_S_SEARCH_VS1_" & _chk_CheckIOType & _chk_CheckPurchasingOrder, "Vs1")
    ...
    Private Sub DATA_MOVE_WRITE01()
        ...
        For i = 0 To Vs1.ActiveSheet.RowCount - 1
            ...
            Else
                ...
                If W3422.QtyPurchasing > 0 And W3422.QtyRequestPO = 0 Then
                    W3422.QtyRequestPO = W3422.QtyPurchasing
                End If
...
KeyTab7:
    ...
    Private Sub cmd_BOM_Click(sender As Object, e As EventArgs) Handles cmd_BOM.Click
        ...
        If READ_PFK7231(D7231.MaterialCode) Then
            ...
            setData(Vs1, getColumIndex(Vs1, "MaterialCheck"), Vs1.ActiveSheet.RowCount - 1, "1")

            setData(Vs1, getColumIndex(Vs1, "Key_MaterialCode"), Vs1.ActiveSheet.RowCount - 1, D7231.MaterialCode)
            ...
            setData(Vs1, getColumIndex(Vs1, "MaterialSimple"), Vs1.ActiveSheet.RowCount - 1, D7231.MaterialSimple)

            setData(Vs1, getColumIndex(Vs1, "QtyBasic"), Vs1.ActiveSheet.RowCount - 1, D7231.QtyBasic)

            setData(Vs1, getColumIndex(Vs1, "seUnitMaterial"), Vs1.ActiveSheet.RowCount - 1, D7231.seUnitMaterial)
            setData(Vs1, getColumIndex(Vs1, "cdUnitMaterial"), Vs1.ActiveSheet.RowCount - 1, D7231.cdUnitMaterial)
            Call READ_PFK7171(D7231.seUnitMaterial, D7231.cdUnitMaterial)
            setData(Vs1, getColumIndex(Vs1, "cdUnitMaterialName"), Vs1.ActiveSheet.RowCount - 1, D7171.BasicName)

            setData(Vs1, getColumIndex(Vs1, "seUnitPacking"), Vs1.ActiveSheet.RowCount - 1, D7231.seUnitPacking)
            setData(Vs1, getColumIndex(Vs1, "cdUnitPacking"), Vs1.ActiveSheet.RowCount - 1, D7231.cdUnitPacking)
            Call READ_PFK7171(D7231.seUnitPacking, D7231.cdUnitPacking)
            setData(Vs1, getColumIndex(Vs1, "cdUnitPackingName"), Vs1.ActiveSheet.RowCount - 1, D7171.BasicName)

            setData(Vs1, getColumIndex(Vs1, "seUnitPrice"), Vs1.ActiveSheet.RowCount - 1, D7231.seUnitPrice)
            setData(Vs1, getColumIndex(Vs1, "cdUnitPrice"), Vs1.ActiveSheet.RowCount - 1, D7231.cdUnitPrice)
            Call READ_PFK7171(D7231.seUnitPrice, D7231.cdUnitPrice)
            setData(Vs1, getColumIndex(Vs1, "cdUnitPriceName"), Vs1.ActiveSheet.RowCount - 1, D7171.BasicName)
