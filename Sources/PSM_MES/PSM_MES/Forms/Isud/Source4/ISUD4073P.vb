...
#Region "Link"
    Public Function Link_ISUD4073P(job As Integer, cdFactory As String, cdMainProcess As String, cdLineProd As String, LineTno As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
    ...
    Private Function DATA_CHECKSTATUS() As Boolean
        ...
        Try
            If READ_PFK4073(L4073.cdFactory, L4073.cdMainProcess, L4073.cdLineProd, L4073.LineTno) = True Then
                ...
                D7558_CLEAR()
                D7558.TableName = "PFK4073"
                D7558.Parameter = L4073.cdFactory + ";" + L4073.cdMainProcess + ";" + L4073.cdLineProd + ";" + L4073.LineTno
                D7558.FileName = "APPROVAL FROM MES SYSTEM"
                D7558.FileType = D4073.CheckComplete & "-" & W4073.CheckComplete
