...
#Region "load"
    ...
    Private Sub DATA_INIT()
        Select Case Strings.Right(Me.PeaceFormType, 3).ToUpper
            Case "FGI"
                If READ_PFK7171(ListCode("SubProcess"), "006") Then
                    txt_cdSubProcess.Code = D7171.BasicCode
                    txt_cdSubProcess.Data = D7171.BasicName
                    txt_cdSubProcess.Enabled = False
                End If
            Case "FGO"
                If READ_PFK7171(ListCode("SubProcess"), "007") Then
                    txt_cdSubProcess.Code = D7171.BasicCode
                    txt_cdSubProcess.Data = D7171.BasicName
                    txt_cdSubProcess.Enabled = False
                End If
...
#Region "search"
    ...
    Public Function DATA_SEARCH_VS1() As Boolean
        ...
        DS1 = PrcDS("USP_PFP42671_SEARCH_vS1", cn, SdateEdate.text1, SdateEdate.text2,
                                                    cdFactory,
                                                    cdLineProd,
                                                    cdMainProcess, Pub.SITE)

        If GetDsRc(DS1) = 0 Then
            SPR_SET(vS1, , , , OperationMode.SingleSelect)
            SPR_PRO(vS1, DS1, "USP_PFP42671_SEARCH_vS1", "vS1")
            vS1.Enabled = True
            Exit Function
        End If
