...
#Region "Variable"
    ...
    Private M3461 As New T3461_AREA
...
#Region "Link"
    Public Function Link_ISUD3460A(job As Integer, InvoiceNo As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
    ...
    Public Function Link_ISUD3460A_AUTO(job As Integer, InvoiceNo As String, checkType As Integer, _strValue As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        D3460.InvoiceNo = InvoiceNo
        L3460.InvoiceNo = InvoiceNo
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = READ_PFK3460(L3460.InvoiceNo, cn)
        ...
        If GetDsData(DS1, 0, "K3460_Status") = "1" Then chk_IsPosted.Checked = True : wJOB = "2" : tst_iDelete.Visible = False : tst_iSave.Visible = False
        If GetDsData(DS1, 0, "K3460_Status") <> "1" Then chk_IsPosted.Checked = False

        If GetDsData(DS1, 0, "K3460_CheckMarketType") = "1" Then chk_AllLines.Checked = True
        If GetDsData(DS1, 0, "K3460_CheckMarketType") <> "1" Then chk_AllLines.Checked = False

        If READ_PFK7101(GetDsData(DS1, 0, "K3460_DestinationID")) Then
    ...
    Private Function DATA_SEARCH_vS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3460A_SEARCH_VS1", cn, L3460.InvoiceNo)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO(Vs1, DS1, "USP_ISUD3460A_SEARCH_VS1", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_vS2() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3460A_SEARCH_vS2", cn, L3460.InvoiceNo)

            If GetDsRc(DS1) = 0 Then
                DS2 = PrcDS("USP_ISUD3460A_SEARCH_vS2_INSERT", cn, L3460.InvoiceNo)

                SPR_PRO(vS2, DS2, "USP_ISUD3460A_SEARCH_vS2", "vS2")
            ...
            SPR_PRO(vS2, DS1, "USP_ISUD3460A_SEARCH_vS2", "vS2")
            SPR_TEXTBOXM(vS2, getColumIndex(vS2, "Content"))
            SPR_TEXTBOXM(vS2, getColumIndex(vS2, "Content1"))
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                If vS2.ActiveSheet.Rows(i).GetPreferredHeight > D9914.Rowheight Then vS2.ActiveSheet.Rows(i).Height = vS2.ActiveSheet.Rows(i).GetPreferredHeight
    ...
    Private Function DATA_SEARCH_vS3() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3460A_SEARCH_vS3", cn, L3460.InvoiceNo)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO(vS3, DS1, "USP_ISUD3460A_SEARCH_vS3", "vS3")
    ...
    Private Function DATA_SEARCH_vS1_AUTO() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD3460A_SEARCH_VS1_AUTO", cn, strValue)
...
#Region "Function"
    ...
    Private Sub DATA_MOVE()
        If chk_IsPosted.Checked Then W3460.Status = "1" Else W3460.Status = "2"
        If chk_AllLines.Checked Then W3460.CheckMarketType = "1" Else W3460.CheckMarketType = "2"
    End Sub
                ...
                For i = 0 To Vs1.ActiveSheet.RowCount - 1
                    If K3461_MOVE(Vs1, i, W3461, L3460.InvoiceNo, getData(Vs1, getColumIndex(Vs1, "InvoiceSeq"), i)) = True Then
                        ...
                        If chk_Line = True And chk_AllLines.Checked Then
                            W3461.SONo = M3461.SONo
                            W3461.BookingNo = M3461.BookingNo
                            W3461.DateEXFac = M3461.DateEXFac
                            W3461.DateETD = M3461.DateETD
                            W3461.DateETA = M3461.DateETA
                            W3461.ChkDeclare = M3461.ChkDeclare
                            W3461.ChkDocsBuyer = M3461.ChkDocsBuyer
                            W3461.ChkDocsHK = M3461.ChkDocsHK
                            W3461.ChkLocalCharge = M3461.ChkLocalCharge
                            W3461.ChkSMDocs = M3461.ChkSMDocs
                            W3461.ChkUploadDocs = M3461.ChkUploadDocs
                            W3461.ShipmentType = M3461.ShipmentType
                            W3461.BLNo = M3461.BLNo
                            W3461.VesselName = M3461.VesselName


                        End If


                        If REWRITE_PFK3461(W3461) And chk_AllLines.Checked Then
...
skip:
            ...
            ElseIf PeaceTabControl1.SelectedIndex = 1 Then
                ...
                Call PrcExeNoError("EXP_PFK3461_UPDATE_INVOICE_INFORMATION", cn, strList.ToArray)
            ...
            ElseIf PeaceTabControl1.SelectedIndex = 2 Then
                ...
                For i = 0 To vS3.ActiveSheet.RowCount - 1
                    ...
                    If READ_PFK3461(L3460.InvoiceNo, getData(vS3, getColumIndex(vS3, "InvoiceSeq"), i)) = True Then
                        W3461 = D3461
                        W3461.ContName1 = getData(vS3, getColumIndex(vS3, "ContName1"), i)
                        W3461.ContName2 = getData(vS3, getColumIndex(vS3, "ContName2"), i)
                        W3461.ContName3 = getData(vS3, getColumIndex(vS3, "ContName3"), i)
                        W3461.ContName4 = getData(vS3, getColumIndex(vS3, "ContName4"), i)
                        W3461.ContName5 = getData(vS3, getColumIndex(vS3, "ContName5"), i)
                        W3461.ContName6 = getData(vS3, getColumIndex(vS3, "ContName6"), i)
                        W3461.ContName7 = getData(vS3, getColumIndex(vS3, "ContName7"), i)
                        W3461.ContName8 = getData(vS3, getColumIndex(vS3, "ContName8"), i)
                        W3461.ContName9 = getData(vS3, getColumIndex(vS3, "ContName9"), i)
                        W3461.ContName10 = getData(vS3, getColumIndex(vS3, "ContName10"), i)

                        W3461.QtyPL1 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL1"), i))
                        W3461.QtyPL2 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL2"), i))
                        W3461.QtyPL3 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL3"), i))
                        W3461.QtyPL4 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL4"), i))
                        W3461.QtyPL5 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL5"), i))
                        W3461.QtyPL6 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL6"), i))
                        W3461.QtyPL7 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL7"), i))
                        W3461.QtyPL8 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL8"), i))
                        W3461.QtyPL9 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL9"), i))
                        W3461.QtyPL10 = CDecp(getData(vS3, getColumIndex(vS3, "QtyPL10"), i))
    ...
    Private Function Data_Check() As Boolean
        ...
        Try
            For i = 0 To Vs1.ActiveSheet.RowCount - 1
                ...
                InvoiceNo = getData(Vs1, getColumIndex(Vs1, "KEY_InvoiceNo"), i)
                InvoiceSeq = getData(Vs1, getColumIndex(Vs1, "KEY_InvoiceSeq"), i)

                Dim strMsg As String

                strMsg = PrcExeNoError_ValueVN(" EXP_CLOSSING_PFK3460_CHECK_QTYORDER", cn, OrderNo, OrderNoSeq, qtyOrder, InvoiceNo, InvoiceSeq)
...
skip:
    ...
    Private Sub DATA_CLOSE()
        Try
            ...
            strMsg = PrcExeNoError_ValueVN(" EXP_CLOSSING_PFK3460_CHECK", cn, txt_InvoiceNo.Data)
        ...
        Select Case e.KeyCode
            ...
            Case Keys.Delete
                ...
                If getData(Vs1, getColumIndex(Vs1, "KEY_InvoiceSeq"), xROW) <> "0" Then
                    ...
                    If READ_PFK3461(txt_InvoiceNo.Data, getData(Vs1, getColumIndex(Vs1, "KEY_InvoiceSeq"), xROW)) Then
                        W3461.InvoiceNo = txt_InvoiceNo.Data
                        W3461.InvoiceSeq = getDataM(Vs1, getColumIndex(Vs1, "KEY_InvoiceSeq"), xROW)
    ...
    Private Sub chk_IsPosted_CheckedChanged(sender As Object, e As EventArgs) Handles chk_IsPosted.CheckedChanged
        Try
            ...
            If chk_IsPosted.Checked = False Then
                If READ_PFK3460(txt_InvoiceNo.Data) Then
                    W3460 = D3460
                    If W3460.Status <> "1" Then Exit Sub

                    If MsgBoxPPW("Please type the password to uncomplete!", const_pwDeleteLiq) = False Then Exit Sub

                    If W3460.Status = "1" Then Call PrcExeNoError("EXP_CLOSSING_PFK3460_UNCOMPLETE", cn, txt_InvoiceNo.Data)
