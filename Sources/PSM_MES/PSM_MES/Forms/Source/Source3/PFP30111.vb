...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1,
                     "PURCHASING LIST CONTROL PROCCESING - " & WordConv("UPDATE") & "(F5)",
                      "PURCHASING LIST CONTROL PROCCESING - " & WordConv("ACCEPT") & "(F6)")
...
#Region "Function"
    Private Sub MAIN_JOB01()
        ...
        Try
            ...
            If READ_PFK1312(OrderNo, OrderNoSeq) Then
                ...
                If ISUD3011B.Link_ISUD3011B(3, OrderNo, OrderNoSeq, Me.Name) Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        Dim str As String = MsgBoxP("Do you want to accept it again?", vbYesNo)
        ...
        Try
            ...
            If READ_PFK1312(OrderNo, OrderNoSeq) Then
                ...
                strMsg = PrcExeNoError_Value("USP_PFP30111_ACCEPT_PURCHASING_LIST", cn, OrderNo, OrderNoSeq, Pub.SAW)

                Call MsgBoxP(strMsg, vbInformation)
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP30111_SEARCH_VS10", cn, SdateEdate.text1, SdateEdate.text2, txt_cdSite.Code, txt_CustPONO.Data, txt_Article.Data, chk_Revise.CheckState)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP30111_SEARCH_VS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(OrderNo As String, OrderNoSeq As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP30111_SEARCH_vS20", cn, OrderNo, OrderNoSeq)


        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP30111_SEARCH_vS20", "vS20")
            vS20.Enabled = True
            Exit Function
        End If
