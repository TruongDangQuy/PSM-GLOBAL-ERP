...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_PFP73070_SEARCH_VS1", cn, txt_BOMName.Data, txt_CustomerCode.Code, chk_CheckUse1.CheckState, chk_CheckUse2.CheckState)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_PFP73070_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP73070_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO_NEW(Vs2, DS1, "USP_PFP73070_SEARCH_VS2", "Vs2")
            DATA_SEARCH02 = True
        Catch ex As Exception
...
#Region "EVENT"
    Private Sub Vs1_CellClick(sender As Object, e As CellClickEventArgs) Handles Vs1.CellDoubleClick
        Vs1.Enabled = False
        Call DATA_SEARCH02(getData(Vs1, getColumIndex(Vs1, "KEY_MAMaID"), e.Row))
        Vs1.Enabled = True
    End Sub
