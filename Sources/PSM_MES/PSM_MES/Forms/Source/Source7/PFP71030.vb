...
#Region "Form_load"
    ...
    Private Sub DATA_INIT()
        ...
        If txt_cdTypeCode.Code = "002" Then
            Dim xISUD7611A As String
            xISUD7611A = ISUD7611A.Text

            Call Cms_additem(Cms_1, _
                          xISUD7611A & " - " & WordConv("INPUT") & "(F5)")
...
#Region "Data_search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_PFP71030_SEARCH_VS1", cn, txt_cdTypeCode.Code, "*" & txt_TypeName.Data)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_PFP71030_SEARCH_VS1", "Vs1")
        DATA_SEARCH01 = True
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP71030_SEARCH_VS1_LINE", cn, Autokey)

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(Vs1, DS1, "USP_PFP71030_SEARCH_VS1", "Vs1", xrow)
