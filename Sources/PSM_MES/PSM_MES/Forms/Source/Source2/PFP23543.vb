...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_2, _
                        ...
                        "MATERIAL INBOUND PROCESSING - " & WordConv("DELETE") & "(F8)", _
                        "MATERIAL INBOUND PROCESSING - " & WordConv("INVOICE UPDATE") & "(F9)")
            ...
            Select Case True
                ...
                Case Vs10.Focused
                    If getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex) <> "" Then
                        If ISUD2351A.Link_ISUD2351A_AUTO_LINE(1, getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), Vs10.ActiveSheet.ActiveRowIndex),
                                                            getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderSeq"), Vs10.ActiveSheet.ActiveRowIndex),
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23543_SEARCH_VS10", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP23543_SEARCH_VS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23543_SEARCH_vS20", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdDepartment.Code,
                                                    txt_FactOrderNo.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23543_SEARCH_vS20", "vS20")
            vS20.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23543_SEARCH_VS30", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdDepartment.Code,
                                                    txt_FactOrderNo.Data,
                                                    txt_SupplierCode.Data, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS30, DS1, "USP_PFP23543_SEARCH_VS30", "VS30")
            vS30.Enabled = True
            Exit Function
        End If
