...
#Region "Link"
    Public Function Link_ISUD4070A(job As Integer, cdFactory As String, cdMainProcess As String, MachineCode As String, MachineTno As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
    ...
    Public Function Link_ISUD4070A_JOBCARD(job As Integer, JobCard As String, cdFactory As String, cdMainProcess As String, MachineCode As String, MachineTno As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        D4070.MachineCode = MachineCode
        D4070.cdFactory = cdFactory
        D4070.cdMainProcess = cdMainProcess
        ...
        Try
            ...
            Link_ISUD4070A_JOBCARD = isudCHK
...
#Region "Search"
    ...
    Private Function DATA_SEARCH_VS0() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD4070A_SEARCH_VS0", cn, L4070.cdFactory,
                                                              L4070.cdMainProcess,
                                                              L4070.MachineCode,
                                                              L4070.MachineTno)
            ...
            If GetDsRc(DS1) = 0 Then
                VS0.Enabled = True
                SPR_PRO(vS0, DS1, "USP_ISUD4070A_SEARCH_VS0", "VS0")
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD4070A_SEARCH_vS1", cn, L4070.cdFactory,
                                                              L4070.cdMainProcess,
                                                              L4070.MachineCode,
                                                              L4070.MachineTno)
            ...
            If GetDsRc(DS1) = 0 Then
                ...
                SPR_PRO(vS1, DS1, "USP_ISUD4070A_SEARCH_vS1", "Vs1")
                Exit Function
            End If
            ...
            If READ_PFK4070(L4070.cdFactory, L4070.cdMainProcess, L4070.MachineCode, L4070.MachineTno) Then
                Call VsSizeRangeNew(vS1, "USP_VS_SIZERANGE_WorkOrder", "SizeQty01", D4070.WorkOrder, D4070.WorkOrderSeq)
            End If
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD4070A_SEARCH_VS2_BATCHGROUP", cn, L4070.cdFactory,
                                                              L4070.cdMainProcess,
                                                              L4070.MachineCode,
            ...
            If GetDsRc(DS1) = 0 Then
                ...
                SPR_PRO(vS2, DS1, "USP_ISUD4070A_SEARCH_VS2", "VS2")
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_HEAD() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD4070A_SEARCH_HEAD", cn, L4070.cdFactory,
                                                         L4070.cdMainProcess,
                                                         L4070.MachineCode,
                                                         L4070.MachineTno)
    ...
    Private Function DATA_SEARCH_HEAD_TAB1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD4070A_SEARCH_sTAB1_HEAD", cn, L4070.JobCard)
    ...
    Private Function DATA_SEARCH01() As Boolean
        DATA_SEARCH01 = False
        Try
            DS1 = PrcDS("USP_ISUD4070A_SEARCH_vS1", cn, L4070.cdFactory, L4070.cdMainProcess, L4070.MachineCode, L4070.MachineTno)
    ...
    Private Function DATA_SEARCH_VS1_INSERT() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD4070A_SEARCH_VS1_INSERT", cn, L4070.JobCard)
            ...
            Call READ_SPREAD(vS1, DS1, "USP_ISUD4070A_SEARCH_vS1", "VS1", xrow)
                ...
                If READ_PFK4071(L4070.cdFactory, L4070.cdMainProcess, L4070.MachineCode, L4070.MachineTno, (i - FixCol + 1).ToString("00")) Then
                    ...
                    For j = 0 To CIntp(getData(vS1, i, 4)) - 1
                        ...
                        If txt_cdMainProcess.Code = "110" Then
                            Call PrcExeNoError("USP_PFK4075_AUTO_BATCHNO_STITCHING_SZNO_MACHINE_BATCHQTY_110", cn, D4071.cdFactory,
                                       D4071.MachineCode,
                                       D4071.MachineTno,
                                       "",
                                       "",
                        ...
                        Else
                            Call PrcExeNoError("USP_PFK4075_AUTO_BATCHNO_STITCHING_SZNO_MACHINE_BATCHQTY", cn, D4071.cdFactory,
                                         D4071.MachineCode,
                                         D4071.MachineTno,
                                         "",
                                         "",
