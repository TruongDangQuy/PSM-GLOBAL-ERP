...
#Region "Formload"
    ...
    Public Function Link_HLP7325A(cdMainProcess As String, Optional ByVal TAG As String = "") As Boolean
        Link_HLP7325A = False
        Me.Tag = TAG
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_HLP7325A_SEARCH_VS1", cn, txt_cdMainProcess.Code)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_HLP7325A_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7325A_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO(Vs2, DSNEW, "USP_HLP7325A_SEARCH_VS2", "Vs2")
