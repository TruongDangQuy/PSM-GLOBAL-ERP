    ...
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1, _
                         ...
                         xISUD2351A & " - " & WordConv("INPUT BY ONE LINE") & "(F7)",
                          ...
                          "-",
                           xISUD2351A & " - " & WordConv("INPUT BY CHECK LIST") & "(F9)")
    ...
    Private Sub MAIN_JOB05()
        Try
            ...
            For i = 0 To Vs10.ActiveSheet.RowCount - 1
                ...
                KEY_Autokey = getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderNo"), i) & getData(Vs10, getColumIndex(Vs10, "KEY_FactOrderSeq"), i)
...
next1:
            ...
            If ISUD2351A.Link_ISUD2351A_INSERT_MULTI(41, SpecNoList, Me.Name) = False Then Exit Sub
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23517_SEARCH_VS10", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                    txt_cdSite.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP23517_SEARCH_VS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23517_SEARCH_vS20", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdSite.Code,
                                                    txt_FactOrderNo.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23517_SEARCH_vS20", "vS20")
            vS20.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23517_SEARCH_VS30", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdSite.Code,
                                                    txt_FactOrderNo.Data,
                                                    txt_SupplierCode.Data, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS30, DS1, "USP_PFP23517_SEARCH_VS30", "VS30")
            vS30.Enabled = True
            Exit Function
        End If
...
#End Region
    ...
    Private Sub ssp_WHERE_Paint(sender As Object, e As PaintEventArgs) Handles ssp_WHERE.Paint
