...
#Region "Form_load"
    ...
    Private Sub DATA_INIT()
        txt_cdMainProcess.Data = "F/G Inbound"
        txt_cdMainProcess.Code = "090"
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP01630_SEARCH_VS10", cn, txt_cdFactory.Code, SdateEdate.text1, SdateEdate.text2)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS10, DS1, "USP_PFP01630_SEARCH_VS10", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
