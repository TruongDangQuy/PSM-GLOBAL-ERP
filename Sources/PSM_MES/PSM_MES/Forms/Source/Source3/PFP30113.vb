...
#Region "Form_load"
    ...
    Private Sub PFP30113_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
next1:
    ...
    Private Sub MAIN_JOB09()
        ...
        If ISUD3411A.Link_ISUD3411A(9, PurchasingOrderNo, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB10()
        ...
        If ISUD3411A.Link_ISUD3411A(10, PurchasingOrderNo, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB05()
        ...
        If cdSite = "" Then MsgBoxP("Site?") : Exit Sub
        ...
        If ISUD3411A.Link_ISUD3411A_AUTO(5, txt_cdSite.Code, CustomerCode, SupplierCode, Line, cdLargeGroupMaterial, cdSemiGroupMaterial, chk_CheckSample.CheckState, PurchasingOrderNo, Me.Name) = False Then Exit Sub
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        If chk_Period.Checked = True Then
            DS1 = PrcDS("USP_PFP30113_SEARCH_VS1_F1", cn, SdateEdate.text1,
                                                       SdateEdate.text2,
                                                       txt_PRName.Data,
                                                       txt_cdSite.Code,
                                                       txt_Customer.Code,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP30113_SEARCH_VS1_F1", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
        ...
        Else
            DS1 = PrcDS("USP_PFP30113_SEARCH_VS1", cn, SdateEdate.text1,
                                                    SdateEdate.text2,
                                                    txt_PRName.Data,
                                                    txt_cdSite.Code,
                                                    txt_Customer.Code,
                                                    ...
                                                    chk_CheckUse.CheckState)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP30113_SEARCH_VS1", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP30113_SEARCH_vs_Season", cn, ListCode("Site"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP30113_SEARCH_vs_Season", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            If chk_Period.Checked = True Then
                DS1 = PrcDS("USP_PFP30113_SEARCH_vS_Cus_F1", cn, SdateEdate.text1, SdateEdate.text2, txt_CustomerCode.Code, txt_cdSite.Code,
                                                       chk_CheckSample.CheckState)
                SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP30113_SEARCH_vS_Cus_F1", "vS_Cus")
            ...
            Else
                DS1 = PrcDS("USP_PFP30113_SEARCH_vS_Cus", cn, txt_CustomerCode.Code, txt_cdSite.Code,
                                                       chk_CheckSample.CheckState)
                SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP30113_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        cdSite = getData(vs_Season, getColumIndex(vs_Season, "BasicCode"), vs_Season.ActiveSheet.ActiveRowIndex)
        ...
        Try
            If chk_Period.Checked = True Then
                DS1 = PrcDS("USP_PFP30113_SEARCH_vS_Line_F1", cn, SdateEdate.text1, SdateEdate.text2, txt_cdSite.Code, CustomerCode,
                                                       chk_CheckSample.CheckState)

                SPR_PRO_NEW(vS_Line, DS1, "USP_PFP30113_SEARCH_vS_Line_F1", "vS_Line")
            ...
            Else
                DS1 = PrcDS("USP_PFP30113_SEARCH_vS_Line", cn, txt_cdSite.Code, CustomerCode,
                                                       chk_CheckSample.CheckState)

                SPR_PRO_NEW(vS_Line, DS1, "USP_PFP30113_SEARCH_vS_Line", "vS_Line")
                SplitContainer2.SplitterDistance = SPR_SHEETWIDHT(vS_Line) + cSprWidthSize
    ...
    Public Function DATA_SEARCH_HEAD_vs_Large() As Boolean
        ...
        Try
            If chk_Period.Checked = True Then
                DS1 = PrcDS("USP_PFP30113_SEARCH_vS_Large_F1", cn, SdateEdate.text1, SdateEdate.text2, ListCode("LargeGroupMaterial"), CustomerCode, txt_cdSite.Code, Line,
                                                      chk_CheckSample.CheckState)

                SPR_PRO_NEW(vs_Large, DS1, "USP_PFP30113_SEARCH_vS_Large_F1", "vs_Large")
            ...
            Else
                DS1 = PrcDS("USP_PFP30113_SEARCH_vS_Large", cn, ListCode("LargeGroupMaterial"), CustomerCode, txt_cdSite.Code, Line,
                                                    chk_CheckSample.CheckState)

                SPR_PRO_NEW(vs_Large, DS1, "USP_PFP30113_SEARCH_vS_Large", "vs_Large")
                SplitContainer2.SplitterDistance = SPR_SHEETWIDHT(vs_Large) + cSprWidthSize
