...
#Region "Link_ISUD"
    ...
    Private Sub MAIN_JOB01()
        ...
        If ISUD7104A.Link_ISUD7104A(1, txt_CustomerCode.Code, "", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        SizeRange = getData(Vs2, getColumIndex(Vs2, "KEY_SizeRange"), Vs2.ActiveSheet.ActiveRowIndex)

        If SizeRange = "" Then Exit Sub

        If ISUD7104A.Link_ISUD7104A(2, CustomerCode, SizeRange, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        If ISUD7104A.Link_ISUD7104A(3, CustomerCode, SizeRange, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB04()
        ...
        If ISUD7104A.Link_ISUD7104A(4, CustomerCode, SizeRange, Me.Name) = False Then Exit Sub
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_PFP71040_SEARCH_VS1", cn, txt_CustomerCode.Code)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_PFP71040_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02() As Boolean
        ...
        Try
            If txt_CustomerCode.Code <> "" Then
                DS1 = PrcDS("USP_PFP71040_SEARCH_VS2", cn, txt_CustomerCode.Code)
            Else
                DS1 = PrcDS("USP_PFP71040_SEARCH_VS2", cn, getData(Vs1, getColumIndex(Vs1, "CustomerCode"), Vs1.ActiveSheet.ActiveRowIndex))
            End If
            ...
            SPR_PRO_NEW(Vs2, DS1, "USP_PFP71040_SEARCH_VS2", "Vs2")
