...
#Region "Event"
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        Select Case wJOB
            Case 1
                Call DATA_CHECKCOMPLETE()
                Call PrcExeNoError("USP_PFK4015_GENERATE_BARCODE_ALL_JOBCARD_SIZECHECK_NEWCONCEPT", cn, L4073.cdFactory, L4073.cdMainProcess, L4073.cdLineProd, L4073.LineTno)
...
#End Region
    ...
    Private Function DATA_DELETE_PFK4075()
        ...
        End Try
    End Function
    Private Sub cmd_DEL_Click_1(sender As Object, e As EventArgs) Handles cmd_DEL.Click
        If CHK(4) <> "1" Then MsgBoxP("You have no right in this program!") : Exit Sub
        Msg_Result = MsgBoxP("Do you want to delete all worksheet?", vbYesNo)
