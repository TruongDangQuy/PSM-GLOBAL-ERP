...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim xISUD3421Y As String = ISUD3421Y.Text
        Dim xISUD3421P As String = ISUD3421P.Text

        Call Cms_additem(Cms_1,
                        xISUD3421Y & " - " & WordConv("INPUT") & "(F5)",
                        xISUD3421Y & " - " & WordConv("SEARCH") & "(F6)",
                        xISUD3421Y & " - " & WordConv("UPDATE") & "(F7)",
                        xISUD3421Y & " - " & WordConv("DELETE") & "(F8)",
                        "-",
                        xISUD3421P & " - " & WordConv("ONE"),
                        xISUD3421P & " - " & WordConv("ALL"),
                        xISUD3421Y & " - " & WordConv("UPDATE AFTER"))
    ...
    Private Sub DATA_INIT()
        ...
        ' mr.son ==> Outside ==>>  chk_CheckProcessMaterial1.Checked = True  ********
...
#Region "Function"
    Private Sub MAIN_JOB01()
        If ISUD3421Y.Link_ISUD3421Y(1, "000000000", chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        If ISUD3421Y.Link_ISUD3421Y(2, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
    End Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        If ISUD3421Y.Link_ISUD3421Y(3, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB04()
        ...
        If ISUD3421Y.Link_ISUD3421Y(4, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB07()
        ...
        If ISUD3421Y.Link_ISUD3421Y(5, FactOrderNo, chk_CheckIOType, chk_CheckPurchasingOrder, Me.Name) = False Then Exit Sub
...
#Region "Data_search"
    Private Function DATA_SEARCH01(Optional ByVal xsort As String = "1") As Boolean
        ...
        If opt_G1.Checked = True Then
            ...
            DS1 = PrcDS("USP_PFP34224_SEARCH_VS1_GROUP", cn, SdateEdate.text1,
                                                        SdateEdate.text2,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP34224_SEARCH_VS1_GROUP", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
        ...
        Else
            ...
            DS1 = PrcDS("USP_PFP34224_SEARCH_VS1_DETAIL", cn, SdateEdate.text1,
                                                       SdateEdate.text2,
                                                       txt_GCODE.chkAll.CheckState,
                                                       txt_GCODE.SQL,
                                                        txt_cdDepartment.Code,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP34224_SEARCH_VS1_DETAIL", "Vs1")
                Vs1.Enabled = True
                Exit Function
            End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP34224_SEARCH_VS1_LINE", cn, FactOrderNo,
                                                        FactOrderSeq)
            ...
            READ_SPREAD(Vs1, DS1, "USP_PFP34224_SEARCH_VS1", "Vs1", Vs1.ActiveSheet.ActiveRowIndex)
