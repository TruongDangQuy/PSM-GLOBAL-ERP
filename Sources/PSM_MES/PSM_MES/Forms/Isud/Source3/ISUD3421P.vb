...
#Region "Link"
    Public Function Link_ISUD3421P(job As Integer, FactOrderNo As String, FactOrderSeq As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
...
#Region "Search"
    Private Function APPROVAL_CHECK() As Boolean
        ...
        If L3422.CheckPurchasing = "2" Then MsgBoxP("Completed already!") : cmd_OK.Visible = False : Exit Function
...
#Region "Functions"
    ...
    Private Function DATA_UPDATE() As Boolean
        ...
        Try
            If READ_PFK3422(L3422.FactOrderNo, L3422.FactOrderSeq) = True Then
                ...
                If READ_PFK3429_FactOrder(L3422.FactOrderNo, L3422.FactOrderSeq) = True Then
                ...
                D7558_CLEAR()
                D7558.TableName = "PFK3422"
                D7558.Parameter = L3422.PurchasingOrderNo + ";" + L3422.PurchasingOrderSeq.ToString
                D7558.FileName = "APPROVAL FROM MES SYSTEM"
                D7558.FileType = D3422.CheckPurchasing & "-" & W3422.CheckPurchasing
    ...
    Private Function DATA_UPDATE_ALL() As Boolean
        ...
        Try
            ...
            If READ_PFK3429_FactOrder(L3422.FactOrderNo, "") = True Then
                MsgBox("Already make Payable can't modify !")
                Exit Function
            End If
            For Each RS01 As DataRow In DS1.Tables(0).Rows
            ...
            If READ_PFK3421(L3422.FactOrderNo) Then
                If D3421.CheckOutPurchasingOrder = "5" Then
                    Call PrcExeNoError("USP_PFK3421_APPROVAL_PFK3421_RETURN_00_IOR", cn, L3422.FactOrderNo)
