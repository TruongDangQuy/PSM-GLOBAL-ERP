...
#Region "Link"
    Public Function Link_ISUD4073B(job As Integer, cdFactory As String, cdMainProcess As String, cdLineProd As String, LineTno As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
    ...
    Public Function Link_ISUD4073B_JobCard(job As Integer, JobCard As String, cdFactory As String, cdMainProcess As String, cdLineProd As String, LineTno As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        D4073.cdLineProd = cdLineProd
        D4073.cdFactory = cdFactory
        D4073.cdMainProcess = cdMainProcess
        ...
        Try
            ...
            Link_ISUD4073B_JobCard = isudCHK
...
AgainPoint:
            ...
            Case 31 'only plan qty update 
                ...
                Me.Text = Me.Text & " - UPDATE PRODUCTION PLAN"
                cmd_DEL.Visible = False

                cmd_Generate.Visible = True
                txt_QtyPlan.Enabled = True
...
#Region "Search"
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD4073B_SEARCH_vS1", cn, L4073.cdFactory,
                                                              L4073.cdMainProcess,
                                                              L4073.cdLineProd,
                                                              L4073.LineTno)
            ...
            SPR_SET(vS1, , , , OperationMode.Normal)
            SPR_PRO(vS1, DS1, "USP_ISUD4073B_SEARCH_vS1", "Vs1")
            Call VsSizeRangeNew(vS1, "USP_VS_SIZERANGE_JOBBASE_GRADING", "SizeQty01", txt_JobCard.Data, txt_cdMainProcess.Code)
    ...
    Private Function DATA_CHECKCOMPLETE() As Boolean
        ...
        Try
            If READ_PFK4073(L4073.cdFactory, L4073.cdMainProcess, L4073.cdLineProd, L4073.LineTno) = True Then
                ...
                W4073.QtyPlan = CInt(txt_QtyPlan.Data)
...
#Region "Event"
    ...
    Private Sub cmd_DEL_Click(sender As Object, e As EventArgs) Handles cmd_DEL.Click
        If Data_Delete_function_BARCODE_PRODUCTION() = True Then
            MsgBoxP("Already Production! ") : Exit Sub
        End If

        If Data_Delete_function_BARCODE_PRINT() = True Then
            MsgBoxP("Already Print! ")

            Msg_Result = MsgBox("Do you want to delete ? Đã in bạn còn muốn xóa ?", vbYesNo)
        ...
        For i = Scol To vS1.ActiveSheet.ColumnCount - 1
            If getDataM(vS1, i, 1) = "1" And CIntp(getDataM(vS1, i, 0)) >= 1 Then
                If txt_cdFactory.Code = "002" Then
                    Call PrcExeNoError("USP_PFK4075_AUTO_BATCHNO_STITCHING_SZNO_QTY_NEWCONCEPT", cn, L4073.cdFactory, "", "", L4073.cdLineProd, L4073.LineTno, L4073.JobCard, (i - FixCol + 1).ToString("00"), CIntp(getDataM(vS1, i, 0)), txt_InchargePlan.Code)
...
#End Region
    ...
    Public Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        gpp = e.Graphics
        Call TAG_PRINT_STITCHING_PANEL_NEW_PROD_NEWCONCEPT()
            ...
            If Msg_Result = vbYes Then
                For i = 0 To vS2.ActiveSheet.RowCount - 1 Step 4
                    If getDataM(vS2, getColumIndex(vS2, "DCHK"), i) = "1" Then
                        ...
                        'Call DATA_MOVE_BARCODE_12(getData(vS2, getColumIndex(vS2, "BatchShoes"), i))
                        'Call DATA_MOVE_BARCODE_34(getData(vS2, getColumIndex(vS2, "BatchShoes"), i + 2))
