...
#Region "Formload"
    ...
    Private Sub FORM_INIT()
        ...
        DS1 = PrcDS("USP_PFP88500_SEARCH_HEAD", cn)
        Dim i As Integer
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH(sender As Object) As Boolean
        ...
        ProcName = "USP_PFP88500_SEARCH_VS" & ItemMain.SelectedIndex.ToString("00")

        DS1 = PrcDS(ProcName, cn, pnr_Year.Value.ToString, txt_cdSite.Code, txt_CustomerCode.Code)
