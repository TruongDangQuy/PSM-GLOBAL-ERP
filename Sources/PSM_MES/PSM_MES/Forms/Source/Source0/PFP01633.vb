...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP01633_SEARCH_VS10", cn, txt_cdFactory.Code, txt_SDATE.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS10, DS1, "USP_PFP01633_SEARCH_VS10", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS11(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS10.Enabled = True
        Try
            DS1 = PrcDS("USP_PFP01603_SEARCH_VS11", cn, txt_cdFactory.Code, cdMainProcess, cdLineProd, JobCard, txt_SDATE.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS10, DS1, "USP_PFP01603_SEARCH_VS11", "VS11")
                vS10.Enabled = True
                Exit Function
            End If
            ...
            For i = 0 To vS10.ActiveSheet.RowCount - 1
                ...
                If Trim$(getData(vS10, getColumIndex(vS10, "TITILE_S150"), i)) <> "" Then
                    If Trim$(getData(vS10, getColumIndex(vS10, "TITILE_S150"), i)) = "1.SealNo" Then Call SPR_BACKCOLOR(vS10, cSprSealNo, i)
                    If Trim$(getData(vS10, getColumIndex(vS10, "TITILE_S150"), i)) = "2.Prod" Then Call SPR_BACKCOLOR(vS10, cSprProduction, i)
                    If Trim$(getData(vS10, getColumIndex(vS10, "TITILE_S150"), i)) = "5.Balance" Then Call SPR_BACKCOLOR(vS10, cSprBalance, i)

                End If

            Next

            Call VsSizeRangeNew_one(vS10, "USP_PFP01603_SEARCH_VS11_HEAD", getColumIndex(vS10, "QtyTotal"), getData(vS10, getColumIndex(vS10, "OrderNo"), 0), getData(vS10, getColumIndex(vS10, "OrderNoSeq"), 0))
