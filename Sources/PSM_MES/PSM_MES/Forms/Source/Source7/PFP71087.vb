...
#Region "Variable"
    ...
    Private Pri_cdSpecState As String = "006"
...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim xISUD7110K As String
        xISUD7110K = ISUD7110K.Text
        ...
        Call Cms_additem(Cms_1, xISUD7110K & " - " & WordConv("SEARCH") & "(F5)", _
                                xISUD7110K & " - " & WordConv("UPDATE") & "(F6)")
    ...
    Private Sub FORM_INIT()
        ...
        If READ_PFK7171(ListCode("SpecState"), Pri_cdSpecState) Then
...
#Region "Function"
    ...
    Private Sub MAIN_JOB01()
        ...
        ShoesCode = getData(vS2, getColumIndex(vS2, "ShoesParent"), vS2.ActiveSheet.ActiveRowIndex)

        If READ_PFK7106(ShoesCode) Then
            If ISUD7110K.Link_ISUD7110K(2, ShoesCode, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        If READ_PFK7106(ShoesCode) Then
            If ISUD7110K.Link_ISUD7110K(3, ShoesCode, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        Try
            ...
            StrMsg = MsgBox("Do you want to COMPLETE CON?", vbYesNo)

            If StrMsg <> vbYes Then Exit Sub

            For i = 0 To vS2.ActiveSheet.RowCount - 1
                ShoesCode = getData(vS2, getColumIndex(vS2, "ShoesCode"), i)

                If getDataM(vS2, getColumIndex(vS2, "DCHK"), i) = "1" Then
                    Call PrcExeNoError("USP_PFP71087_CHECKCON_COMPLETE", cn, ShoesCode, Pub.DAT, Pub.SAW)
                    setData(vS2, getColumIndex(vS2, "CheckCON"), i, "1", , True)
                End If
            Next
    ...
    Private Sub MAIN_JOB04()
        Try
            ...
            StrMsg = MsgBox("Do you want to UN-COMPLETE CON?", vbYesNo)
            ...
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                ...
                If getDataM(vS2, getColumIndex(vS2, "DCHK"), i) = "1" Then
                    Call PrcExeNoError("USP_PFP71087_CHECKCON_UNCOMPLETE", cn, ShoesCode, Pub.DAT, Pub.SAW)
                    setData(vS2, getColumIndex(vS2, "CheckCON"), i, "2", , True)
                End If
            Next
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        If txt_CustomerCode.Code = "" Then
            MsgBoxP("Input Customer Info!")
            Exit Function
        End If

        If txt_cdSeason.Code = "" Then
            MsgBoxP("Input Season Info!")
            Exit Function
        End If

        Vs1.Enabled = False

        DS1 = PrcDS("USP_PFP71087_SEARCH_VS1", cn, txt_cdSeason.Code, txt_CustomerCode.Code, txt_cdSpecState.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP71087_SEARCH_VS1", "Vs1")
            SplitContainer1.SplitterDistance = SPR_SHEETWIDHT(Vs1) + cSprWidthSize
            Vs1.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS2(cdSpecState As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71087_SEARCH_VS2_F1", cn, txt_CustomerCode.Code, txt_cdSpecState.Code, txt_cdSeason.Code, txt_Line.Data, "*" & txt_Article.Data, txt_ColorName.Data, txt_LastCode.Code, txt_MoldCode.Code, chk_CheckUse1.CheckState, chk_CheckUse2.CheckState, chk_Use1.CheckState, chk_Use2.CheckState, chk_Complete1.CheckState, chk_Complete2.CheckState)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_PFP71087_SEARCH_VS2_F1", "VS2")
    ...
    Private Function DATA_SEARCH_vs_Image(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71087_SEARCH_vs_Image", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vs_Image, DS1, "USP_PFP71087_SEARCH_vs_Image", "vs_Image")
    ...
    Private Function DATA_SEARCH_vs_Doc(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71087_SEARCH_vs_Doc", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS_Doc, DS1, "USP_PFP71087_SEARCH_vs_Doc", "vs_Doc")
            vS_Doc.Enabled = True
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP71087_SEARCH_Vs2_LINE", cn, ShoesCode)

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(vS2, DS1, "USP_PFP71087_SEARCH_Vs2", "Vs2", xrow)
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71087_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP71087_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71087_SEARCH_vS_Cus", cn, CustomerCode, cdSeason)
            SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP71087_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71087_SEARCH_vS_Line", cn, cdSeason, CustomerCode, txt_cdSpecState.Code)
            SPR_PRO_NEW(vS_Line, DS1, "USP_PFP71087_SEARCH_vS_Line", "vS_Line")
...
#Region "Event"
    ...
    Private Sub vS_Line_CellClick(sender As Object, e As CellClickEventArgs) Handles vS_Line.CellDoubleClick
        ...
        Call DATA_SEARCH_VS2(Pri_cdSpecState)
    End Sub
        ...
        Try
            ...
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                If getDataM(vS2, getColumIndex(vS2, "DCHK"), i) = "1" Then
                    ...
                    If GetDsRc(DS1) > 0 Then
                        READ_SPREAD(vS2, DS1, "USP_PFP71087_SEARCH_VS2", "vS2", i)
                    End If
...
#End Region
    ...
    Private Sub Me_KeyDown_123(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        End If
    End Sub
    Private Sub vs_Image_CellClick(sender As Object, e As CellClickEventArgs) Handles vs_Image.CellClick
    ...
    Private Sub vS_Doc_CellClick(sender As Object, e As CellClickEventArgs) Handles vS_Doc.CellDoubleClick
        If e.Column = getColumIndex(sender, "DoucmentName") Then
            sender.ActiveSheet.OperationMode = OperationMode.Normal
        Else
            sender.ActiveSheet.OperationMode = OperationMode.SingleSelect
    ...
    Private Sub vs_Image_CellDoubleClick(sender As Object, e As CellClickEventArgs) Handles vs_Image.CellDoubleClick, vS_Doc.CellDoubleClick
