...
#Region "Link"
    Public Function Link_ISUD3421B_MAT(job As Integer, FactOrderNo As String, chk_CheckIOType As String, chk_CheckPurchasingOrder As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
...
#Region "Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_ISUD3421B_RND_SEARCH_HEAD", cn, L3421.FactOrderNo)
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_ISUD3421B_RND_SEARCH_VS1", cn, L3421.FactOrderNo)
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_ISUD3421B_RND_SEARCH_VS1", "Vs1")

                If cmb_CheckInPurchasingOrder.InSelected = 4 Then
                    If getColumIndex(Vs1, "CLcdMaterialCode") > -1 Then
                        Vs1.ActiveSheet.Columns(getColumIndex(Vs1, "CLcdMaterialCode")).Tag = "CLcdMaterialCode_F1"
                    End If
                End If
    ...
    Private Sub DATA_MOVE_WRITE01()
        ...
        For i = 0 To Vs1.ActiveSheet.RowCount - 1
            ...
            If K3422_MOVE(Vs1, i, W3422, L3422.FactOrderNo, getData(Vs1, getColumIndex(Vs1, "KEY_FactOrderSeq"), i)) = True Then
                ...
                W3422.cdDepartment = "007" 'MATERIAL
...
skip:
    ...
    Private Sub DATA_UPDATE_AFTER()
        Try
            If READ_PFK3421(L3421.FactOrderNo) = True Then
                W3421 = D3421
                W3421.ContractNo = txt_ContractNo.Data
    ...
    Private Sub KEY_COUNT()
        ...
        Try
            ...
            If IsDBNull(rd!MAX_MCODE) Then
                W3421.FactOrderNo = "PB" & YRNO & "00001"
            Else
                W3421.FactOrderNo = "PB" & YRNO & Format(CInt(rd!MAX_MCODE + 1), "00000")
            End If
    ...
    Private Function Data_Check() As Boolean
        ...
        Try
            For i = 0 To Vs1.ActiveSheet.RowCount - 1
                If FormatCut(getData(Vs1, getColumIndex(Vs1, "MaterialCode"), i)) = "" Then MsgBoxP("Material Code at Line" & (i + 1)) : Exit Function
...
#Region "Event"
    ...
    Private Sub Vs1_ButtonClicked(sender As Object, e As EditorNotifyEventArgs) Handles Vs1.ButtonClicked
        ...
        Select Case xCOL
            ...
            Case 11
                If cmb_CheckInPurchasingOrder.InSelected <> 4 Then Exit Sub
                    ...
                    If READ_PFK7101(txt_SupplierCode.Code) = True Then
                        ...
                        For i = 0 To Array_hlp0000SeVaTt.Count - 1
                            If READ_PFK7231(Array_hlp0000SeVaTt1(i)) Then
                                ...
                                DS1 = PrcDS("USP_ISUD3421B_RND_SEARCH_VS1_INSERT_SUPPLIER", cn, Array_hlp0000SeVaTt(i), Array_hlp0000SeVaTt1(i), xCheckMaterialType)

                                Call READ_SPREAD_N(Vs1, DS1, xROW, GetDsRc(DS1), "USP_ISUD3421B_RND_SEARCH_VS1", "VS1")
