...
#Region "Form"
    Public Function Link_ISUD4090D(job As Integer, cdMainProcess As String, ProdDate As String, ProdSeq As String, _
        ...
        If READ_PFK7171(ListCode("SubProcess"), "029") Then
...
#Region "Search"
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD4090D_SEARCH_VS1", cn, L4090.ProdDate, _
                                                        L4090.cdFactory, _
                                                        L4090.cdLineProd, _
                                                        L4090.cdMainProcess)
            ...
            If GetDsRc(DS1) = 0 Then
                ...
                SPR_PRO(vS1, DS1, "USP_ISUD4090D_SEARCH_VS1", "vS1")
    ...
    Private Sub txt_Barcode_txtTextKeyDown(sender As Object, e As KeyEventArgs) Handles txt_Barcode.txtTextKeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            If txt_cdSubProcess.Code = "" Then
                MsgBoxP("Sub Process Plz!")
                Setfocus(txt_cdSubProcess)
                Exit Sub
            End If
            ...
            If READ_PFK4075_BatchNo(L4090.BatchNo) Then
                ...
                If D4075.cdFactory = "051" Then
                    ...
                    DS1 = PrcDS("USP_PFK4090A_INSERT_AUTO_PRODUCTION_OUTSOLE_F3", cn, txt_cdFactory.Code, txt_cdLineProd.Code, txt_MachineCode.Code, txt_cdMainProcess.Code, txt_cdSubProcess.Code, D4075.BatchNo, D4075.QtyBatch, txt_InchargeProdution.Code)
                Else
                    DS1 = PrcDS("USP_PFK4090A_INSERT_AUTO_PRODUCTION_OUTSOLE_F3_OT", cn, txt_cdFactory.Code, txt_cdLineProd.Code, txt_MachineCode.Code, txt_cdMainProcess.Code, txt_cdSubProcess.Code, D4075.BatchNo, D4075.QtyBatch, txt_InchargeProdution.Code)
