...
#Region "Formload"
    ...
    Public Function Link_HLP7301A(Optional ByVal TAG As String = "") As Boolean
        Link_HLP7301A = False
        Me.Tag = TAG
    ...
    Public Function Link_HLP7301A_SHOESCODE(ByVal SHOESCODE As String, Optional ByVal TAG As String = "") As Boolean
        Link_HLP7301A_SHOESCODE = False
        txt_MaterialBOMName.Code = SHOESCODE

        If READ_PFK7106(SHOESCODE) Then
            txt_MaterialBOMName.Data = D7106.Article & "-" & D7106.Line & "-" & D7106.ColorName
        End If
        ...
        Try
            ...
            Me.ShowDialog()
            Link_HLP7301A_SHOESCODE = isudCHK
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        DATA_SEARCH01 = False
        If txt_MaterialBOMName.Data = "" Then txt_MaterialBOMName.Code = ""
        Vs1.Enabled = False

        If txt_MaterialBOMName.Code <> "" Then

            DS1 = PrcDS("USP_HLP7301A_SEARCH_VS1", cn, txt_MaterialBOMName.Code)
            ...
            SPR_PRO(Vs1, DS1, "USP_HLP7301A_SEARCH_VS1", "Vs1")

            Vs1.Enabled = True
            DATA_SEARCH01 = True
        Else
            DS1 = PrcDS("USP_HLP7301A_SEARCH_VS1", cn, txt_MaterialBOMName.Data)
            If GetDsRc(DS1) = 0 Then
                Vs1.Enabled = True
                Vs1.ActiveSheet.RowCount = 0
                Exit Function
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7301A_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO(Vs2, DSNEW, "USP_HLP7301A_SEARCH_VS2", "Vs2")
