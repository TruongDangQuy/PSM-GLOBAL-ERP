...
#Region "Variable"
    ...
    Private cdMachineType As String
...
#Region "Formload"
    ...
    Public Function Link_HLP3530A(_cdMachineType As String, Optional ByVal TAG As String = "") As Boolean
        cdMachineType = ""

        Link_HLP3530A = False
        Me.Tag = TAG
        cdMachineType = _cdMachineType
        Try
            formA = False

            Me.ShowDialog()
            Link_HLP3530A = isudCHK
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        DATA_SEARCH01 = False
        If txt_MCStandardName.Data = "" Then txt_MCStandardName.Code = ""
        Vs1.Enabled = False

        DS1 = PrcDS("USP_HLP3530A_SEARCH_VS1", cn, cdMachineType, txt_MCStandardName.Data)
        ...
        SPR_PRO_NEW(Vs1, DS1, "USP_HLP3530A_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP3530A_SEARCH_VS2", cn, KSEL)
            ...
            SPR_PRO_NEW(Vs2, DSNEW, "USP_HLP3530A_SEARCH_VS2", "Vs2")
