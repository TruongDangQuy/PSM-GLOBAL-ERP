...
#Region "DATA_SEARCH"
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            'DS1 = PrcDS("USP_PFP70155_SEARCH_VS1_LINE", cn, getData(Vs1, getColumIndex(Vs1, "Key_cdMachineType"), Vs1.ActiveSheet.ActiveRowIndex), _
            '                                                getData(Vs1, getColumIndex(Vs1, "Key_MachineCode"), Vs1.ActiveSheet.ActiveRowIndex), _
            '                                                Const_MachineType, _
            ...
            '    Exit Function
            'End If
            'READ_SPREAD(Vs1, DS1, "USP_PFP70155_SEARCH_VS1", "Vs1", Vs1.ActiveSheet.ActiveRowIndex)
...
#End Region
    ...
    Private Sub btn_Print_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        ...
        Try
            SQL = ""
            SQL = " DELETE FROM [CS_PRINT].[dbo].[A_SHEETPRINT_MATCHING] "
            ...
            For i = 0 To Vs2.ActiveSheet.RowCount - 1
                If getDataM(Vs2, 0, i) = "1" Then
                    SQL = "Insert into [CS_PRINT].[dbo].[A_SHEETPRINT_MATCHING] "
