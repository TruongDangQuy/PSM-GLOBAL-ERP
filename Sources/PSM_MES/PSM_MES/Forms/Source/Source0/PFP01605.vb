...
#Region "Data_search"
    Private Sub vs_GotFocus(sender As Object, e As EventArgs) Handles Vs10.GotFocus, vS20.GotFocus, vS30.GotFocus
    ...
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Vs10.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01605_SEARCH_VS10", cn, SdateEdate.text1, SdateEdate.text2, txt_cdFactory.Code, txt_cdLineProd.Code, txt_cdMainProcess.Code, txt_Customer.Code)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP01605_SEARCH_VS10", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
            ...
            Call VsSizeRange(Vs10, "USP_PFP01605_SEARCH_VS10_HEAD", SpecNoList)
    ...
    Private Function SpecNoList() As String
        SpecNoList = ""
        Dim Arr_ As New List(Of String)
        Dim i As Integer

        For i = 0 To Vs10.ActiveSheet.RowCount - 1
            If Arr_.Contains(getData(Vs10, getColumIndex(Vs10, "SizeRange"), i)) = False Then
                Arr_.Add(getData(Vs10, getColumIndex(Vs10, "SizeRange"), i))
            End If

        Next


        For i = 0 To Arr_.Count - 1
            SpecNoList = SpecNoList & "''" & Arr_(i) & "''"
...
next1:
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS20.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01605_SEARCH_VS20", cn, SdateEdate.text1, SdateEdate.text2, "003")

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS20, DS1, "USP_PFP01605_SEARCH_VS20", "VS20")
                vS20.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS30.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP01605_SEARCH_VS30", cn, SdateEdate.text1, SdateEdate.text2)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS30, DS1, "USP_PFP01605_SEARCH_VS30", "VS30")
                vS30.Enabled = True
                Exit Function
            End If
