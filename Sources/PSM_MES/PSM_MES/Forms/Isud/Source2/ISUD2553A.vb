Public Class ISUD2553A

#Region "Variable"
    Private wJOB As Integer

    Private W2553 As New T2553_AREA
    Private L2553 As New T2553_AREA
...
#Region "Form"
    ...
    Public Function Link_ISUD2553A(job As Integer, DateAudit As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
        D2553.DateAudit = DateAudit
        wJOB = job : L2553 = D2553

        txt_DateAudit.Data = DateAudit

        Link_ISUD2553A = False
        Try
...
#Region "Search"
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD2553A_SEARCH_VS1", cn, txt_DateAudit.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_SET(Vs1, , , 1, OperationMode.SingleSelect)
                SPR_PRO(Vs1, DS1, "USP_ISUD2553A_SEARCH_VS1", "vS1")
                Vs1.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS2() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_ISUD2553A_SEARCH_VS2", cn, txt_DateAudit.Data)

            If GetDsRc(DS1) = 0 Then
                SPR_SET(vS2, , , 1, OperationMode.SingleSelect)
                SPR_PRO(vS2, DS1, "USP_ISUD2553A_SEARCH_VS2", "VS2")
                vS2.Enabled = True
                Exit Function
            End If
...
#Region "Function"
    ...
    Private Function DATA_MOVE() As Boolean
        ...
        Try
            ...
            If READ_PFK2352(txt_MaterialInBoundNo.Data, txt_MaterialInBoundSeq.Data, txt_MaterialInBoundSno.Data) = True Then
                W2553.PackAudit = 1
                W2553.DateAudit = txt_DateAudit.Data

                W2553.MaterialInBoundDseq = D2352.MaterialInBoundDseq
                W2553.MaterialInBoundNo = D2352.MaterialInBoundNo
                W2553.MaterialInBoundSeq = D2352.MaterialInBoundSeq
                W2553.MaterialInBoundSno = D2352.MaterialInBoundSno

                W2553.QtyAudit = CDecp(txt_QtyAudit.Data)

                If WRITE_PFK2553(W2553) = True Then
                    isudCHK = True
                    Call READ_PFK2351(W2553.MaterialInBoundNo, W2553.MaterialInBoundSeq)
                    ...
                    sTRINGaUDITO = READ_PFK2553_AUTOKEY(W2553.MaterialInBoundNo, W2553.MaterialInBoundSeq, W2553.MaterialInBoundSno)

                    setData(Vs1, getColumIndex(Vs1, "KEY_MaterialInboundNo"), Vs1.ActiveSheet.RowCount - 1, W2553.MaterialInBoundNo)
                    setData(Vs1, getColumIndex(Vs1, "KEY_MaterialInboundSeq"), Vs1.ActiveSheet.RowCount - 1, W2553.MaterialInBoundSeq)
                    setData(Vs1, getColumIndex(Vs1, "KEY_MaterialInBoundSno"), Vs1.ActiveSheet.RowCount - 1, W2553.MaterialInBoundSno)
                    ...
                    setData(Vs1, getColumIndex(Vs1, "DateAudit"), Vs1.ActiveSheet.RowCount - 1, W2553.DateAudit)
                    ...
                    setData(Vs1, getColumIndex(Vs1, "QtyAudit"), Vs1.ActiveSheet.RowCount - 1, W2553.QtyAudit)
                    setData(Vs1, getColumIndex(Vs1, "MaterialInboundNo"), Vs1.ActiveSheet.RowCount - 1, W2553.MaterialInBoundNo)
                    setData(Vs1, getColumIndex(Vs1, "MaterialInboundSeq"), Vs1.ActiveSheet.RowCount - 1, W2553.MaterialInBoundSeq)
                    setData(Vs1, getColumIndex(Vs1, "MaterialInBoundSno"), Vs1.ActiveSheet.RowCount - 1, W2553.MaterialInBoundSno)
    ...
    Private Sub DATA_DELETE()
        ...
        Try
            'For i = 0 To Vs1.ActiveSheet.RowCount - 1
            '    If READ_PFK2553(getData(Vs1, getColumIndex(Vs1, "KEY_Autokey"), i)) = True Then
            '        W2553 = D2553
            '        DELETE_PFK2553(W2553)
            '    End If

            'Next
            Dim xROW As Integer = Vs1.ActiveSheet.ActiveRowIndex

            If READ_PFK2553(getData(Vs1, getColumIndex(Vs1, "KEY_Autokey"), xROW)) = True Then
                W2553 = D2553
                Call DELETE_PFK2553(W2553)
                isudCHK = True
                SPR_DEL(Vs1, 0, xROW)
            Else
                Vs1.Focus()
...
#Region "Event"
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        Select Case wJOB
            Case 1
                If DataCheck(Me, "PFK2553") = False Then Exit Sub
                Call DATA_MOVE()
                Calculation()
    ...
    Private Sub Vs1_Change(sender As Object, e As ChangeEventArgs) Handles Vs1.Change
        ...
        If READ_PFK2553(getData(Vs1, getColumIndex(Vs1, "KEY_AUTOKEY"), e.Row)) = True Then
            W2553 = D2553
            W2553.QtyAudit = CDecp(getData(Vs1, getColumIndex(Vs1, "QtyAudit"), e.Row))

            Call REWRITE_PFK2553(W2553)
