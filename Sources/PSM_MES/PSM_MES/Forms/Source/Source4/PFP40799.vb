...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40799_SEARCH_VS10", cn, SdateEdate.text1, SdateEdate.text2, txt_cdFactory.Code, txt_cdMainProcess.Code, txt_cdLineProd.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(VS10, DS1, "USP_PFP40799_SEARCH_VS10", "VS10")
            VS10.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS11(cdFactory As String, cdMainProcess As String, DatePlan As String, cdLineProd As String, JobCard As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP40799_SEARCH_VS11", cn, cdFactory, cdMainProcess, DatePlan, cdLineProd, JobCard)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS11, DS1, "USP_PFP40799_SEARCH_VS11", "VS11")
            vS11.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40799_SEARCH_VS20", cn, SdateEdate.text1, SdateEdate.text2, txt_cdFactory.Code, txt_cdMainProcess.Code, txt_cdLineProd.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP40799_SEARCH_VS20", "VS20")
            vS20.Enabled = True
            Exit Function
        End If

        SPR_PRO_NEW_BARCODE(vS20, DS1, "USP_PFP40799_SEARCH_VS20", "VS20")
