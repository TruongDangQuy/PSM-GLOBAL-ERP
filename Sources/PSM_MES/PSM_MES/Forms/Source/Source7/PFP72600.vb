...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim xISUD7260A As String = ISUD7260A.Text
        Dim xISUD7260P As String = ISUD1311P.Text
...
#Region "Function"
    Private Sub MAIN_JOB01()
        ...
        If ISUD7260A.Link_ISUD7260A(xJOB, W7260.CustomerCode, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB02()
        ...
        If ISUD7260A.Link_ISUD7260A(xJOB, W7260.ContractID, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB06()
        ...
        xStatus1 = "2"  '1.YES 2.NO
        xStatus2 = "2"  '1.YES 2.NO
        xStatus3 = "2"  '1.YES 2.NO
        xStatus4 = "2"  '1.YES 2.NO
        xStatus5 = "2"  '1.YES 2.NO
        xStatus6 = "2"  '1.YES 2.NO
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP72600_SEARCH_VS1_F1", cn, "*" & txt_CustomerCode.Data, MaterialType, txt_cdDepartment.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP72600_SEARCH_VS1_F1", "Vs1")
            Vs1.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS2(CustomerCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP72600_SEARCH_VS2_F1", cn, txt_ContractNo.Data,
                                                    CustomerCode,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_PFP72600_SEARCH_VS2_F1", "VS2")
            vS2.Enabled = True
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP72600_SEARCH_VS1_LINE", cn,
                                                        ContractID)
            ...
            READ_SPREAD(Vs1, DS1, "USP_PFP72600_SEARCH_VS1", "Vs1", Vs1.ActiveSheet.ActiveRowIndex)
...
#Region "Event"
    ...
    Private Sub Vs1_CellDoubleClick(sender As Object, e As CellClickEventArgs) Handles Vs1.CellDoubleClick
        ...
        Call DATA_SEARCH_VS2(CustomerCode)
