...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDSVN("USP_HLP3011OS_SEARCH_APPROVAL_VS1", cn,
                                                        SdateEdate.text1,
                                                        SdateEdate.text2,
                                                        txt_cdSeason.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(PeacePanalSeach, DS1, "USP_HLP3011OS_SEARCH_APPROVAL_VS1", "Vs1")
...
#Region "Event"
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        ...
        Try
            ...
            '    If getDataM(PeacePanalSeach, getColumIndex(PeacePanalSeach, "CheckUse"), i) = "1" And CIntp(getData(PeacePanalSeach, getColumIndex(PeacePanalSeach, "OrderNoSeq"), i)) > 0 Then
            '        CheckValue = True
