...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Vs10.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP09000_SEARCH_VS10", cn, txt_DateReport.Data, txt_cdSite.Code, txt_Customer.Code, txt_Article.Code, txt_SupplierCode.Code)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP09000_SEARCH_VS10", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS11(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS11.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP09000_SEARCH_VS11", cn, OrderNo, OrderNoSeq)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS11, DS1, "USP_PFP09000_SEARCH_VS11", "VS11")
                vS11.Enabled = True
                Exit Function
            End If
            ...
            Call VsSizeRange(vS11, "USP_PFP09000_SEARCH_VS11_HEAD", getData(vS11, getColumIndex(vS11, "OrderNo"), 0), getData(vS11, getColumIndex(vS11, "OrderNoSeq"), 0))
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS20.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP09000_SEARCH_VS20", cn, txt_DateReport.Data, txt_cdSite.Code, txt_Customer.Code, txt_Article.Code)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS20, DS1, "USP_PFP09000_SEARCH_VS20", "VS20")
                vS20.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        vS30.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP09000_SEARCH_VS30", cn, txt_DateReport.Data, txt_cdSite.Code, txt_Customer.Code, txt_Article.Code)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS30, DS1, "USP_PFP09000_SEARCH_VS30", "VS30")
                vS30.Enabled = True
                Exit Function
            End If
