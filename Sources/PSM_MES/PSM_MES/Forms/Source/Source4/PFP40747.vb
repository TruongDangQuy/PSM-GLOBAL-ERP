...
#Region "load"
    ...
    End Sub
    Private Sub PFP40747_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
#Region "search"
    Private Sub DATA_SEARCH_HEAD(spr As FarPoint.Win.Spread.FpSpread, Xcol As Integer, Xrow As Integer, Value As String)
        Try
            ...
            DS2 = PrcDS("USP_PFP40747_SEARCH_HEAD", cn, cdFactory,
                                                       cdMainProcess,
                                                       cdLineProd,
                                                       "01")
    ...
    Public Function DATA_SEARCH01(ProcessType As String) As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP40747_SEARCH_VS1_HEAD", cn, ListCode("Factory"), txt_cdFactory.Code, ListCode("LineProd"))
            ...
            If chk_FullScreen.Checked Then
                ...
                DS2 = PrcDS("USP_PFP40747_SEARCH_VS1_F2_FULL", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, txt_cdSeason.Code)
                SPR_PRO(vS1, DS2, "USP_PFP40747_SEARCH_VS1_F2_FULL", "vS1")
            ...
            Else
                ...
                DS2 = PrcDS("USP_PFP40747_SEARCH_VS1_F2", cn, txt_cdFactory.Code, txt_cdMainProcess.Code, txt_cdSeason.Code, STR_Foodbed, STR_Stockfit)
...
next1:
    ...
    Private Function DATA_SEARCH_VS2(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40747_SEARCH_VS2", cn, cdFactory,
                                                    cdMainProcess,
                                                    cdLineProd,
                                                    LineTno)
        ...
        SPR_PRO(vS2, DS1, "USP_PFP40747_SEARCH_VS2", "vs2")
    ...
    Private Function DATA_SEARCH_VS31(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP40747_SEARCH_vS31", cn, cdFactory,
                                                    cdMainProcess,
                                                    cdLineProd,
                                                    LineTno)
        ...
        SPR_PRO(vS31, DS1, "USP_PFP40747_SEARCH_vS31", "vS31")
    ...
    Private Function DATA_SEARCH_VS32(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP40747_SEARCH_vS32", cn, cdFactory,
                                                              cdMainProcess,
                                                              cdLineProd,
                                                              LineTno,
                                                              SizeName,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO(vS32, DS1, "USP_PFP40747_SEARCH_vS32", "vS32")
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40747_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP40747_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40747_SEARCH_vS_Cus", cn, CustomerCode, cdSeason)
            SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP40747_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40747_SEARCH_vS_Line", cn, cdSeason, CustomerCode)
            SPR_PRO_NEW(vS_Line, DS1, "USP_PFP40747_SEARCH_vS_Line", "vS_Line")
    ...
    Public Function DATA_SEARCH_HEAD_vs_Job() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP40747_SEARCH_vs_Job", cn, cdSeason, CustomerCode, Line)
            SPR_PRO_NEW(vs_Job, DS1, "USP_PFP40747_SEARCH_vs_Job", "vs_Job")
...
#Region "Event"
            ...
            If READ_PFK4073(cdFactory, cdMainProcess, cdLineProd, LineTno) = False Then
                ...
                If READ_PFK4010_SlnoD(StrMsg) And FormatCut(StrMsg) <> "" Then
                    ...
                    ElseIf chk_Size.Checked = True Then
                        ...
                        'If ISUD4073C.Link_ISUD4073C_QTYBASE(1, cdFactory, cdMainProcess, cdLineProd, LineTno, txt_BatchSizeQ.Value, "PFP40747") Then
                        '    Call LINE_MOVE_DISPLAY01(vS1, vS1.ActiveSheet.ActiveColumnIndex, vS1.ActiveSheet.ActiveRowIndex, cdLineProd)
    ...
    Private Sub PFP40747_Resize(sender As Object, e As EventArgs) Handles Me.Resize
