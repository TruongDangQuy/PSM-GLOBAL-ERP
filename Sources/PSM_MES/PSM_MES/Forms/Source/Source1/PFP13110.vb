...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call Cms_additem(Cms_1, _
                                ...
                                "-",
                                "ORDER PROCESSING - " & WordConv("APPROVAL") & "(F9)",
...
#Region "Function"
    Private Sub MAIN_JOB01()
        Try
            If ISUD1311A.Link_ISUD1311A(1, "000000000", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        Try
            ...
            If ISUD1311A.Link_ISUD1311A(3, OrderNo, Me.Name) = False Then Exit Sub
            'Call DATA_SEARCH_VS1()
        Catch ex As Exception
    ...
    Private Sub MAIN_JOB04()
        ...
        Try
            ...
            If ISUD1311A.Link_ISUD1311A(4, OrderNo, Me.Name) = False Then Exit Sub
            'Call DATA_SEARCH_VS1()
        Catch ex As Exception
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP13110_SEARCH_VS1", cn, ssp_WHERE.gData_SDate,
            ...
            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs1, DS1, "USP_PFP13110_SEARCH_VS1", "Vs1")
