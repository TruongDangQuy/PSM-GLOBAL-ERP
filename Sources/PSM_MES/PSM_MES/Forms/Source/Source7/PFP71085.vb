...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim xISUD7108A As String
        xISUD7108A = ISUD7108A.Text
        ...
        Call Cms_additem(Cms_1, xISUD7108A & " - " & WordConv("SEARCH") & "(F5)", _
                                xISUD7108A & " - " & WordConv("UPDATE") & "(F6)")
...
#Region "Function"
    ...
    Private Sub MAIN_JOB01()
        ...
        If READ_PFK7108_SHOESCODE(ShoesCode) Then
            If ISUD7108A.Link_ISUD7108A(2, D7108.GroupComponentBOM, Me.Name) = False Then Exit Sub
        End If
    ...
    Private Sub MAIN_JOB02()
        ...
        If READ_PFK7108_SHOESCODE(ShoesCode) Then
            ...
            If D7106.CheckComplete = "1" Then
                MsgBoxP("Đã xong ! Completed all !")
                If ISUD7108A.Link_ISUD7108A(2, D7108.GroupComponentBOM, Me.Name) = False Then Exit Sub

                Exit Sub
            End If

            If D7106.CheckBOM = "1" Then
                MsgBoxP("Đã xong SPEC ! Completed SPEC already !")
                If ISUD7108A.Link_ISUD7108A(2, D7108.GroupComponentBOM, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        Try
            ...
            StrMsg = MsgBox("Do you want to COMPLETE BOM?", vbYesNo)

            If StrMsg <> vbYes Then Exit Sub

            ShoesCode = getData(vS2, getColumIndex(vS2, "KEY_ShoesCode"), i)

            i = vS2.ActiveSheet.ActiveRowIndex

            If READ_PFK7106(ShoesCode) Then
                'If READ_PFK7101(D7106.Customercode) Then
                '    If D7101.cdPassWord = "" Then D7101.cdPassWord = "011"

                '    If MsgBoxPPW("Please type the password to compete!", D7101.cdPassWord) = False Then Exit Sub

                '    'Exit For
                'End If

                Call PrcExeNoError("USP_PFP71085_CHECKBOM_COMPLETE", cn, ShoesCode, Pub.DAT, Pub.SAW)
            ...
            '        Call PrcExeNoError("USP_PFP71085_CHECKBOM_COMPLETE", cn, ShoesCode, Pub.DAT, Pub.SAW)
            '        setData(vS2, getColumIndex(vS2, "CheckBOM"), i, "1", , True)
            '    End If
            'Next
    ...
    Private Sub MAIN_JOB04()
        Try
            ...
            If READ_PFK7106(ShoesCode) Then
                ...
                Call PrcExeNoError("USP_PFP71085_CHECKBOM_UNCOMPLETE", cn, ShoesCode, Pub.DAT, Pub.SAW)
            ...
            '                If MsgBoxPPW("Please type the password to uncompete!", D7101.cdPassWord) = False Then Exit Sub
            ...
            '        Call PrcExeNoError("USP_PFP71085_CHECKBOM_UNCOMPLETE", cn, ShoesCode, Pub.DAT, Pub.SAW)
            '        setData(vS2, getColumIndex(vS2, "CheckBOM"), i, "2", , True)
            '    End If
            'Next
    ...
    Private Sub MAIN_JOB05()
        Try
            ...
            If READ_PFK7106(ShoesCode) Then
                If PRINTSHEET_NEW_SHOESCODE.Link_SheetReport(3, "PFP71080", ShoesCode) = True Then
...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        DS1 = PrcDS("USP_PFP71085_SEARCH_VS1", cn, txt_cdSeason.Code, txt_CustomerCode.Code, txt_cdSpecState.Code)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP71085_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH_VS2(cdSpecState As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71085_SEARCH_VS2_F2", cn, getData(vS_Line, getColumIndex(vS_Line, "KEY_ShoesCode"), vS_Line.ActiveSheet.ActiveRowIndex))

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_PFP71085_SEARCH_VS2_F2", "VS2")
    ...
    Private Function DATA_SEARCH_vs_Image(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71085_SEARCH_vs_Image", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vs_Image, DS1, "USP_PFP71085_SEARCH_vs_Image", "vs_Image")
    ...
    Private Function DATA_SEARCH_vs_Doc(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71085_SEARCH_vs_Doc", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS_Doc, DS1, "USP_PFP71085_SEARCH_vs_Doc", "vs_Doc")
            vS_Doc.Enabled = True
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP71085_SEARCH_Vs2_LINE", cn, ShoesCode)

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(vS2, DS1, "USP_PFP71085_SEARCH_Vs2", "Vs2", xrow)
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71085_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP71085_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71085_SEARCH_vS_Cus", cn, CustomerCode, cdSeason)
            SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP71085_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71085_SEARCH_vS_Line", cn, cdSeason, CustomerCode, txt_cdSpecState.Code)
            SPR_PRO_NEW(vS_Line, DS1, "USP_PFP71085_SEARCH_vS_Line", "vS_Line")
        ...
        Try
            ...
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                If getDataM(vS2, getColumIndex(vS2, "DCHK"), i) = "1" Then
                    ...
                    If GetDsRc(DS1) > 0 Then
                        READ_SPREAD(vS2, DS1, "USP_PFP71085_SEARCH_VS2", "vS2", i)
                    End If
