...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_HLP7180A_SEARCH_VS1", cn, "001", txt_cdProcessPrescription.Data, Const_ProcessProduction)
        ...
        SPR_PRO(Vs1, DS1, "USP_HLP7180A_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7180A_SEARCH_VS2", cn, "001", KSEL, Const_ProcessProduction, Const_MachineType)
            ...
            SPR_PRO(Vs2, DSNEW, "USP_HLP7180A_SEARCH_VS2", "Vs2")
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        If getData(Vs1, 0, Vs1.ActiveSheet.ActiveRowIndex) IsNot Nothing Then
            If getData(Vs1, 0, Vs1.ActiveSheet.ActiveRowIndex) <> "" Then
                ...
                hlp0000SeVaTt = getData(Vs1, 1, Vs1.ActiveSheet.ActiveRowIndex)
