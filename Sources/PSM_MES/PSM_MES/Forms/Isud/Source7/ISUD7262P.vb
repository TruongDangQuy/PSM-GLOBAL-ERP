...
#Region "Link"
    Public Function Link_ISUD7262P(job As Integer, ContractID As String,
                                                    Status1 As String,
                                                    Status2 As String,
                                                    Status3 As String,
                                                    Status4 As String,
            ...
            Select Case job
                ...
                Case Else
                    If READ_PFK7262(L7262.ContractID) = False Then
                        ...
                        Exit Function
                    Else
                        L7262.CheckSupplierPrice = D7262.CheckSupplierPrice

                        If L7262.CheckSupplierPrice = "3" Then
                            L_Status1 = "1"
                            L_Status2 = "1"
                            L_Status3 = "1"
                            L_Status4 = "1"
                        ...
                        If L7262.CheckSupplierPrice = "2" Or L7262.CheckSupplierPrice = "4" Then
                            L_Status1 = "2"
                            L_Status2 = "1"
                            L_Status3 = "1"
                            L_Status4 = "1"
                        ...
                        If L7262.CheckSupplierPrice = "1" Or L7262.CheckSupplierPrice = "" Then
                            L_Status1 = "1"
                            L_Status2 = "2"
                            L_Status3 = "1"
                            L_Status4 = "2"
                        ...
                        If L7262.CheckSupplierPrice = "5" Or L7262.CheckSupplierPrice = "6" Then
                            L_Status1 = "1"
                            L_Status2 = "2"
                            L_Status3 = "1"
                            L_Status4 = "2"
...
#Region "Form"
    Private Sub Form_Activate(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If bolCheckSalesPrice = False Then
            If MsgBoxPPW("Please type the password to modify!", const_pwSALESPrice) = False Then wJOB = "2" : cmd_OK.Visible = False Else bolCheckSalesPrice = True
        End If
        ...
        Call Block_Check()
        Call K7262_CheckSupplierPrice(L7262.CheckSupplierPrice)
...
#Region "Search"
    ...
    Private Sub K7262_CheckSupplierPrice(Process As String)
        Select Case Process
        ...
        End Select
    End Sub
    Private Sub K7262_CheckSupplierPrice()
        If rad_CheckSupplierPrice1.Checked = True Then W7262.CheckSupplierPrice = "1"
        If rad_CheckSupplierPrice2.Checked = True Then W7262.CheckSupplierPrice = "2" : W7262.DateComplete = Pub.DAT
        If rad_CheckSupplierPrice3.Checked = True Then W7262.CheckSupplierPrice = "3" : W7262.DateApproved = Pub.DAT
        If rad_CheckSupplierPrice4.Checked = True Then W7262.CheckSupplierPrice = "4" : W7262.DateCancel = Pub.DAT
        If rad_CheckSupplierPrice5.Checked = True Then W7262.CheckSupplierPrice = "5" : W7262.DatePending1 = Pub.DAT
        If rad_CheckSupplierPrice6.Checked = True Then W7262.CheckSupplierPrice = "6" : W7262.DatePending2 = Pub.DAT
    End Sub
