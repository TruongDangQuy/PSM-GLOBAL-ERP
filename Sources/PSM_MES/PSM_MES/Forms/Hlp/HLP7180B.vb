...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_HLP7180A_SEARCH_VS1", cn, "002", txt_cdProcessPrescription.Data, Const_ProcessProduction)
    ...
    Private Function DATA_SEARCH02(KSEL As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7180A_SEARCH_VS2", cn, "002", KSEL, Const_ProcessProduction, Const_MachineType)
