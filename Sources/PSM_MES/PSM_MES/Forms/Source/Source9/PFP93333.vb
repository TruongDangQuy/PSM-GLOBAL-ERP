...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_Vs10(Optional ByVal xsort As String = "1") As Boolean
        ...
        Vs10.Enabled = False
        Try
            DS1 = PrcDS("USP_PFP94100_SEARCH_Vs10", cn, txt_cdSite.Code, txt_Year.Value)
    ...
    Private Function DATA_SEARCH_Vs20(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP94100_SEARCH_Vs20", cn, txt_cdSite.Code, txt_Year.Value)
    ...
    Private Function DATA_SEARCH_Vs30(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP94100_SEARCH_Vs30", cn, txt_cdSite.Code, txt_Year.Value)
