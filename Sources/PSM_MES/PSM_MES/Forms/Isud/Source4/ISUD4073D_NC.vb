...
#Region "Link"
    Public Function Link_ISUD4073D(job As Integer, cdFactory As String, cdMainProcess As String, cdLineProd As String, LineTno As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
...
#Region "Event"
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        Select Case wJOB
            Case 1
                Call DATA_CHECKCOMPLETE()
                Call PrcExeNoError("USP_PFK4015_GENERATE_BARCODE_ALL_JOBCARD_SIZECHECK_OUTSOURCE", cn, L4073.cdFactory, L4073.cdMainProcess, L4073.cdLineProd, L4073.LineTno, CInt(txt_Qtybase.Data))
