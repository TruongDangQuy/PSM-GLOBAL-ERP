...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim xISUD7262A As String
        Dim xISUD7262P As String

        xISUD7262A = ISUD7262A.Text
        xISUD7262P = ISUD7262P.Text

        Call TOOLBAR_CHECKSHOW(ToolStrip1, False, False, False, False, False, False)
        Call Cms_additem(Cms_1,
                         xISUD7262A & "-" & WordConv("INPUT") & "(F5)",
                         xISUD7262A & "-" & WordConv("SEARCH") & "(F6)",
                         xISUD7262A & "-" & WordConv("UPDATE") & "(F7)",
                         xISUD7262A & "-" & WordConv("DELETE") & "(F8)",
                         xISUD7262A & "-" & WordConv("COPY") & "(F9)",
                         "-",
                         xISUD7262P & "-" & WordConv("APPROVED") & "(F10)")
...
#Region "Function"
    Private Sub MAIN_JOB01()
        ...
        If chk_RnD.Checked = True Then
            If ISUD7262A.Link_ISUD7262A(xJOB, W7262.CustomerCode, "PFP72620RnD") = False Then Exit Sub
        Else
            If ISUD7262A.Link_ISUD7262A(xJOB, W7262.CustomerCode, "PFP72620") = False Then Exit Sub
        End If
    ...
    Private Sub MAIN_JOB02()
        ...
        If chk_RnD.Checked = True Then
            If ISUD7262A.Link_ISUD7262A(xJOB, W7262.ContractID, "PFP72620RnD") = False Then Exit Sub
        Else
            If ISUD7262A.Link_ISUD7262A(xJOB, W7262.ContractID, "PFP72620") = False Then Exit Sub
        End If
    ...
    Private Sub MAIN_JOB05()
        ...
        If ISUD7262A.Link_ISUD7262A(5, W7262.ContractID, Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB06()
        ...
        If ISUD7262P.Link_ISUD7262P(xJOB, getData(Vs1, getColumIndex(Vs1, "KEY_ContractID"), Vs1.ActiveSheet.ActiveRowIndex),
...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        DS1 = PrcDS("USP_PFP72639_SEARCH_VS1", cn, txt_ContractNo.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS1, DS1, "USP_PFP72639_SEARCH_VS1", "VS1")
            vS1.Enabled = True
            Exit Function
        End If
