...
#Region "Form_load"
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call DATA_INIT()
    End Sub
    Private Sub PFP23525_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
...
#Region "Data_search"
    ...
    Private Function DATA_SEARCH_VS10(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23525_SEARCH_vS10", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs10, DS1, "USP_PFP23525_SEARCH_vS10", "vS10")
    ...
    Private Function DATA_SEARCH_VS11(Optional ByVal tmpDate As String = "") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23525_SEARCH_vS11", cn, tmpDate, _
                                                    tmpDate, _
                                                    txt_cdDepartment.Code,
                                                    txt_CustomerInBoundMaterialName.Code, _
                                                    txt_cdLargeGroupMaterial.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs11, DS1, "USP_PFP23525_SEARCH_vS11", "vS11")
            Vs11.ActiveSheet.RowCount = 0
            Vs11.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS20(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23525_SEARCH_vS20", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdDepartment.Code,
                                                    txt_CustomerInBoundMaterialName.Code, _
                                                    txt_cdLargeGroupMaterial.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS20, DS1, "USP_PFP23525_SEARCH_vS20", "VS20")
    ...
    Private Function DATA_SEARCH_VS21(Optional ByVal tmpCustomerInBoundMaterial As String = "") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23525_SEARCH_vS21", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdDepartment.Code,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS21, DS1, "USP_PFP23525_SEARCH_vS21", "vS21")
            vS21.ActiveSheet.RowCount = 0
    ...
    Private Function DATA_SEARCH_VS30(Optional ByVal xsort As String = "1") As Boolean
        ...
        DS1 = PrcDS("USP_PFP23525_SEARCH_vS30", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdDepartment.Code,
                                                    txt_CustomerInBoundMaterialName.Code, _
                                                    txt_cdLargeGroupMaterial.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS30, DS1, "USP_PFP23525_SEARCH_vS30", "VS30")
    ...
    Private Function DATA_SEARCH_VS31(Optional ByVal tmpMaterialCode As String = "") As Boolean
        ...
        vS31.Enabled = False
        DS1 = PrcDS("USP_PFP23525_SEARCH_vS31", cn, SdateEdate.text1, _
                                                    SdateEdate.text2, _
                                                    txt_cdDepartment.Code,
                                                    txt_CustomerInBoundMaterialName.Code, _
                                                    txt_cdLargeGroupMaterial.Data,
                                                    ...
                                                    chkInApproval8.CheckState)
        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS31, DS1, "USP_PFP23525_SEARCH_vS31", "vS31")
            vS31.ActiveSheet.RowCount = 0
