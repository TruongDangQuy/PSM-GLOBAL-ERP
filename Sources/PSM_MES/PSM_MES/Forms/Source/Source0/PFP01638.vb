...
#Region "Data_search"
    Private Function DATA_SEARCH_VS10() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP01638_SEARCH_VS10_F1", cn, ProdDate,
                                                        txt_CustomerCode.Code,
                                                        txt_cdSeason.Code,
                                                        txt_SlNoD.Data,
                                                        txt_Line.Data,
                                                        txt_Article.Data,
                                                        txt_cdStateOfficial.Code,
                                                        txt_cdOrderKind.Code,
                                                        txt_cdWorkType.Code)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(Vs10, DS1, "USP_PFP01638_SEARCH_VS10_F1", "vS10")
                Vs10.Enabled = True
                Exit Function
            End If
    ...
    Private Function DATA_SEARCH_VS11(Optional ByVal xsort As String = "1") As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP01638_SEARCH_VS11", cn, ProdDate,
                                                       JobCard)

            If GetDsRc(DS1) = 0 Then
                SPR_PRO_NEW(vS11, DS1, "USP_PFP01638_SEARCH_VS11", "vS11")
                vS11.Enabled = True
                Exit Function
            End If
            ...
            Call VsSizeRangeNew_one(vS11, "USP_PFP01638_SEARCH_VS11_HEAD", getColumIndex(vS11, "QtyTotal"), getData(vS11, getColumIndex(vS11, "OrderNo"), 0), getData(vS11, getColumIndex(vS11, "OrderNoSeq"), 0))
