...
#Region "Data Search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_PFP72317_SEARCH_VS1", cn, "*" & txt_Name.Data,
        ...
        If GetDsRc(DS1) = 0 Then
            Vs1.Enabled = True
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP72317_SEARCH_VS1", "Vs1")
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            Dim RS01 As DataRow = Nothing
            DS1 = PrcDS("USP_PFP72317_SEARCH_VS1_LINE", cn, getData(Vs1, getColumIndex(Vs1, "Key_MaterialCode"), Vs1.ActiveSheet.ActiveRowIndex))

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(Vs1, DS1, "USP_PFP72317_SEARCH_VS1", "Vs1", Vs1.ActiveSheet.ActiveRowIndex)
    ...
    Private Sub Vs1_Change(sender As Object, e As ChangeEventArgs) Handles Vs1.Change
        Try
            ...
            If READ_PFK7231(getData(Vs1, getColumIndex(Vs1, "KEY_MaterialCode"), Vs1.ActiveSheet.ActiveRowIndex)) Then
                D7231.seImportGroup = ListCode("ImportGroup")
                D7231.cdImportGroup = getData(Vs1, getColumIndex(Vs1, "cdImportGroup"), Vs1.ActiveSheet.ActiveRowIndex)
                D7231.ImportName = getData(Vs1, getColumIndex(Vs1, "ImportName"), Vs1.ActiveSheet.ActiveRowIndex)
                D7231.ImportCode = getData(Vs1, getColumIndex(Vs1, "ImportCode"), Vs1.ActiveSheet.ActiveRowIndex)
            ...
            For i = 0 To Vs1.ActiveSheet.RowCount - 1
                If getDataM(Vs1, getColumIndex(Vs1, "dchk"), i) = "1" Then
                    ...
                    If READ_PFK7231(getData(Vs1, getColumIndex(Vs1, "KEY_MaterialCode"), i)) Then
                        D7231.seImportGroup = ListCode("ImportGroup")
                        D7231.cdImportGroup = getData(Vs1, getColumIndex(Vs1, "cdImportGroup"), i)
                        D7231.ImportName = getData(Vs1, getColumIndex(Vs1, "ImportName"), i)
                        D7231.ImportCode = getData(Vs1, getColumIndex(Vs1, "ImportCode"), i)
