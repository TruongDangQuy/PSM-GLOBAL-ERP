...
#Region "Data_search"
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        DS1 = PrcDS("USP_PFP71060_SEARCH_VS1", cn, ListCode("SpecState"))

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(Vs1, DS1, "USP_PFP71060_SEARCH_VS1", "Vs1")
            SplitContainer1.SplitterDistance = SPR_SHEETWIDHT(Vs1) + cSprWidthSize
            Vs1.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_VS2(cdSpecState As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71060_SEARCH_VS2", cn, txt_CustomerCode.Code, txt_cdSpecState.Code, txt_cdSeason.Code, txt_Line.Data, "*" & txt_Article.Data, txt_ColorName.Data, txt_LastCode.Code, txt_MoldCode.Code, chk_CheckUse1.CheckState, chk_CheckUse2.CheckState)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS2, DS1, "USP_PFP71060_SEARCH_VS2", "VS2")
            vS2.Enabled = True
            Exit Function
        End If
    ...
    Private Function DATA_SEARCH_vs_Image(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71060_SEARCH_vs_Image", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vs_Image, DS1, "USP_PFP71060_SEARCH_vs_Image", "vs_Image")
    ...
    Private Function DATA_SEARCH_vs_Doc(ShoesCode As String) As Boolean
        ...
        DS1 = PrcDS("USP_PFP71060_SEARCH_vs_Doc", cn, ShoesCode)

        If GetDsRc(DS1) = 0 Then
            SPR_PRO_NEW(vS_Doc, DS1, "USP_PFP71060_SEARCH_vs_Doc", "vs_Doc")
            vS_Doc.Enabled = True
            Exit Function
        End If
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP71060_SEARCH_Vs2_LINE", cn, ShoesCode)

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(vS2, DS1, "USP_PFP71060_SEARCH_Vs2", "Vs2", xrow)
    ...
    Public Function DATA_SEARCH_HEAD_vs_Season() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71060_SEARCH_VS_SEASON", cn, ListCode("Season"))
            SPR_PRO_NEW(vs_Season, DS1, "USP_PFP71060_SEARCH_VS_SEASON", "vs_Season")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Cus() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71060_SEARCH_vS_Cus", cn, CustomerCode, cdSeason)
            SPR_PRO_NEW(vS_Cus, DS1, "USP_PFP71060_SEARCH_vS_Cus", "vS_Cus")
    ...
    Public Function DATA_SEARCH_HEAD_vS_Line() As Boolean
        ...
        Try
            DS1 = PrcDS("USP_PFP71060_SEARCH_vS_Line", cn, cdSeason, CustomerCode)
            SPR_PRO_NEW(vS_Line, DS1, "USP_PFP71060_SEARCH_vS_Line", "vS_Line")
        ...
        Try
            ...
            For i = 0 To vS2.ActiveSheet.RowCount - 1
                If getDataM(vS2, getColumIndex(vS2, "DCHK"), i) = "1" Then
                    ...
                    If GetDsRc(DS1) > 0 Then
                        READ_SPREAD(vS2, DS1, "USP_PFP71060_SEARCH_VS2", "vS2", i)
                    End If
