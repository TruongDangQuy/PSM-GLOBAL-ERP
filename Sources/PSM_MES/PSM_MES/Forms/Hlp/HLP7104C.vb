...
#Region "Formload"
    ...
    Friend Function Link_HLP7104C(Optional CustomerCode As String = "") As Boolean
        hlp0000SeVa = ""
        hlp0000SeVaTt = ""
        hlp0000SeVaTt1 = ""
        ...
        If Trim$(CustomerCode) <> "" Then
            L7104.CustomerCode = CustomerCode
            If READ_PFK7101(L7104.CustomerCode) = True Then
                w7101 = D7101
        ...
        Try
            ...
            Link_HLP7104C = isudCHK

        Catch ex As Exception
            Call MsgBoxP("61", WordConv("Link_HLP7104C"))
        End Try
...
#Region "PFP_SEARCH"
    Private Function DATA_SEARCH_VS1() As Boolean
        ...
        Vs2.Enabled = False
        Try
            DS1 = PrcDS("USP_HLP7104A_SEARCH_VS1", cn, txt_CustomerCode.Code)
            ...
            SPR_PRO_NEW(Vs1, DS1, "USP_HLP7104A_SEARCH_VS1", "Vs1")
    ...
    Private Function DATA_SEARCH_VS2(CODE As String, Optional KNAME As String = Nothing) As Boolean
        ...
        Try
            DSNEW = PrcDS("USP_HLP7104A_SEARCH_VS2", cn, CODE)
            Vs2.Enabled = True
            ...
            SPR_PRO_NEW(Vs2, DSNEW, "USP_HLP7104A_SEARCH_VS2", "Vs2")
...
#Region "EVENT"
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        Try
            ...
            If getData(Vs2, getColumIndex(Vs2, "KEY_SizeRange"), Vs2.ActiveSheet.ActiveRowIndex) IsNot Nothing Then
                If getData(Vs2, getColumIndex(Vs2, "KEY_SizeRange"), Vs2.ActiveSheet.ActiveRowIndex) <> "" Then
                    hlp0000SeVa = getData(Vs2, getColumIndex(Vs2, "SizeRangeName"), Vs2.ActiveSheet.ActiveRowIndex)
                    hlp0000SeVaTt = getData(Vs2, getColumIndex(Vs2, "KEY_SizeRange"), Vs2.ActiveSheet.ActiveRowIndex)
                    hlp0000SeVaTt1 = getData(Vs2, getColumIndex(Vs2, "KEY_SizeRange"), Vs2.ActiveSheet.ActiveRowIndex)
                End If
            Else
                hlp0000SeVa = ""
                hlp0000SeVaTt = ""
