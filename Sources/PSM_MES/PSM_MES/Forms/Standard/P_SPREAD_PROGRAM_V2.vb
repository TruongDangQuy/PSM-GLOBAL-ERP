Public Class P_SPREAD_PROGRAM_V2
#Region "Variable"
    Private checkrn As Boolean = False
    Private a9911() As T9911_AREA
    Private L9911 As T9911_AREA
    Private W9914 As New T9914_AREA
    Private W9915 As New T9915_AREA
...
#Region "Form_load"
    ...
    Private Sub SPREAD_SETUP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Vs1.ActiveSheet.OperationMode = OperationMode.MultiSelect
        form_int()
        data_int()
        '  DATA_SEARCH()
    End Sub
    ...
    Private Sub data_int()
        ...
        txt_ColsFrozen.Data = "0"
        txt_RowsFrozen.Data = "0"
        txt_MaxRows.Data = "0"
        txt_OperationMode.SelectedIndex = 3
        chk_ChartType.SelectedIndex = 1
        txt_Lock.Checked = True
        txt_DefaultRowHeight.Checked = True
        txt_HeaderTextMode.Checked = True
        txt_RetainSelectionBlock.Checked = False
        txt_AutoClip.Checked = False
        txt_Header.Checked = False
        txt_Merge.Checked = False
        txt_BackColorCheck.Checked = False
        txt_AreaColorCheck.Checked = False

        txt_BackColor.Data = ""
        txt_AreaColor.Data = ""

        txt_Rowheight.Data = "22"

    End Sub
    Private Sub data_head()
        txt_ColsFrozen.Data = "0"
        txt_RowsFrozen.Data = "0"
        txt_MaxRows.Data = "0"
        txt_OperationMode.SelectedIndex = 3
        ...
        txt_Rowheight.Data = cSprRowHeight

        txt_Separate.Checked = False
        txt_TotalSeparate.Checked = False
...
#Region "SPREAD"
    Private Sub DATA_SEARCH_VS2()
        ...
        Try
            ...
            If READ_PFK9912_CHECKDSEQ(Project.Text, proname2.Data, sheetname2.Text) Then
                SQL = ""
            ...
            Vs1.ActiveSheet.ColumnHeader.RowCount = 1
            ...
            For Each RS01 In ds.Tables(0).Rows
                ...
                i += 1
            Next
            Vs1.ActiveSheet.SelectionPolicy = Model.SelectionPolicy.Range
            Vs1.ActiveSheet.SelectionPolicy = Model.SelectionPolicy.Range
            Vs1.ActiveSheet.SelectionUnit = Model.SelectionUnit.Cell
...
#End Region
    ...
    Private Sub DATA_SEARCH_HEAD()
        Try
            If READ_PFK9914("DMS", proname1.Data, sheetname1.Text) Then
                txt_ColsFrozen.Data = D9914.ColsFrozen
                txt_RowsFrozen.Data = D9914.RowsFrozen
                txt_MaxRows.Data = D9914.MaxRows
                txt_OperationMode.SelectedIndex = D9914.OperationMode

                If D9914.Lock = "1" Then txt_Lock.Checked = True Else txt_Lock.Checked = False

                If D9914.Footer = "1" Then chk_Footer.Checked = True Else chk_Footer.Checked = False

                If D9914.DefaultRowHeight = "1" Then txt_DefaultRowHeight.Checked = True Else txt_DefaultRowHeight.Checked = False
                If D9914.HeaderTextMode = "1" Then txt_HeaderTextMode.Checked = True Else txt_HeaderTextMode.Checked = False
                If D9914.RetainSelectionBlock = "1" Then txt_RetainSelectionBlock.Checked = True Else txt_RetainSelectionBlock.Checked = False
                If D9914.AutoClip = "1" Then txt_AutoClip.Checked = True Else txt_AutoClip.Checked = False
                If D9914.Header = "1" Then txt_Header.Checked = True Else txt_Header.Checked = False
                If D9914.Merge = "1" Then txt_Merge.Checked = True Else txt_Merge.Checked = False
                If D9914.BackColor = "1" Then txt_BackColorCheck.Checked = True Else txt_BackColorCheck.Checked = False
                If D9914.AreaColorCheck = "1" Then txt_AreaColorCheck.Checked = True Else txt_AreaColorCheck.Checked = False

                'Header Column is a type of Reserved Variable. So we need to make default value at "2"

                If D9914.HeaderColumn = "2" Then txt_HeaderColumn.Checked = False Else txt_HeaderColumn.Checked = True
                If D9914.HeaderRow = "2" Then txt_HeaderRow.Checked = False Else txt_HeaderRow.Checked = True

                If D9914.Separate = "1" Then txt_Separate.Checked = True Else txt_Separate.Checked = False
                If D9914.TotalSeparate = "1" Then txt_TotalSeparate.Checked = True Else txt_TotalSeparate.Checked = False

                If D9914.CheckColumnSpan = "1" Then chk_CheckColumnSpan.Checked = True Else chk_CheckColumnSpan.Checked = False

                If D9914.FixSize = "1" Then chk_FixSize.Checked = True Else chk_FixSize.Checked = False
                txt_ZoomSize.Data = CDecp(D9914.ZoomSize)
                If CDecp(D9914.ZoomSize) < 1 Or CDecp(D9914.ZoomSize) > 5 Then txt_ZoomSize.Data = 1

                txt_ColHeader1.Value = CIntp(D9914.ColHeader1)
                txt_ColHeader2.Value = CIntp(D9914.ColHeader2)

                txt_Line.Data = D9914.Line

                txt_ColumnSpanID.Data = D9914.ColumnSpanID

                txt_ColumnBase.Data = D9914.ColumnBase

                Dim Value() As String
                If D9914.ColumnBase <> "" Then
                    Value = D9914.ColumnBase.Split(";")

                    If Value.Length = 1 Then
                        txt_Total1.Data = Value(0)
                    ElseIf Value.Length = 2 Then
                        txt_Total1.Data = Value(0)
                        txt_Total2.Data = Value(1)
                    ElseIf Value.Length = 3 Then
                        txt_Total1.Data = Value(0)
                        txt_Total2.Data = Value(1)
                        txt_Total3.Data = Value(2)
                    End If

                End If


                txt_ColumnCal.Data = D9914.ColumnCal

                txt_BackColor.Data = D9914.BackColor
                txt_AreaColor.Data = D9914.AreaColor

                txt_MergeColumn.Data = D9914.MergeColumn
                txt_MergeRetrict.Data = D9914.MergeRetrict

                txt_Rowheight.Data = D9914.Rowheight


                If D9914.Chart = "1" Then chk_Chart.Checked = True Else chk_Chart.Checked = False

                txt_NameChart.Data = D9914.NameChart
                chk_ChartType.SelectedIndex = D9914.ChartType
                txt_LineBase.Data = D9914.LineBase
                txt_BarBase.Data = D9914.BarBase
                txt_PieBase.Data = D9914.PieBase
                If D9914.ChartVisible = "1" Then chk_ChartVisible.Checked = True Else chk_ChartVisible.Checked = True
    ...
    Private Sub DATA_SEARCH_VSSPAN()
        cellick = False
        ' Dim SQL As String
        Dim RS01 As DataRow = Nothing
        Dim i As Integer = 0
        Dim j As Integer = 0
        Try
            DS1 = PrcDS("USP_SPREAD_PROGRAM_SEARCH_PFK9915", cn, "DMS", proname1.Data, sheetname1.Text, txt_ColumnSpanID.Data)
            SPR_SET(vS_Span, , , , OperationMode.Normal)
            SPR_PRO(vS_Span, DS1, "USP_SPREAD_PROGRAM_SEARCH_PFK9915", "vS_Span")

            Vs1.ActiveSheet.ColumnHeader.RowCount = 2
            vS_Span.ActiveSheet.Columns(0, 2).Visible = False


            For i = 0 To GetDsRc(DS1) - 1
                For j = CIntp(GetDsData(DS1, i, "BeginColumn")) To CIntp(GetDsData(DS1, i, "EndColumn"))
                    Vs1.ActiveSheet.ColumnHeader.Cells(1, j).Value = Vs1.ActiveSheet.ColumnHeader.Cells(0, j).Value
                Next
                Vs1.ActiveSheet.AddColumnHeaderSpanCell(0, CIntp(GetDsData(DS1, i, "BeginColumn")), 1, CIntp(GetDsData(DS1, i, "EndColumn")) - CIntp(GetDsData(DS1, i, "BeginColumn")) + 1)
                Vs1.ActiveSheet.ColumnHeader.Cells(0, CIntp(GetDsData(DS1, i, "BeginColumn"))).Value = GetDsData(DS1, i, "Title")
            Next

            For i = 0 To Vs1.ActiveSheet.ColumnCount - 1
                If Vs1.ActiveSheet.ColumnHeader.Cells(0, i).ColumnSpan = 1 Then
                    Vs1.ActiveSheet.ColumnHeader.Cells(0, i).RowSpan = 2
                End If
            ...
            If READ_PFK9914("DMS", proname1.Data, sheetname1.Text) Then
                If D9914.ColHeader1 < 10 Then
                    Vs1.ActiveSheet.ColumnHeader.Rows(0).Height = cSprRowHeight
                Else
                    Vs1.ActiveSheet.ColumnHeader.Rows(0).Height = D9914.ColHeader1
                End If
                If D9914.ColHeader2 < 10 Then
                    Vs1.ActiveSheet.ColumnHeader.Rows(1).Height = cSprRowHeight
                Else
                    Vs1.ActiveSheet.ColumnHeader.Rows(1).Height = D9914.ColHeader2
                End If

                'Vs1.ActiveSheet.ColumnHeader.Rows(0).Height = W9914.ColHeader1
                'Vs1.ActiveSheet.ColumnHeader.Rows(1).Height = W9914.ColHeader2
            End If
...
#Region "Function"
    Private Function FUNCTION_DATATYPE(data As String) As String
        ...
        Select Case data
            ...
            Case 6 : FUNCTION_DATATYPE = "Convert"
    ...
    Private Sub DATA_MOVE(zzz As T9911_AREA)
        ...
        txt_CheckDevValue.Data = zzz.CheckDevValue
    ...
    Private Sub DATA_MOVE_PFK9912_INSERT(zzz As T9911_AREA)
        Itemnamesimple1.Data = zzz.ItemNameSimply
        ItemnameForeign11.Data = zzz.ItemNameForeign1
        ItemnameForeign21.Data = zzz.ItemNameForeign2
        Projectname1.Data = zzz.ProdjectName
        Datatype1.SelectedIndex = zzz.DataType
        Datasize1.Data = zzz.DataSize
        Datadecimal1.Data = zzz.DataDecimal
        TextAlign1.SelectedIndex = zzz.TextAlign
        HorizonAlign1.SelectedIndex = zzz.HorizontalAlignment
        VerticalAlign1.SelectedIndex = zzz.VerticalAlignment
        Sizewidth1.Data = zzz.SizeWidth
        Sizeheight1.Data = zzz.SizeHeight
        Backcolor_1.Data = zzz.BackColot
        Forecolor_1.Data = zzz.ForeColor
        Fontname1.Data = zzz.FontName
        Fontsize1.Data = zzz.FontSize
        Fontbold1.Data = zzz.FontBold

        If zzz.CheckHead = "1" Then chk_CheckHead1.Checked = True Else chk_CheckHead1.Checked = False
        If zzz.CheckMerge = "1" Then chk_CheckMerge1.Checked = True Else chk_CheckMerge1.Checked = False
        If zzz.CheckDev = "1" Then chk_CheckDev1.Checked = True Else chk_CheckDev1.Checked = False

        chk_CheckHeadType1.SelectedIndex = CIntp(zzz.CheckHeadType)
        chk_CheckMergePolicy1.SelectedIndex = CIntp(zzz.CheckMergePolicy)

        Remark1.Data = zzz.REMK
    End Sub

    Private Sub DATA_MOVE_PFK9912(zzz As T9912_AREA)
        Itemnamesimple1.Data = zzz.ItemNameSimply
        ItemnameForeign11.Data = zzz.ItemNameForeign1
        ItemnameForeign21.Data = zzz.ItemNameForeign2
        Projectname1.Data = zzz.ProdjectName
    ...
    Private Function data_check1() As Boolean
        data_check1 = False
        If IsNumeric(Sizewidth1.Data) = False Then Exit Function
        If IsNumeric(Sizewidth1.Height) = False Then Exit Function
        If Datadecimal1.Data.Trim = "" Then Exit Function
    ...
    Private Sub DATA_LINK()
        ...
        L9911.CheckDevValue = txt_CheckDevValue.Data
        L9911.REMK = Remark.Data


    End Sub
    Private Sub DATA_LINK9912()
        L9912.ItemNameSimply = Itemnamesimple1.Data

        If ItemnameForeign1.Data.Trim <> "" Then L9912.ItemNameForeign1 = ItemnameForeign11.Data Else L9912.ItemNameForeign1 = Itemnamesimple1.Data
        If ItemnameForeign2.Data.Trim <> "" Then L9912.ItemNameForeign2 = ItemnameForeign21.Data Else L9912.ItemNameForeign2 = Itemnamesimple1.Data


        L9912.ProdjectName = Projectname1.Data
        L9912.DataType = Datatype1.SelectedIndex
        L9912.DataSize = Datasize1.Data
        L9912.DataDecimal = Datadecimal1.Data
        L9912.TextAlign = TextAlign1.SelectedIndex
        L9912.HorizontalAlignment = HorizonAlign1.SelectedIndex
        L9912.VerticalAlignment = VerticalAlign1.SelectedIndex
        L9912.SizeWidth = Sizewidth1.Data
        L9912.SizeHeight = Sizeheight1.Data
        L9912.BackColot = Backcolor_1.Data
        L9912.ForeColor = Forecolor_1.Data
        L9912.FontName = Fontname1.Data
        L9912.FontSize = Fontsize1.Data
        L9912.FontBold = Fontbold1.Data

        L9912.CheckMerge = chk_CheckMerge1.CheckState
        L9912.CheckMergePolicy = chk_CheckMergePolicy1.SelectedIndex
        L9912.CheckHead = chk_CheckHead1.CheckState
        L9912.CheckHeadType = chk_CheckHeadType1.SelectedIndex
        L9912.CheckDev = chk_CheckDev1.CheckState

        L9912.REMK = Remark1.Data
...
#Region "Event"
    ...
    End Sub
    Private Sub ChangeValue1(sender As Object, e As EventArgs) Handles Sizewidth1.txtTextChanged, Sizeheight1.txtTextChanged, Projectname1.txtTextChanged, Itemnamesimple1.txtTextChanged, Forecolor_1.txtTextChanged, Fontsize1.txtTextChanged, Fontname1.txtTextChanged, Fontbold1.txtTextChanged, Backcolor_1.txtTextChanged
        If data_check1() = False Then Exit Sub
        If cellick = False Then Exit Sub
        Vs1.ActiveSheet.ColumnHeader.Columns(xcol).Label = Itemnamesimple1.Data
        Vs1.ActiveSheet.ColumnHeader.Columns(xcol).Tag = Itemcode.Data & Itemname.Data

        Vs1.ActiveSheet.ColumnHeader.Columns(xcol).Width = CDbl(Sizewidth1.Data)
        Dim newfont As Font
        If Fontbold1.Data = "0" Then
            newfont = New Font(Fontname1.Data, CSng(Fontsize1.Data), Drawing.FontStyle.Regular)
        Else
            newfont = New Font(Fontname1.Data, CSng(Fontsize1.Data), Drawing.FontStyle.Bold)
        End If
        Vs1.ActiveSheet.ColumnHeader.Columns(xcol).Font = newfont
    End Sub
    ...
    Private Sub Fontstyle_Load(sender As Object, e As EventArgs) Handles Fontstyle.btnTitleClick
        ...
        End If
    End Sub
    Private Sub Fontstyle1_Load(sender As Object, e As EventArgs) Handles Fontstyle1.btnTitleClick
        FontDialog1.ShowDialog()
        Fontname1.Data = FontDialog1.Font.Name
        Fontsize1.Data = FontDialog1.Font.Size
        If FontDialog1.Font.Bold = True Then
            Fontbold1.Data = "1"
        Else
            Fontbold1.Data = "0"
    ...
    Private Sub Backcolor_1_Load(sender As Object, e As EventArgs) Handles Backcolor_1.btnTitleClick
        ColorDialog1.ShowDialog()
        Backcolor_1.TextboxBackColor = ColorDialog1.Color
        Backcolor_1.Data = ColorDialog1.Color.R & "-" & ColorDialog1.Color.G & "-" & ColorDialog1.Color.B
        Backcolor_1.Code = ColorDialog1.Color.R & "-" & ColorDialog1.Color.G & "-" & ColorDialog1.Color.B
        Vs1.ActiveSheet.Columns(xcol).BackColor = ColorDialog1.Color
    End Sub
    ...
    Private Sub Forecolor_1_Load(sender As Object, e As EventArgs) Handles Forecolor_1.btnTitleClick
        ColorDialog1.ShowDialog()
        Forecolor_1.TextboxBackColor = ColorDialog1.Color
        Forecolor_1.Data = ColorDialog1.Color.R & "-" & ColorDialog1.Color.G & "-" & ColorDialog1.Color.B
        Vs1.ActiveSheet.Columns(xcol).ForeColor = ColorDialog1.Color
    End Sub
    Private Sub SelectIndexChange(sender As Object, e As EventArgs) Handles HorizonAlign.SelectedIndexChanged, VerticalAlign.SelectedIndexChanged, _
        ...
        End Try
    End Sub
    Private Sub SelectIndexChange1(sender As Object, e As EventArgs) Handles HorizonAlign1.SelectedIndexChanged, VerticalAlign1.SelectedIndexChanged

        Try
            Vs1.ActiveSheet.Columns(xcol).VerticalAlignment = VerticalAlign1.SelectedIndex
            Vs1.ActiveSheet.Columns(xcol).HorizontalAlignment = HorizonAlign1.SelectedIndex
    ...
    Private Sub cmd_OK_Click(sender As Object, e As EventArgs) Handles cmd_OK.Click
        Try
            ...
            If READ_PFK9912_1(Projectname.Data, proname2.Data, sheetname2.Text, Itemcode.Data) Then
                L9912 = D9912
                DATA_LINK9912()

                Call REWRITE_PFK9912(L9912)
            End If
            '    DATA_SEARCH_VS1_2()
        Catch ex As Exception
        End Try
    ...
    Private Sub Datatype_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Datatype.SelectedIndexChanged
        Try
            Select Case Datatype.SelectedIndex
                ...
                Case 1
                    SPR_NUMBERCELL(Vs1, CIntp(Datadecimal.Data), xcol)
                ...
                Case 6
                    Vs1.ActiveSheet.Columns(xcol).CellType = textt
                Case 7
                    SPR_PERCENTCELL(Vs1, CIntp(Datadecimal.Data), xcol)
            End Select
        Catch ex As Exception

        End Try
    End Sub
    Private Sub Datatype1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Datatype1.SelectedIndexChanged
        Try
            Select Case Datatype1.SelectedIndex
                Case 0
                    Vs1.ActiveSheet.Columns(xcol).CellType = textt
                Case 1
                    SPR_NUMBERCELL(Vs1, CIntp(Datadecimal.Data), xcol)
    ...
    End Sub
    Private Sub Datadecimal1_Load(sender As Object, e As EventArgs) Handles Datadecimal1.txtTextChanged
        If Datatype1.SelectedIndex <> 1 Then Exit Sub
        If IsNumeric(Datadecimal1.Data) = False Then Exit Sub
        SPR_NUMBERCELL(Vs1, CInt(Datadecimal1.Data), xcol)
    End Sub
    Private Sub cmd_K9912_Click(sender As Object, e As EventArgs) Handles cmd_SAVE.Click
        ...
        Try
            ...
            '        L9912.ItemNameSimply = Itemnamesimple2.Data
            ...
            Call REWRITE_PFK9912_UPDATE_DSEQ1(Project.Text, proname2.Data, sheetname2.Text)

            For i = 0 To ListBox1.Items.Count - 1
                Dim str() As String
                str = Split(ListBox1.GetItemText(ListBox1.Items(i)), "-")

                If READ_PFK9912_3(Project.Text, proname2.Data, sheetname2.Text, str(1)) Then
                    L9912 = D9912
                    L9912.ProgramDSeq = j + 1
                    L9912.Lock = FUNCTION_CBOOLEAN(str(2))
                    L9912.Hidden = FUNCTION_CBOOLEAN(str(3))
                    j = j + 1
                    Call REWRITE_PFK9912(L9912)
                Else
                    ...
                    L9912.ProgramSeq = key_count_k9912(L9912.ProdjectName, L9912.ProgramNo, L9912.SheetName)
                    j = j + 1
                    Call WRITE_PFK9912(L9912)
                End If
            Next

            Call DELETE_PFK9912_DSEQ1(Project.Text, proname2.Data, sheetname2.Text)

            Call PrcExeNoError("EXP_CLOSSING_PFK9912", cn, Project.Text, proname2.Data, sheetname2.Text)
            MsgBoxP("INSERT SUCCESSFULLY!", vbInformation)
        Catch ex As Exception
        End Try
    End Sub
    ...
    Sub PeaceFarpoint_CellClick(sender As Object, e As CellClickEventArgs) Handles Vs1.CellClick
        ...
        If READ_PFK9911(itemcode1, itemname1) = True Then
            ...
            If READ_PFK9912_3(Project.Text, proname2.Data, sheetname2.Text, D9911.ItemCode) Then
                If D9912.CheckDev = "1" Then
                    DATA_MOVE_PFK9912(D9912)
                Else
                    DATA_MOVE_PFK9912_INSERT(D9911)
                End If
            End If
    ...
    End Sub
    Private Sub PeaceButton6_Click(sender As Object, e As EventArgs)
        CLEAR_ALL()
    End Sub
    ...
    End Sub
    Private Sub PeaceCombobox3_SelectedIndexChanged(sender As Object, e As EventArgs)
    ...
    Private Sub cmd_Search_Click(sender As Object, e As EventArgs) Handles cmd_Search.Click
        ...
        ListBox1.Items.Clear()
        DATA_SEARCH_VS2()
        If CIntp(txt_ColumnSpanID.Data) > 0 Then DATA_SEARCH_VSSPAN()
        refeshlist()
    End Sub
...
#End Region
    ...
    Private Sub cmd_Rearragement_Click(sender As Object, e As EventArgs) Handles cmd_Rearragement.Click
        Dim SQL As String
        Dim RS01 As DataRow = Nothing
        Dim i As Integer = 0
        Dim j As Integer = 0
        ...
        Try
            ...
            ReDim ArrayTest(ListBox1.Items.Count)
            ...
            For i = 0 To ListBox1.Items.Count - 1
                ...
                For j = 0 To RowCnt - 1
                    If DS1.Tables(0).Columns(j).ColumnName.ToUpper = stra(0).ToUpper Then
                        ...
                        For k As Integer = 0 To ArrayTest.Length - 1
                            If ArrayTest(k) = "" Then ArrayTest(k) = ""
                            If ArrayTest(k).ToUpper = stra(0).ToUpper Then
                                Chkk = False
                                GoTo next1
                            End If
                        Next
                        ArrayTest(i) = stra(0).ToUpper
                        Exit For
                    End If
                Next
next1:
    ...
    Private Sub cmd_OkSheet_Click(sender As Object, e As EventArgs) Handles cmd_OkSheet.Click
        'Exit Sub
        ...
        Try
            If READ_PFK9914("DMS", proname1.Data, sheetname1.Text) Then
                ...
                W9914.ColsFrozen = txt_ColsFrozen.Data
                W9914.RowsFrozen = txt_RowsFrozen.Data
                W9914.MaxRows = txt_MaxRows.Data
                W9914.OperationMode = txt_OperationMode.SelectedIndex

                If txt_Lock.Checked = True Then W9914.Lock = "1" Else W9914.Lock = "2"
                If txt_DefaultRowHeight.Checked = True Then W9914.DefaultRowHeight = "1" Else W9914.DefaultRowHeight = "2"
                If txt_HeaderTextMode.Checked = True Then W9914.HeaderTextMode = "1" Else W9914.HeaderTextMode = "2"
                If txt_RetainSelectionBlock.Checked = True Then W9914.RetainSelectionBlock = "1" Else W9914.RetainSelectionBlock = "2"
                If txt_AutoClip.Checked = True Then W9914.AutoClip = "1" Else W9914.AutoClip = "2"
                If txt_Header.Checked = True Then W9914.Header = "1" Else W9914.Header = "2"
                If txt_Merge.Checked = True Then W9914.Merge = "1" Else W9914.Merge = "2"

                If chk_Footer.Checked = True Then W9914.Footer = "1" Else W9914.Footer = "2"

                If txt_BackColorCheck.Checked = True Then W9914.BackColor = "1" Else W9914.BackColor = "2"
                If txt_AreaColorCheck.Checked = True Then W9914.AreaColorCheck = "1" Else W9914.AreaColorCheck = "2"

                If txt_Separate.Checked = True Then W9914.Separate = "1" Else W9914.Separate = "2"
                If txt_TotalSeparate.Checked = True Then W9914.TotalSeparate = "1" Else W9914.TotalSeparate = "2"

                If txt_HeaderColumn.Checked = True Then W9914.HeaderColumn = "1" Else W9914.HeaderColumn = "2"
                If txt_HeaderRow.Checked = True Then W9914.HeaderRow = "1" Else W9914.HeaderRow = "2"

                '--------------------------------CHART------------------------------------------------------'
                If chk_Chart.Checked = True Then W9914.Chart = "1" Else W9914.Chart = "2"
                If chk_ChartVisible.Checked = True Then W9914.ChartVisible = "1" Else W9914.ChartVisible = "2"

                If chk_FixSize.Checked = True Then W9914.FixSize = "1" Else W9914.FixSize = "2"
                If CDecp(txt_ZoomSize.Data) < 1 Or CDecp(txt_ZoomSize.Data) > 5 Then W9914.ZoomSize = 1 Else W9914.ZoomSize = CDecp(txt_ZoomSize.Data)

                W9914.ChartType = chk_ChartType.SelectedIndex
                If W9914.ChartType = "-1" Then W9914.ChartType = 0

                W9914.Line = txt_Line.Data

                W9914.LineBase = txt_LineBase.Data
                W9914.BarBase = txt_BarBase.Data
                W9914.PieBase = txt_PieBase.Data
                W9914.NameChart = txt_NameChart.Data
                '--------------------------------CHART------------------------------------------------------'

                W9914.ColumnBase = txt_ColumnBase.Data
                W9914.ColumnCal = txt_ColumnCal.Data

                W9914.BackColor = txt_BackColor.Data
                W9914.AreaColor = txt_AreaColor.Data

                W9914.Rowheight = txt_Rowheight.Data
                W9914.Fontsize = CDecp(txt_Fontsize.Data)

                W9914.ColHeader1 = txt_ColHeader1.Value
                W9914.ColHeader2 = txt_ColHeader2.Value

                W9914.MergeColumn = txt_MergeColumn.Data
                W9914.MergeRetrict = txt_MergeRetrict.Data

                Call REWRITE_PFK9914(W9914)
                MsgBoxP("Update successfully!", vbInformation)
            Else
                W9914.ProdjectName = "DMS"
                W9914.SheetName = sheetname1.Text
                W9914.ProgramNo = proname1.Data
                ...
                If txt_DefaultRowHeight.Checked = True Then W9914.DefaultRowHeight = "1" Else W9914.DefaultRowHeight = "2"
                If txt_HeaderTextMode.Checked = True Then W9914.HeaderTextMode = "1" Else W9914.HeaderTextMode = "2"
                If txt_RetainSelectionBlock.Checked = True Then W9914.RetainSelectionBlock = "1"
                If txt_AutoClip.Checked = True Then W9914.AutoClip = "1" Else W9914.AutoClip = "2"
                If txt_Header.Checked = True Then W9914.Header = "1" Else W9914.Header = "2"
                If txt_Merge.Checked = True Then W9914.Merge = "1" Else W9914.Lock = "2"
    ...
    Private Sub cmd_ClrSheet_Click(sender As Object, e As EventArgs) Handles cmd_ClrSheet.Click
        Exit Sub
    ...
    Private Sub chk_CheckColumnSpan_CheckedChanged(sender As Object, e As EventArgs) Handles chk_CheckColumnSpan.CheckedChanged
        Call CheckColumnSpan()
    End Sub

    Private Function CheckColumnSpan() As Boolean
        CheckColumnSpan = False
        If READ_PFK9914("DMS", proname1.Data, sheetname1.Text) = True Then
            W9914 = D9914

            If W9914.ColumnSpanID > 0 Then
                Dim StrMsg As String

                StrMsg = MsgBox("Do you want to delete this column span id", vbYesNo)
                If StrMsg <> vbYes Then Exit Function

                D9915_CLEAR()
                W9915 = D9915

                W9915.ProdjectName = W9914.ProdjectName
                W9915.ProgramNo = W9914.ProgramNo
                W9915.SheetName = W9914.SheetName
                W9915.ColumnSpanID = W9914.ColumnSpanID


                If DELETE_PFK9915(W9915, True) = True Then
                    W9914.ColumnSpanID = 0
                    If REWRITE_PFK9914(W9914) = True Then
                        MsgBoxP("Clear Span Id Successfully!", vbInformation)
                        CheckColumnSpan = True
                        txt_ColumnSpanID.Data = ""
                        DATA_SEARCH_VS2()
                        Vs1.ActiveSheet.ColumnHeader.RowCount = 1
                    End If
                End If
            Else
                ...
                StrMsg = MsgBox("Do you want to create this column span id", vbYesNo)
                If StrMsg <> vbYes Then Exit Function
                W9914.ColumnSpanID = KEY_COUNT_9915(W9914.ProdjectName, W9914.ProgramNo, W9914.SheetName)
                W9914.ColHeader1 = 22
                W9914.ColHeader2 = 22

                If REWRITE_PFK9914(W9914) = True Then
                    MsgBoxP("Create Id Successfully!", vbInformation)
                    txt_ColumnSpanID.Data = W9914.ColumnSpanID
                    CheckColumnSpan = True
                    DATA_SEARCH_VS2()
                    Vs1.ActiveSheet.ColumnHeader.RowCount = 2
        ...
        End If
    End Function
    Private Function KEY_COUNT_9915(PRODJECTNAME As String, PROGRAMNO As String, SHEETNAME As String) As Double
        KEY_COUNT_9915 = 0
        Try
            SQL = "SELECT MAX(K9914_ColumnSpanID)  AS MAX_CODE FROM PFK9914"
            ...
            If IsDBNull(rd!MAX_CODE) Then
                KEY_COUNT_9915 = 1
            Else
                KEY_COUNT_9915 = CIntp(rd!MAX_CODE + 1)
            End If
            rd.Close()
        Catch ex As Exception
            MsgBoxP("Error Key_count!!!")
        End Try

    End Function

    Private Function KEY_COUNT_9915_SEQ(PRODJECTNAME As String, PROGRAMNO As String, SHEETNAME As String, ColumnSpanID As String)
        KEY_COUNT_9915_SEQ = 0
        Try
            SQL = "SELECT MAX(K9915_ColumnSpanSeq)  AS MAX_CODE FROM PFK9915 "
            ...
            If IsDBNull(rd!MAX_CODE) Then
                KEY_COUNT_9915_SEQ = 1
            Else
                KEY_COUNT_9915_SEQ = CIntp(rd!MAX_CODE + 1)
            End If
            rd.Close()
        Catch ex As Exception
            MsgBoxP("Error Key_count!!!")
    ...
    End Function
    Private Sub cmd_AddSpan_Click(sender As Object, e As EventArgs) Handles cmd_AddSpan.Click
        If READ_PFK9914("DMS", proname1.Data, sheetname1.Text) = True Then
            W9914 = D9914
            ...
            If W9914.ColumnSpanID > 0 Then
                ...
                Value = Vs1.ActiveSheet.ActiveCell

                Dim cr() As FarPoint.Win.Spread.Model.CellRange

                cr = Vs1.ActiveSheet.GetSelections
                ...
                Vs1.ActiveSheet.AddColumnHeaderSpanCell(0, ColB, 1, SpanC)
                Vs1.ActiveSheet.ColumnHeader.Cells(0, ColB).Value = "SPAN COLUMN"
                ...
                W9915.BeginColumn = ColB
                W9915.EndColumn = ColE
                W9915.ColumnSpanSeq = KEY_COUNT_9915_SEQ(W9914.ProdjectName, W9914.ProgramNo, W9914.SheetName, W9914.ColumnSpanID)
                W9915.Title = InputBox("Please Input Title Name !")

                Call WRITE_PFK9915(W9915)
                Call DATA_SEARCH_VSSPAN()

            End If
        End If
    End Sub

    Private Sub vS_Span_Change(sender As Object, e As ChangeEventArgs) Handles vS_Span.Change
        Dim Seq As String
        Seq = getData(vS_Span, getColumIndex(vS_Span, "ColumnSpanSeq"), e.Row)

        If READ_PFK9915("DMS", proname1.Data, sheetname1.Text, txt_ColumnSpanID.Data, Seq) Then
            W9915 = D9915
            W9915.Title = getData(vS_Span, getColumIndex(vS_Span, "Title"), e.Row)

            W9915.ForeignName1 = getData(vS_Span, getColumIndex(vS_Span, "ForeignName1"), e.Row)
            W9915.ForeignName2 = getData(vS_Span, getColumIndex(vS_Span, "ForeignName2"), e.Row)

            W9915.BeginColumn = getData(vS_Span, getColumIndex(vS_Span, "BeginColumn"), e.Row)
            W9915.EndColumn = getData(vS_Span, getColumIndex(vS_Span, "EndColumn"), e.Row)

            If W9915.BeginColumn < 0 Or W9915.EndColumn < 0 Then MsgBoxP("Wrong format!") : Exit Sub

            If W9915.BeginColumn >= W9915.EndColumn Then MsgBoxP("Wrong format!") : Exit Sub

            If REWRITE_PFK9915(W9915) Then
                Call DATA_SEARCH_VSSPAN()
            End If
        End If
    End Sub

    Private Sub vS_Span_KeyDown(sender As Object, e As KeyEventArgs) Handles vS_Span.KeyDown
        If e.KeyCode = Keys.Enter Then
            Dim Seq As String
            Seq = getData(vS_Span, getColumIndex(vS_Span, "ColumnSpanSeq"), vS_Span.ActiveSheet.ActiveRowIndex)

            If READ_PFK9915("DMS", proname1.Data, sheetname1.Text, txt_ColumnSpanID.Data, Seq) Then
                W9915 = D9915
                W9915.Title = getData(vS_Span, getColumIndex(vS_Span, "Title"), vS_Span.ActiveSheet.ActiveRowIndex)
                If REWRITE_PFK9915(W9915) Then
                    Call DATA_SEARCH_VSSPAN()
                End If
            End If
    ...
    Private Sub txt_Total1_txtTextChanged(sender As Object, e As EventArgs) Handles txt_Total1.txtTextChanged, txt_Total2.txtTextChanged, txt_Total3.txtTextChanged

        If txt_Total1.Data <> "" Then
            txt_ColumnBase.Data = txt_Total1.Data

            If txt_Total2.Data <> "" Then
                txt_ColumnBase.Data = txt_Total1.Data & ";" & txt_Total2.Data

                If txt_Total3.Data <> "" Then
                    txt_ColumnBase.Data = txt_Total1.Data & ";" & txt_Total2.Data & ";" & txt_Total3.Data
                End If
