...
#Region "Form"
    ...
    Public Function Link_ISUD4000C() As Boolean
        Me.Tag = Tag
        ...
        Link_ISUD4000C = False
        Try
            formA = False
            Me.ShowDialog()

            Link_ISUD4000C = isudCHK

        Catch ex As Exception
            Call MsgBoxP("61", WordConv("Link_ISUD4000C"))
        End Try

    End Function
    Public Function Link_ISUD4000C(job As Integer, DateProd As String, cdFactory As String, cdMainProcess As String, cdLineProd As String, BatchGroup As String, Optional ByVal TAG As String = "") As Boolean
        Me.Tag = TAG
...
#Region "Search"
    Private Function DATA_SEARCH_HEAD_INSERT_ThanhPham() As Boolean
        ...
        txt_InchargeProdution.Enabled = True


        txt_cdMainProcess_ScanOffline.Data = "Xuất kho thành phẩm"
        txt_cdMainProcess_ScanOffline.Code = "OOO"

        If READ_PFK7411(Pub.SAW) Then
            txt_InchargeProdution.Code = Pub.SAW
    ...
    Private Function DATA_SEARCH_HEAD_INSERT() As Boolean
        ...
        txt_InchargeProdution.Data = Pub.SAW
        txt_InchargeProdution.Code = Pub.SAW
...
#Region "Function"
    ...
    Private Sub DATA_INIT()
        Try
            ...
            txt_DateProd.Data = FormatCut(Pub.DAT)
            txt_DateProd.Code = FormatCut(Pub.DAT)
    ...
    Private Function DATA_INSERT() As Boolean
        ...
        Try
            ...
            Incharge = txt_InchargeProdution.Code
