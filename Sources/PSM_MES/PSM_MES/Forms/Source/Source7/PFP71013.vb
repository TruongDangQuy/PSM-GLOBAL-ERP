Public Class PFP71013
#Region "Variable"
    Private Dsu01 As Long     'Data Su
    Private wGCODE As String
    Protected prg As E_PRG
    Private strCheckKind As String = "2"
...
#Region "Function"
    ...
    Private Sub MAIN_JOB01()
        If ISUD7101B.Link_ISUD7101A_CHECK(1, strCheckKind, "000000", Me.Name) = False Then Exit Sub
    ...
    Private Sub MAIN_JOB03()
        ...
        If ISUD7101B.Link_ISUD7101A_CHECK(xJOB, strCheckKind, getData(Vs1, getColumIndex(Vs1, "Key_CustomerCode"), Vs1.ActiveSheet.ActiveRowIndex), Me.Name) = False Then Exit Sub
...
#Region "Data_search"
    Private Function DATA_SEARCH01() As Boolean
        ...
        DS1 = PrcDS("USP_PFP71013_SEARCH_VS1", cn, "*" & txt_GNAME.Data, chk_CheckUse1.CheckState, chk_CheckUse2.CheckState, "1")
        ...
        If GetDsRc(DS1) = 0 Then
            ...
            Exit Function
        End If
        SPR_PRO_NEW(Vs1, DS1, "USP_PFP71013_SEARCH_VS1", "Vs1")
        DATA_SEARCH01 = True
    ...
    Private Function LINE_MOVE_DISPLAY01() As Boolean
        ...
        Try
            ...
            DS1 = PrcDS("USP_PFP71013_SEARCH_VS1_LINE", cn, CustomerCode)

            If GetDsRc(DS1) = 0 Then
                Exit Function
            End If
            READ_SPREAD(Vs1, DS1, "USP_PFP71013_SEARCH_VS1", "Vs1", xrow)
...
#Region "Event"
    ...
    Private Sub vS1_GotFocus(sender As Object, e As EventArgs) Handles Vs1.GotFocus
        ...
        Call TOOLBAR_CHECKSHOW(ToolStrip1, True, True, True, True, False, False, WordConv("INPUT") & "(F5)", WordConv("SEARCH") & "(F6)")
